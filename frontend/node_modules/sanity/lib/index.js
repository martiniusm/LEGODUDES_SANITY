...
var TransformPatches = require('./_chunks/TransformPatches-BrsaTpSa.js');
...
var getJsonStream = require('./_chunks/getJsonStream-DNA5CeHW.js');
...
function useEditState(publishedDocId, docTypeName) {
  ...
  return reactRx.useMemoObservable(() => {
    if (priority === "low") {
      ...
      return rxjs.merge(base.pipe(rxjs.take(1)), base.pipe(rxjs.skip(1), rxjs.debounce(() => rxjs.timer(1e3))));
    }
...
function useFormattedDuration(durationMs, options) {
  ...
  const locale = getJsonStream.useCurrentLocale().id;
...
function IntentButton(props) {
  return props.disabled ? /* @__PURE__ */jsxRuntime.jsx(getJsonStream.Button, {
    ...props,
    as: "a",
    role: "link",
    "aria-disabled": "true"
  }) : /* @__PURE__ */jsxRuntime.jsx(getJsonStream.Button, {
    ...props,
