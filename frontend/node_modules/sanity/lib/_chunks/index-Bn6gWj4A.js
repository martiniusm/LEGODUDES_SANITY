...
import { usePaneLayout, ChildLink, BackLink, ReferenceChildLink, ParameterizedLink, PaneRouterContext, useStructureTool, LOADING_PANE, structureLocaleNamespace, SerializeError, Pane, PaneHeader, PaneContent, LoadingPane, PaneLayout, setActivePanes, StructureToolProvider } from './StructureToolProvider-CK141bsB.js';
...
import { Button } from './getJsonStream-RYwhuhmq.js';
...
const paneMap = {
  component: lazy(() => import('./index-pIqlMpni.js')),
  document: lazy(() => import('./pane-DelUyv32.js')),
  documentList: lazy(() => import('./pane-CoYwJxjj.js')),
  list: lazy(() => import('./index-DH4YIT_w.js'))
};
