...
const validateDocumentsCommand$1 = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./validateAction-CIIRrVB4.js');
    });
    return mod.default(args, context);
  }
};
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployApiAction-BFRyyUEN.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$a
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./listApisAction-BmbRqQKF.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$9
...
const createMigrationCommand = {
  ...
  action: async (args, context) => {
    ...
    const destDir = path__default.default.join(workDir, MIGRATIONS_DIRECTORY, sluggedName);
    ...
    await promises$1.writeFile(definitionFile, renderedTemplate);
    output.print();
...
const runMigrationCommand = {
  ...
  action: async (args, context) => {
    ...
    const migrationsDirectoryPath = path__default.default.join(workDir, MIGRATIONS_DIRECTORY);
    ...
    if (resolvedScripts.length > 1) {
      throw new Error('Found multiple migrations for "'.concat(id, '" in ').concat(chalk.cyan(migrationsDirectoryPath), ": \n - ").concat(candidates.map(candidate => path__default.default.relative(migrationsDirectoryPath, candidate.absolutePath)).join("\n - ")));
    }
...
const extractSchemaCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./extractAction-rb526l4N.js');
    });
    return mod.default(args, context);
  }
};
...
//# sourceMappingURL=_internal-Dv59gj7E.js.map
