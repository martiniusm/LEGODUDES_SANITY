...
var ue = It;
var le = class le extends Error {
    constructor(t, n) {
      let r = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "type";
      (super("Unexpected ".concat(n, " node ").concat(r, ": ").concat(JSON.stringify(t[r]), ".")), _defineProperty(this, "name", "UnexpectedNodeError")), this.node = t;
    }
  },
  Ae = le;
function Dt(e) {
  ...
  function n(r) {
    let i = r[t],
      s = e[i];
    if (!Array.isArray(s)) throw Object.assign(new Error("Missing visitor keys for '".concat(i, "'.")), {
      node: r
    });
    return s;
  }
...
function kt(e, t, n) {
  ...
  switch (r.kind) {
    ...
    case "Field":
      return y([r.alias ? [n("alias"), ": "] : "", n("name"), r.arguments.length > 0 ? y(["(", x([p, E([O("", ", "), p], A(e, t, n, "arguments"))]), p, ")"]) : "", _(e, n, r), r.selectionSet ? " " : "", n("selectionSet")]);
    case "Name":
      return r.value;
    case "StringValue":
      if (r.block) {
    ...
    case "Directive":
      return ["@", n("name"), r.arguments.length > 0 ? y(["(", x([p, E([O("", ", "), p], A(e, t, n, "arguments"))]), p, ")"]) : ""];
    case "NamedType":
      return n("name");
    ...
    case "InterfaceTypeDefinition":
      {
        let {
          ...
          s = [];
        return i.endsWith("TypeDefinition") ? s.push(g(e, t, n)) : s.push("extend "), i.startsWith("ObjectType") ? s.push("type") : i.startsWith("InputObjectType") ? s.push("input") : s.push("interface"), s.push(" ", n("name")), !i.startsWith("InputObjectType") && r.interfaces.length > 0 && s.push(" implements ", ...vt(e, t, n)), s.push(_(e, n, r)), r.fields.length > 0 && s.push([" {", x([f, E(f, A(e, t, n, "fields"))]), f, "}"]), s;
      }
    case "FieldDefinition":
      return [g(e, t, n), n("name"), r.arguments.length > 0 ? y(["(", x([p, E([O("", ", "), p], A(e, t, n, "arguments"))]), p, ")"]) : "", ": ", n("type"), _(e, n, r)];
    case "DirectiveDefinition":
      return [g(e, t, n), "directive ", "@", n("name"), r.arguments.length > 0 ? y(["(", x([p, E([O("", ", "), p], A(e, t, n, "arguments"))]), p, ")"]) : "", r.repeatable ? " repeatable" : "", " on ", ...E(" | ", e.map(n, "locations"))];
    case "EnumTypeExtension":
    case "EnumTypeDefinition":
      return [g(e, t, n), r.kind === "EnumTypeExtension" ? "extend " : "", "enum ", n("name"), _(e, n, r), r.values.length > 0 ? [" {", x([f, E(f, A(e, t, n, "values"))]), f, "}"] : ""];
    case "EnumValueDefinition":
      return [g(e, t, n), n("name"), _(e, n, r)];
    case "InputValueDefinition":
      return [g(e, t, n), n("name"), ": ", n("type"), r.defaultValue ? [" = ", n("defaultValue")] : "", _(e, n, r)];
    case "SchemaExtension":
      return ["extend schema", _(e, n, r), ...(r.operationTypes.length > 0 ? [" {", x([f, E(f, A(e, t, n, "operationTypes"))]), f, "}"] : [])];
    case "SchemaDefinition":
      return [g(e, t, n), "schema", _(e, n, r), " {", r.operationTypes.length > 0 ? x([f, E(f, A(e, t, n, "operationTypes"))]) : "", f, "}"];
    ...
    case "UnionTypeDefinition":
      return y([g(e, t, n), y([r.kind === "UnionTypeExtension" ? "extend " : "", "union ", n("name"), _(e, n, r), r.types.length > 0 ? [" =", O("", " "), x([O([k, "| "]), E([k, "| "], e.map(n, "types"))])] : ""])]);
    case "ScalarTypeExtension":
    case "ScalarTypeDefinition":
      return [g(e, t, n), r.kind === "ScalarTypeExtension" ? "extend " : "", "scalar ", n("name"), _(e, n, r)];
    case "NonNullType":
      return [n("type"), "!"];
    case "ListType":
      return ["[", n("type"), "]"];
...
function Be(e, t) {
  if (!!!e) throw new Error(t !== null && t !== void 0 ? t : "Unexpected invariant triggered.");
}
var Pt = /\r\n|[\n\r]/g;
function B(e, t) {
  let n = 0,
...
function fe(e, t) {
  let n = e.locationOffset.column - 1,
    ...
    u = t.line === 1 ? n : 0,
    l = t.column + u,
    T = "".concat(e.name, ":").concat(a, ":").concat(l, "\n"),
    h = r.split(/\r\n|[\n\r]/g),
    D = h[i];
  if (D.length > 120) {
    ...
    return T + Ue([["".concat(a, " |"), N[0]], ...N.slice(1, I + 1).map(v => ["|", v]), ["|", "^".padStart(ie)], ["|", N[I + 1]]]);
  }
  return T + Ue([["".concat(a - 1, " |"), h[i - 1]], ["".concat(a, " |"), D], ["|", "^".padStart(l)], ["".concat(a + 1, " |"), h[i + 1]]]);
}
function Ue(e) {
  let t = e.filter(_ref2 => {
      let [r, i] = _ref2;
      return i !== void 0;
    }),
    n = Math.max(...t.map(_ref3 => {
      let [r] = _ref3;
      return r.length;
    }));
  return t.map(_ref4 => {
...
var W = class e extends Error {
  constructor(t) {
    ...
    super(t), this.name = "GraphQLError", this.path = T !== null && T !== void 0 ? T : void 0, this.originalError = h !== null && h !== void 0 ? h : void 0, this.nodes = Ye(Array.isArray(a) ? a : a ? [a] : void 0);
    let I = Ye((r = this.nodes) === null || r === void 0 ? void 0 : r.map(N => N.loc).filter(N => N != null));
    this.source = u !== null && u !== void 0 ? u : I == null || (i = I[0]) === null || i === void 0 ? void 0 : i.source, this.positions = l !== null && l !== void 0 ? l : I == null ? void 0 : I.map(N => N.start), this.locations = l && u ? l.map(N => B(u, N)) : I == null ? void 0 : I.map(N => B(N.source, N.start));
    let ie = Ve(h == null ? void 0 : h.extensions) ? h == null ? void 0 : h.extensions : void 0;
    this.extensions = (s = D !== null && D !== void 0 ? D : ie) !== null && s !== void 0 ? s : Object.create(null), Object.defineProperties(this, {
      message: {
        writable: !0,
        enumerable: !0
      },
...
function d(e, t, n) {
  return new W("Syntax Error: ".concat(n), {
    source: e,
    positions: [t]
  });
}
...
var z = class {
  ...
  lookahead() {
    let t = this.token;
    if (t.kind !== o.EOF) do if (t.next) t = t.next;else {
      let n = Vt(this, t.end);
...
function Vt(e, t) {
  ...
  for (; i < r;) {
    ...
    throw d(e.source, i, s === 39 ? "Unexpected single quote character ('), did you mean to use a double quote (\")?" : R(s) || K(n, i) ? "Unexpected character: ".concat(C(e, i), ".") : "Invalid character: ".concat(C(e, i), "."));
  }
...
function Bt(e, t) {
  ...
  for (; i < r;) {
    let s = n.charCodeAt(i);
    if (s === 10 || s === 13) break;
    if (R(s)) ++i;else if (K(n, i)) i += 2;else break;
  }
...
function Ut(e, t, n) {
  ...
  if (s === 45 && (s = r.charCodeAt(++i)), s === 48) {
    if (s = r.charCodeAt(++i), L(s)) throw d(e.source, i, "Invalid number, unexpected digit after 0: ".concat(C(e, i), "."));
  } else i = de(e, i, s), s = r.charCodeAt(i);
  if (s === 46 && (a = !0, s = r.charCodeAt(++i), i = de(e, i, s), s = r.charCodeAt(i)), (s === 69 || s === 101) && (a = !0, s = r.charCodeAt(++i), (s === 43 || s === 45) && (s = r.charCodeAt(++i)), i = de(e, i, s), s = r.charCodeAt(i)), s === 46 || he(s)) throw d(e.source, i, "Invalid number, expected digit but got: ".concat(C(e, i), "."));
  return m(e, a ? o.FLOAT : o.INT, t, i, r.slice(t, i));
}
function de(e, t, n) {
  if (!L(n)) throw d(e.source, t, "Invalid number, expected digit but got: ".concat(C(e, t), "."));
  let r = e.source.body,
    i = t + 1;
...
function Mt(e, t) {
  ...
  for (; i < r;) {
    ...
    if (u === 10 || u === 13) break;
    if (R(u)) ++i;else if (K(n, i)) i += 2;else throw d(e.source, i, "Invalid character within String: ".concat(C(e, i), "."));
  }
...
function Yt(e, t) {
  ...
  throw d(e.source, t, "Invalid Unicode escape sequence: \"".concat(n.slice(t, t + i), "\"."));
}
function jt(e, t) {
  let n = e.source.body,
    r = Xe(n, t + 2);
  ...
  throw d(e.source, t, "Invalid Unicode escape sequence: \"".concat(n.slice(t, t + 6), "\"."));
}
function Xe(e, t) {
...
function Gt(e, t) {
  ...
  throw d(e.source, t, "Invalid character escape sequence: \"".concat(n.slice(t, t + 2), "\"."));
}
function $t(e, t) {
  let n = e.source.body,
    r = n.length,
  ...
  for (; s < r;) {
    ...
    if (T === 34 && n.charCodeAt(s + 1) === 34 && n.charCodeAt(s + 2) === 34) {
      ...
      let h = m(e, o.BLOCK_STRING, t, s + 3, Je(l).join("\n"));
    ...
    if (R(T)) ++s;else if (K(n, s)) s += 2;else throw d(e.source, s, "Invalid character within String: ".concat(C(e, s), "."));
  }
...
function Qt(e, t) {
  ...
  return n.length === 0 ? "{}" : t.length > 2 ? "[" + Ht(e) + "]" : "{ " + n.map(_ref5 => {
    let [i, s] = _ref5;
    return i + ": " + te(s, t);
  }).join(", ") + " }";
}
...
var M = class {
  constructor(t) {
    let n = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "GraphQL request";
    let r = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {
      line: 1,
      column: 1
    };
    typeof t == "string" || Z(!1, "Body must be a string. Received: ".concat(ee(t), ".")), this.body = t, this.name = n, this.locationOffset = r, this.locationOffset.line > 0 || Z(!1, "line in locationOffset is 1-indexed and must be positive."), this.locationOffset.column > 0 || Z(!1, "column in locationOffset is 1-indexed and must be positive.");
  }
  get [Symbol.toStringTag]() {
    return "Source";
  }
...
var me = class {
    ...
    switch (n.kind) {
      ...
      case o.DOLLAR:
        if (t) if (this.expectToken(o.DOLLAR), this._lexer.token.kind === o.NAME) {
          ...
          throw d(this._lexer.source, n.start, "Unexpected variable \"$".concat(r, "\" in constant value."));
  ...
  parseEnumValueName() {
    if (this._lexer.token.value === "true" || this._lexer.token.value === "false" || this._lexer.token.value === "null") throw d(this._lexer.source, this._lexer.token.start, "".concat(ne(this._lexer.token), " is reserved and cannot be used for an enum value."));
    return this.parseName();
  }
  ...
  expectToken(t) {
    ...
    throw d(this._lexer.source, n.start, "Expected ".concat(Ze(t), ", found ").concat(ne(n), "."));
  }
  ...
  expectKeyword(t) {
    let n = this._lexer.token;
    if (n.kind === o.NAME && n.value === t) this.advanceLexer();else throw d(this._lexer.source, n.start, "Expected \"".concat(t, "\", found ").concat(ne(n), "."));
  }
  ...
  unexpected(t) {
    let n = t !== null && t !== void 0 ? t : this._lexer.token;
    return d(this._lexer.source, n.start, "Unexpected ".concat(ne(n), "."));
  }
  any(t, n, r) {
    this.expectToken(t);
    let i = [];
  ...
  advanceLexer() {
    ...
    if (t !== void 0 && n.kind !== o.EOF && (++this._tokenCounter, this._tokenCounter > t)) throw d(this._lexer.source, n.start, "Document contains more that ".concat(t, " tokens. Parsing aborted."));
  }
};
function ne(e) {
  let t = e.value;
  return Ze(e.kind) + (t != null ? " \"".concat(t, "\"") : "");
}
function Ze(e) {
  return qe(e) ? "\"".concat(e, "\"") : e;
}
function zt(e, t) {
...
var Zt = {
  allowLegacyFragmentVariables: !0
};
function en(e) {
...
exports.parsers = Ee;
exports.printers = rn;
//# sourceMappingURL=graphql-D8i6KiOn.js.map
