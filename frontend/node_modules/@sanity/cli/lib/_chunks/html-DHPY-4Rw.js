...
var Q = (t, e, r) => (jr(t, e, "read from private field"), r ? r.call(t) : e.get(t)),
  Kr = (t, e, r) => {
    if (e.has(t)) throw TypeError("Cannot add the same private member more than once");
    e instanceof WeakSet ? e.add(t) : e.set(t, r);
  },
  Qr = (t, e, r, n) => (jr(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r);
var Ur = {};
Yr(Ur, {
  languages: () => Cs,
  options: () => _s,
...
var Ie = ei;
var ti = t => new Intl.ListFormat("en-US", {
  type: "disjunction"
}).format(t);
function ri(t) {
  ...
  let n = ti([...mt].map(s => "'".concat(s, "'")));
  return "Unexpected doc.type '".concat(t.type, "'.\nExpected it to be ").concat(n, ".");
}
var rr = class rr extends Error {
    constructor(e) {
      (super(ri(e)), _defineProperty(this, "name", "InvalidDocError")), this.doc = e;
    }
  },
  gt = rr;
function L(t) {
...
function T(t) {
  let e = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : rn;
  return St(t, r => typeof r == "string" ? M(e, r.split("\n")) : r);
}
var _t = "'",
  sn = '"';
function oi(t, e) {
...
var Re = ci;
var pi = new Set(["sourceSpan", "startSourceSpan", "endSourceSpan", "nameSpan", "valueSpan", "keySpan", "tagDefinition", "tokens", "valueTokens", "switchValueSourceSpan", "expSourceSpan", "valueSourceSpan"]),
  hi = new Set(["if", "else if", "for", "switch", "case"]);
function ln(t, e) {
  var r;
  if (t.type === "text" || t.type === "comment" || Re(t) || t.type === "yaml" || t.type === "toml") return null;
  if (t.type === "attribute" && delete e.value, t.type === "docType" && delete e.value, t.type === "angularControlFlowBlock" && (r = e.parameters) != null && r.children) for (let n of e.parameters.children) hi.has(t.name) ? delete n.expression : n.expression = n.expression.trim();
...
var hn = mi;
var gi = t => String(t).split(/[/\\]/).pop();
function fn(t, e) {
  var _t$find;
  if (!e) return;
  let r = gi(e).toLowerCase();
  return (_t$find = t.find(_ref => {
    let {
      filenames: n
    } = _ref;
    return n == null ? void 0 : n.some(s => s.toLowerCase() === r);
  })) !== null && _t$find !== void 0 ? _t$find : t.find(_ref2 => {
    let {
      extensions: n
    } = _ref2;
    return n == null ? void 0 : n.some(s => r.endsWith(s));
  });
}
function di(t, e) {
  var _ref3, _t$find2;
  if (e) return (_ref3 = (_t$find2 = t.find(_ref4 => {
    let {
      name: r
    } = _ref4;
    return r.toLowerCase() === e;
  })) !== null && _t$find2 !== void 0 ? _t$find2 : t.find(_ref5 => {
    let {
      aliases: r
    } = _ref5;
    return r == null ? void 0 : r.includes(e);
  })) !== null && _ref3 !== void 0 ? _ref3 : t.find(_ref6 => {
    let {
      extensions: r
    } = _ref6;
    return r == null ? void 0 : r.includes(".".concat(e));
  });
}
function Ci(t, e) {
  var _ref7, _ref8, _di;
  let r = t.plugins.flatMap(s => {
      var _s$languages;
      return (_s$languages = s.languages) !== null && _s$languages !== void 0 ? _s$languages : [];
    }),
    n = (_ref7 = (_ref8 = (_di = di(r, e.language)) !== null && _di !== void 0 ? _di : fn(r, e.physicalFile)) !== null && _ref8 !== void 0 ? _ref8 : fn(r, e.file)) !== null && _ref7 !== void 0 ? _ref7 : void 0;
...
function Et(t, e) {
  return !!(t.type === "ieConditionalComment" && t.lastChild && !t.lastChild.isSelfClosing && !t.lastChild.endSourceSpan || t.type === "ieConditionalComment" && !t.complete || Ce(t) && t.children.some(r => r.type !== "text" && r.type !== "interpolation") || vt(t, e) && !U(t) && t.type !== "interpolation");
}
function Se(t) {
...
function U(t) {
  return t.type === "element" && (t.fullName === "script" || t.fullName === "style" || t.fullName === "svg:style" || t.fullName === "svg:script" || de(t) && (t.name === "script" || t.name === "style"));
}
function _n(t) {
  return t.children && !U(t);
}
function En(t) {
  return U(t) || t.type === "interpolation" || or(t);
}
function or(t) {
...
function An(t, e) {
  ...
  return r;
  function n() {
    return Re(t) || t.type === "angularControlFlowBlock" ? !1 : (t.type === "text" || t.type === "interpolation") && t.prev && (t.prev.type === "text" || t.prev.type === "interpolation") ? !0 : !t.parent || t.parent.cssDisplay === "none" ? !1 : Ce(t.parent) ? !0 : !(!t.prev && (t.parent.type === "root" || Ce(t) && t.parent || U(t.parent) || Je(t.parent, e) || !bi(t.parent.cssDisplay)) || t.prev && !ki(t.prev.cssDisplay));
  }
}
function Dn(t, e) {
  return Re(t) || t.type === "angularControlFlowBlock" ? !1 : (t.type === "text" || t.type === "interpolation") && t.next && (t.next.type === "text" || t.next.type === "interpolation") ? !0 : !t.parent || t.parent.cssDisplay === "none" ? !1 : Ce(t.parent) ? !0 : !(!t.next && (t.parent.type === "root" || Ce(t) && t.parent || U(t.parent) || Je(t.parent, e) || !Ti(t.parent.cssDisplay)) || t.next && !xi(t.next.cssDisplay));
}
function vn(t) {
  return Bi(t.cssDisplay) && !U(t);
}
function Qe(t) {
  return Re(t) || t.next && t.sourceSpan.end && t.sourceSpan.end.line + 1 < t.next.sourceSpan.start.line;
}
function yn(t) {
  return ur(t) || t.type === "element" && t.children.length > 0 && (["body", "script", "style"].includes(t.name) || t.children.some(e => Di(e))) || t.firstChild && t.firstChild === t.lastChild && t.firstChild.type !== "text" && bn(t.firstChild) && (!t.lastChild.isTrailingSpaceSensitive || Tn(t.lastChild));
}
function ur(t) {
...
function At(t) {
  return xn(t) || t.prev && Ai(t.prev) || wn(t);
}
function Ai(t) {
...
function vi(t, e) {
  ...
  return !i && !s ? "babel" : (_$e = $e(e, {
    language: i
  })) !== null && _$e !== void 0 ? _$e : kn(s);
}
function yi(t, e) {
  var _$e2;
  if (!vt(t, e)) return;
...
function lr(t, e) {
  var _ref9, _vi;
  return (_ref9 = (_vi = vi(t, e)) !== null && _vi !== void 0 ? _vi : wi(t, e)) !== null && _ref9 !== void 0 ? _ref9 : yi(t, e);
}
function Xe(t) {
...
function Bn(t, e) {
  ...
  let r = !1;
  if (t.type === "element" && t.namespace === "svg") if (Li(t, s => s.fullName === "svg:foreignObject")) r = !0;else return t.name === "svg" ? "inline-block" : "block";
  switch (e.htmlWhitespaceSensitivity) {
    ...
    case "ignore":
      return "block";
    default:
      return t.type === "element" && (!t.namespace || r || de(t)) && gn[t.name] || mn;
  }
}
function Ln(t) {
  return t.type === "element" && (!t.namespace || de(t)) && Cn[t.name] || dn;
}
function Fi(t) {
...
function cr(t) {
  let e = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Fi(t);
...
var Pi = new Set(["template", "style", "script"]);
function Je(t, e) {
  return _e(t, e) && !Pi.has(t.fullName);
}
function _e(t, e) {
  return e.parser === "vue" && t.type === "element" && t.parent.type === "root" && t.fullName.toLowerCase() !== "html";
}
function vt(t, e) {
  return _e(t, e) && (Je(t, e) || t.attrMap.lang && t.attrMap.lang !== "html");
}
function Fn(t) {
  let e = t.fullName;
...
function yt(t) {
  let e = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : t.value;
  return t.parent.isWhitespaceSensitive ? t.parent.isIndentationSensitive ? T(e) : T(cr(ar(e)), S) : M(A, F.split(e));
}
function wt(t, e) {
...
async function Nn(t, e) {
  let r = [];
  for (let [n, s] of t.split(hr).entries()) if (n % 2 === 0) r.push(T(s));else try {
...
function Wi(t) {
  ...
  function m() {
    for (p(Mi), s = "", i = "in descriptor";;) {
      if (a = t.charAt(o), i === "in descriptor") {
        if ($n(a)) s && (n.push(s), s = "", i = "after descriptor");else if (a === ",") {
          o += 1, s && n.push(s), g();
          return;
  ...
  function g() {
    let C = !1,
      ...
      b,
      V;
    for (B = 0; B < n.length; B++) d = n[B], y = d[d.length - 1], O = d.substring(0, d.length - 1), b = parseInt(O, 10), V = parseFloat(O), On.test(O) && y === "w" ? ((_ || D) && (C = !0), b === 0 ? C = !0 : _ = b) : Ui.test(O) && y === "x" ? ((_ || D || I) && (C = !0), V < 0 ? C = !0 : D = V) : On.test(O) && y === "h" ? ((I || D) && (C = !0), b === 0 ? C = !0 : I = b) : C = !0;
    if (!C) c.source = {
      value: r,
      startOffset: u
    }, _ && (c.width = {
      ...
      value: I
    }), l.push(c);else throw new Error("Invalid srcset descriptor found in \"".concat(t, "\" at \"").concat(d, "\"."));
  }
}
var Mn = Wi;
function zi(t) {
  if (t.node.fullName === "srcset" && (t.parent.fullName === "img" || t.parent.fullName === "source")) return () => Yi(P(t.node));
}
var qn = {
    width: "w",
    height: "h",
...
function Yi(t) {
  let e = Mn(t),
    r = Gi.filter(l => e.some(m => Object.prototype.hasOwnProperty.call(m, l)));
...
function Un(t, e, r) {
  let {
    ...
    s = P(n);
  return x("type T<".concat(s, "> = any"), t, {
    parser: "babel-ts",
    __isEmbeddedTypescriptGenericParameters: !0
  }, j);
}
function Wn(t, e, _ref11) {
  let {
    parseWithTs: r
  } = _ref11;
  return x("function _(".concat(t, ") {}"), e, {
...
async function Gn(t, e, r, n) {
  let s = P(r.node),
    ...
    u = Oe(r, n);
  return [E(await x("function _(".concat(i, ") {}"), t, {
...
function ea(t) {
  return async (e, r, n, s) => {
    ...
    if (i) return i = St(i, a => typeof a == "string" ? w(!1, a, '"', "&quot;") : a), [n.node.rawName, '="', E(i), '"'];
  };
}
var Kn = Zi;
var Qn = new Proxy(() => {}, {
...
function Ze(t, e) {
  return [t.isSelfClosing ? "" : ra(t, e), Ee(t, e)];
}
function ra(t, e) {
  return t.lastChild && ve(t.lastChild) ? "" : [na(t, e), bt(t, e)];
}
function Ee(t, e) {
...
function bt(t, e) {
  if (gr(!t.isSelfClosing), Xn(t, e)) return "";
  switch (t.type) {
    case "ieConditionalComment":
      return "<!";
    case "element":
...
function K(t) {
  return t.prev && t.prev.type !== "docType" && t.type !== "angularControlFlowBlock" && !R(t.prev) && t.isLeadingSpaceSensitive && !t.hasLeadingSpaces;
}
function De(t) {
  var e;
  return ((e = t.lastChild) == null ? void 0 : e.isTrailingSpaceSensitive) && !t.lastChild.hasTrailingSpaces && !R(Dt(t.lastChild)) && !Ce(t);
}
function ve(t) {
  return !t.next && !t.hasTrailingSpaces && t.isTrailingSpaceSensitive && R(Dt(t));
}
function et(t) {
  return t.next && !R(t.next) && R(t) && t.isTrailingSpaceSensitive && !t.hasTrailingSpaces;
}
function sa(t) {
...
function ia(t, e, r) {
  ...
  let s = ((m = n.prev) == null ? void 0 : m.type) === "comment" && sa(n.prev.value),
    i = typeof s == "boolean" ? () => s : Array.isArray(s) ? g => s.includes(g.rawName) : () => !1,
    a = t.map(_ref15 => {
      let {
        node: g
      } = _ref15;
      return i(g) ? T(e.originalText.slice(se(g), ie(g))) : r();
    }, "attrs"),
...
function rt(t, e, r) {
  ...
  return [ye(n, e), ia(t, e, r), n.isSelfClosing ? "" : aa(n)];
}
function ye(t, e) {
...
function Tt(t) {
  switch (t.type) {
    ...
    case "angularIcuExpression":
      return "{";
    case "element":
      if (t.condition) return "<!--[if ".concat(t.condition, "]><!--><").concat(t.rawName);
    default:
      return "<".concat(t.rawName);
  }
}
function xt(t) {
  switch (gr(!t.isSelfClosing), t.type) {
    case "ieConditionalComment":
      return "]>";
    case "element":
...
function oa(t, e) {
  ...
  return t.lastChild && ve(t.lastChild) ? n += bt(t, e).length : De(t) && (n -= Ae(t.lastChild, e).length), e.originalText.slice(r, n);
}
var kt = oa;
var ua = new Set(["if", "else if", "for", "switch", "case"]);
function la(t, e) {
  let {
    node: r
  } = t;
  switch (r.type) {
      ...
      if (!r.isSelfClosing && vt(r, e)) {
        ...
        return n ? async (s, i) => {
          ...
          return o || (u = await s(ar(a), {
            parser: n,
            __embeddedInHtml: !0
          }), o = u === ""), [z(r, e), E(rt(t, e, i)), o ? "" : S, u, o ? "" : S, Ze(r, e), W(r, e)];
        } : void 0;
      }
      break;
    case "text":
      if (U(r.parent)) {
        ...
        return e.parser === "angular" ? (s.parser = "__ng_interpolation", s.trailingComma = "none") : e.parser === "vue" ? s.parser = Oe(t, e) ? "__vue_ts_expression" : "__vue_expression" : s.parser = "__js_expression", [L([A, await n(r.value, s)]), r.parent.next && K(r.parent.next) ? " " : A];
      };
      break;
    case "attribute":
      return Kn(t, e);
    ...
    case "angularControlFlowBlockParameters":
      return ua.has(t.parent.name) ? hn : void 0;
  }
}
var Jn = la;
function pa(t) {
...
var ss = new Map([["if", new Set(["else if", "else"])], ["else if", new Set(["else if", "else"])], ["for", new Set(["empty"])], ["defer", new Set(["placeholder", "error", "loading"])], ["placeholder", new Set(["placeholder", "error", "loading"])], ["error", new Set(["placeholder", "error", "loading"])], ["loading", new Set(["placeholder", "error", "loading"])]]);
function is(t) {
  let e = ie(t);
  return t.type === "element" && !t.endSourceSpan && Me(t.children) ? Math.max(e, is(X(!1, t.children, -1))) : e;
}
function it(t, e, r) {
  let n = t.node;
  if (Se(n)) {
...
function Bt(t, e) {
  return R(t) && R(e) ? t.isTrailingSpaceSensitive ? t.hasTrailingSpaces ? At(e) ? S : A : "" : At(e) ? S : v : et(t) && (Se(e) || e.firstChild || e.isSelfClosing || e.type === "element" && e.attrs.length > 0) || t.type === "element" && t.isSelfClosing && K(e) ? "" : !e.isLeadingSpaceSensitive || At(e) || K(e) && t.lastChild && ve(t.lastChild) && t.lastChild.lastChild && ve(t.lastChild.lastChild) ? S : e.hasLeadingSpaces ? A : v;
}
function qe(t, e, r) {
  let {
    node: n
  } = t;
  if (ur(n)) return [ne, ...t.map(i => {
    let a = i.node,
...
function as(t, e, r) {
  let {
    ...
    s = [];
  ma(t) && s.push("} "), s.push("@", n.name), n.parameters && s.push(" (", E(r("parameters")), ")"), s.push(" {");
  let i = os(n);
  return n.children.length > 0 ? (n.firstChild.hasLeadingSpaces = !0, n.lastChild.hasTrailingSpaces = !0, s.push(L([S, qe(t, e, r)])), i && s.push(S, "}")) : i && s.push("}"), E(s, {
    shouldBreak: !0
  });
}
function os(t) {
  var e, r;
  return !(((e = t.next) == null ? void 0 : e.type) === "angularControlFlowBlock" && (r = ss.get(t.name)) != null && r.has(t.next.name));
}
function ma(t) {
  let {
    previous: e
...
function ls(t, e, r) {
  ...
  return [ye(n, e), E([n.switchValue.trim(), ", ", n.clause, n.cases.length > 0 ? [",", L([A, M(A, t.map(r, "cases"))])] : "", v]), Ee(n, e)];
}
function cs(t, e, r) {
  let {
    node: n
  } = t;
  return [n.value, " {", E([L([v, t.map(_ref16 => {
    let {
      node: s
    } = _ref16;
    return s.type === "text" && !F.trim(s.value) ? "" : r();
  }, "expression")]), v]), "}"];
}
function ps(t, e, r) {
  let {
  ...
  if (Et(n, e)) return [z(n, e), E(rt(t, e, r)), T(kt(n, e)), ...Ze(n, e), W(n, e)];
  let s = n.children.length === 1 && (n.firstChild.type === "interpolation" || n.firstChild.type === "angularIcuExpression") && n.firstChild.isLeadingSpaceSensitive && !n.firstChild.hasLeadingSpaces && n.lastChild.isTrailingSpaceSensitive && !n.lastChild.hasTrailingSpaces,
    ...
    o = l => s ? tn(l, {
      groupId: i
    }) : (U(n) || Je(n, e)) && n.parent.type === "root" && e.parser === "vue" && !e.vueIndentScriptAndStyle ? l : L(l),
    u = () => s ? me(v, "", {
      groupId: i
    }) : n.firstChild.hasLeadingSpaces && n.firstChild.isLeadingSpaceSensitive ? A : n.firstChild.type === "text" && n.isWhitespaceSensitive && n.isIndentationSensitive ? Zr(v) : v,
    p = () => (n.next ? K(n.next) : De(n.parent)) ? n.lastChild.hasTrailingSpaces && n.lastChild.isTrailingSpaceSensitive ? " " : "" : s ? me(v, "", {
      groupId: i
    }) : n.lastChild.hasTrailingSpaces && n.lastChild.isTrailingSpaceSensitive ? A : (n.lastChild.type === "comment" || n.lastChild.type === "text" && n.isWhitespaceSensitive && n.isIndentationSensitive) && new RegExp("\\n[\\t ]{".concat(e.tabWidth * (t.ancestors.length - 1), "}$")).test(n.lastChild.value) ? "" : v;
  return n.children.length === 0 ? a(n.hasDanglingSpaces && n.isDanglingSpaceSensitive ? A : "") : a([yn(n) ? ne : "", o([u(), qe(t, e, r)]), p()]);
}
function Lt(t) {
...
function hs(t) {
  return t >= 97 && t <= 102 || t >= 65 && t <= 70 || Cr(t);
}
function Sr(t) {
  return t === 10 || t === 13;
}
...
var ae = class t {
  ...
  f = class {
    constructor(e, r) {
      let n = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : e;
...
var Ve = class {
  constructor(e, r) {
    let n = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : Pt.ERROR;
    this.span = e, this.msg = r, this.level = n;
  }
  contextualMessage() {
    let e = this.span.start.getContext(100, 3);
    return e ? "".concat(this.msg, " (\"").concat(e.before, "[").concat(Pt[this.level], " ->]").concat(e.after, "\")") : this.msg;
  }
  toString() {
    let e = this.span.details ? ", ".concat(this.span.details) : "";
    return "".concat(this.contextualMessage(), ": ").concat(this.span.start).concat(e);
  }
};
var da = [Sa, _a, Aa, va, ya, Ta, wa, ba, xa, Da];
function Ca(t, e) {
  for (let r of da) r(t, e);
  return t;
}
function Sa(t) {
  t.walk(e => {
...
function Aa(t) {
  return Ea(t, e => e.type === "cdata", e => "<![CDATA[".concat(e.value, "]]>"));
}
function Da(t) {
  let e = r => {
    var n, s;
  ...
  t.walk(r => {
    if (r.children) for (let n = 0; n < r.children.length; n++) {
      ...
      let i = s.prev,
        a = s.next;
      i.value += "<".concat(s.rawName, ">") + s.firstChild.value + "</".concat(s.rawName, ">") + a.value, i.sourceSpan = new f(i.sourceSpan.start, a.sourceSpan.end), i.isTrailingSpaceSensitive = a.isTrailingSpaceSensitive, i.hasTrailingSpaces = a.hasTrailingSpaces, r.removeChild(s), n--, r.removeChild(a);
    }
  });
}
function va(t, e) {
...
function ka(t, e, r) {
  ...
  switch (n.type) {
    ...
    case "docType":
      return [E([ye(n, e), " ", w(!1, n.value.replace(/^html\b/i, "html"), /\s+/g, " ")]), Ee(n, e)];
    case "comment":
    ...
    case "attribute":
      {
        ...
        let s = pr(n.value),
          i = an(s, '"');
        return [n.rawName, "=", i, T(i === '"' ? w(!1, s, '"', "&quot;") : w(!1, s, "'", "&apos;")), i];
      }
    case "cdata":
    default:
      throw new un(n, "HTML");
...
function at(t) {
  ...
  let e = t.indexOf(":", 1);
  if (e === -1) throw new Error("Unsupported format \"".concat(t, "\" expecting \":namespace:name\""));
...
var Fa = "boolean",
  ...
  $a = Array.from(vs).reduce((t, _ref17) => {
    let [e, r] = _ref17;
    return t.set(e, r), t;
  }, new Map()),
  $t = class extends Rt {
    constructor() {
      super(), this._schema = new Map(), this._eventSchema = new Map(), Ra.forEach(e => {
        let r = new Map(),
          n = new Set(),
          [s, i] = e.split("|"),
          a = i.split(","),
    ...
    hasElement(e, r) {
      return r.some(n => n.name === vr.name) || e.indexOf("-") > -1 && (yr(e) || wr(e) || r.some(n => n.name === Dr.name)) ? !0 : this._schema.has(e.toLowerCase());
    }
    ...
    getMappedPropName(e) {
      var _vs$get;
      return (_vs$get = vs.get(e)) !== null && _vs$get !== void 0 ? _vs$get : e;
    }
    ...
    validateProperty(e) {
      return e.toLowerCase().startsWith("on") ? {
        error: !0,
        msg: "Binding to event property '".concat(e, "' is disallowed for security reasons, please use (").concat(e.slice(2), ")=...\nIf '").concat(e, "' is a directive input, make sure the directive is imported by the current module.")
      } : {
        error: !1
      };
    }
    validateAttribute(e) {
      return e.toLowerCase().startsWith("on") ? {
        error: !0,
        msg: "Binding to event attribute '".concat(e, "' is disallowed for security reasons, please use (").concat(e.slice(2), ")=...")
      } : {
        error: !1
      };
    }
    ...
    allKnownAttributesOfElement(e) {
      ...
      return Array.from(r.keys()).map(n => {
        var _$a$get;
        return (_$a$get = $a.get(n)) !== null && _$a$get !== void 0 ? _$a$get : n;
      });
    }
    allKnownEventsOfElement(e) {
      var _this$_eventSchema$ge;
      return Array.from((_this$_eventSchema$ge = this._eventSchema.get(e.toLowerCase())) !== null && _this$_eventSchema$ge !== void 0 ? _this$_eventSchema$ge : []);
    }
    ...
    normalizeAnimationStyleValue(e, r, n) {
      let s = "",
        i = n.toString().trim(),
        a = null;
      if (Oa(e) && n !== 0 && n !== "0") if (typeof n == "number") s = "px";else {
        let o = n.match(/^[+-]?[\d\.]+([a-z]*)$/);
        o && o[1].length == 0 && (a = "Please provide a CSS unit value for ".concat(r, ":").concat(n));
      }
      return {
        error: a,
        value: i + s
...
var h = class {
    constructor() {
      ...
      this.closedByChildren = {}, this.closedByParent = !1, e && e.length > 0 && e.forEach(p => this.closedByChildren[p] = !0), this.isVoid = i, this.closedByParent = s || i, this.implicitNamespacePrefix = r || null, this.contentType = n, this.ignoreFirstLf = a, this.preventNamespaceInheritance = o, this.canSelfClose = u !== null && u !== void 0 ? u : i;
    }
    isClosedByChild(e) {
    ...
    getContentType(e) {
      var _ref18;
      return typeof this.contentType == "object" ? (_ref18 = e === void 0 ? void 0 : this.contentType[e]) !== null && _ref18 !== void 0 ? _ref18 : this.contentType.default : this.contentType;
    }
  },
  ys,
  ot;
function ze(t) {
  ...
  })), (_ot$t = ot[t]) !== null && _ot$t !== void 0 ? _ot$t : ys;
}
var be = class {
    constructor(e, r) {
...
var Ha = [/^\s*$/, /[<>]/, /^[{}]$/, /&(#|[a-z])/i, /^\/\//];
function ws(t, e) {
  if (e != null && !(Array.isArray(e) && e.length == 2)) throw new Error("Expected '".concat(t, "' to be an array, [start, end]."));
  if (e != null) {
    let r = e[0],
      n = e[1];
    Ha.forEach(s => {
...
var Tr = class t {
    static fromArray(e) {
      return e ? (ws("interpolation", e), new t(e[0], e[1])) : xr;
    }
    constructor(e, r) {
...
function Ms(t, e, r) {
  ...
  let s = new Nr(new we(t, e), r, n);
  return s.tokenize(), new Pr(fo(s.tokens), s.errors, s.nonNormalizedIcuExpressions);
}
var ao = /\r\n?/g;
function Ye(t) {
  return "Unexpected character \"".concat(t === 0 ? "EOF" : String.fromCharCode(t), "\"");
}
function Ls(t) {
  return "Unknown entity \"".concat(t, "\" - use the \"&#<decimal>;\" or  \"&#x<hex>;\" syntax");
}
function oo(t, e) {
  return "Unable to parse entity \"".concat(e, "\" - ").concat(t, " character reference entities must end with \";\"");
}
var jt;
(function (t) {
...
var ht = class {
  ...
  Nr = class {
    constructor(e, r, n) {
      ...
      this._cursor = n.escapedString ? new Ir(e, s) : new Kt(e, s), this._preserveLineEndings = n.preserveLineEndings || !1, this._i18nNormalizeLineEndingsInICUs = n.i18nNormalizeLineEndingsInICUs || !1, this._tokenizeBlocks = (_n$tokenizeBlocks = n.tokenizeBlocks) !== null && _n$tokenizeBlocks !== void 0 ? _n$tokenizeBlocks : !0;
      try {
        this._cursor.init();
      } catch (i) {
        this.handleError(i);
    ...
    _getBlockName() {
      ...
      return this._attemptCharCodeUntilFn(n => Lt(n) ? !e : Ns(n) ? (e = !0, !1) : !0), this._cursor.getChars(r).trim();
    }
    ...
    _consumeBlockParameters() {
      for (this._attemptCharCodeUntilFn(Is); this._cursor.peek() !== 41 && this._cursor.peek() !== 0;) {
        ...
        for (; this._cursor.peek() !== 59 && this._cursor.peek() !== 0 || r !== null;) {
          ...
          if (s === 92) this._cursor.advance();else if (s === r) r = null;else if (r === null && Er(s)) r = s;else if (s === 40 && r === null) n++;else if (s === 41 && r === null) {
            if (n === 0) break;
            n > 0 && n--;
          }
    ...
    _tokenizeExpansionForm() {
      ...
      if (po(this._cursor.peek()) && this._isInExpansionForm()) return this._consumeExpansionCaseStart(), !0;
    ...
    _beginToken(e) {
      let r = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this._cursor.clone();
    ...
    _endToken(e, r) {
      ...
      let n = {
        ...
        parts: e,
        sourceSpan: (r !== null && r !== void 0 ? r : this._cursor).getSpan(this._currentTokenStart, this._leadingTriviaCodePoints)
      };
    ...
    handleError(e) {
      if (e instanceof ft && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))), e instanceof ht) this.errors.push(e.error);else throw e;
    }
    _attemptCharCode(e) {
    ...
    _consumeEntity(e) {
      ...
      if (this._cursor.advance(), this._attemptCharCode(35)) {
        ...
        let n = this._cursor.clone();
        if (this._attemptCharCodeUntilFn(co), this._cursor.peek() != 59) this._beginToken(e, r), this._cursor = n, this._endToken(["&"]);else {
          let s = this._cursor.getChars(n);
          this._cursor.advance();
          let i = Ge[s];
          if (!i) throw this._createError(Ls(s), this._cursor.getSpan(r));
          this._endToken([i, "&".concat(s, ";")]);
        }
      }
    }
    _consumeRawText(e, r) {
...
function Fs(t) {
  return Lt(t) || t === 62 || t === 60 || t === 47 || t === 39 || t === 34 || t === 61 || t === 0;
}
function uo(t) {
...
var $ = class t extends Ve {
  ...
  Mr = class t {
    ...
    build() {
      ...
      for (let e of this._containerStack) e instanceof Z && this.errors.push($.create(e.name, e.sourceSpan, "Unclosed block \"".concat(e.name, "\"")));
    }
    _advance() {
      let e = this._peek;
    ...
    _collectExpansionExpTokens(e) {
      ...
      for (;;) {
        ...
        if (this._peek.type === 24) if (qs(n, 20)) n.pop();else return this.errors.push($.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
    ...
    _consumeStartTag(e) {
      ...
      if (this._peek.type === 2) {
        ...
        this.canSelfClose || C.canSelfClose || Ue(i) !== null || C.isVoid || this.errors.push($.create(i, e.sourceSpan, "Only void, custom and foreign elements can be self closed \"".concat(e.parts[1], "\"")));
      ...
      this._pushContainer(m, g instanceof G && this.getTagDefinition(g.name).isClosedByChild(m.name)), a ? this._popContainer(i, G, u) : e.type === 4 && (this._popContainer(i, G, null), this.errors.push($.create(i, u, "Opening tag \"".concat(i, "\" not terminated."))));
    }
    _pushContainer(e, r) {
    ...
    _consumeEndTag(e) {
      ...
      if (r && this.getTagDefinition(r).isVoid) this.errors.push($.create(r, e.sourceSpan, "Void elements do not have end tags \"".concat(e.parts[1], "\"")));else if (!this._popContainer(r, G, e.sourceSpan)) {
        let n = "Unexpected closing tag \"".concat(r, "\". It may happen when the tag has already been closed by another tag. For more info see https://www.w3.org/TR/html5/syntax.html#closing-elements-that-have-implied-end-tags");
    ...
    _consumeAttr(e) {
      ...
      let l = o && u && new f((_ref19 = s == null ? void 0 : s.sourceSpan.start) !== null && _ref19 !== void 0 ? _ref19 : o.start, u, (_ref20 = s == null ? void 0 : s.sourceSpan.fullStart) !== null && _ref20 !== void 0 ? _ref20 : o.fullStart);
    ...
    _consumeIncompleteBlock(e) {
      ...
      let n = this._peek.sourceSpan.fullStart,
        ...
        i = new f(e.sourceSpan.start, n, e.sourceSpan.fullStart),
        a = new Z(e.parts[0], r, [], s, i);
      this._pushContainer(a, !1), this._popContainer(null, Z, null), this.errors.push($.create(e.parts[0], s, "Incomplete block \"".concat(e.parts[0], "\". If you meant to write the @ character, you should use the \"&#64;\" HTML entity instead.")));
    }
    _getContainer() {
...
function Hs(t, e) {
  return Ge[e] !== void 0 ? Ge[e] || t : /^#x[a-f0-9]+$/i.test(e) ? String.fromCodePoint(parseInt(e.slice(2), 16)) : /^#\d+$/.test(e) ? String.fromCodePoint(parseInt(e.slice(1), 10)) : t;
}
...
function Hr(t) {
  ...
  return mo().parse(t, "angular-html-parser", {
...
var Jt = {
  ...
  Zt = class t {
    constructor() {
      ...
      for (let r of new Set([...Ws, ...Object.keys(e)])) this.setProperty(r, e[r]);
    }
    setProperty(e, r) {
      if (this[e] !== r) {
...
function yo(t) {
  if (t.type === "block") {
    ...
    t.parameters = {
      ...
      sourceSpan: new f(t.parameters[0].sourceSpan.start, X(!1, t.parameters, -1).sourceSpan.end)
    };
  }
}
function wo(t) {
...
function js(t, e, r) {
  let {
    ...
    } = e,
    {
      ...
      getTagContentType: p ? function () {
        return p(...arguments) ? N.RAW_TEXT : void 0;
      } : void 0,
      tokenizeAngularBlocks: n === "angular" ? !0 : void 0
    });
  if (n === "vue") {
    if (l.some(b => b.type === "docType" && b.value === "html" || b.type === "element" && b.name.toLowerCase() === "html")) return js(t, Qs, r);
    let d,
      y = () => {
        var _d;
        return (_d = d) !== null && _d !== void 0 ? _d : d = Hr(t, {
          canSelfClose: s,
          allowHtmComponentClosingTags: o,
          isTagNameCaseSensitive: u
        });
      ...
      O = b => {
        var _y$rootNodes$find;
        return (_y$rootNodes$find = y().rootNodes.find(_ref21 => {
          let {
            startSourceSpan: V
          } = _ref21;
          return V && V.start.offset === b.startSourceSpan.start.offset;
        })) !== null && _y$rootNodes$find !== void 0 ? _y$rootNodes$find : b;
      };
    for (let [b, V] of l.entries()) {
      ...
      if (Wr === null) m = y().errors, l[b] = O(V);else if (bo(V, r)) {
  ...
  let g = c => {
      let d = c.name.startsWith(":") ? c.name.slice(1).split(":")[0] : null,
        ...
        O = d !== null && y.startsWith("".concat(d, ":")),
...
var Qs = {
  ...
  ko = tr({
    ...
    shouldParseAsRawText(t, e, r, n) {
      return t.toLowerCase() !== "html" && !r && (t !== "template" || n.some(_ref22 => {
        let {
          name: s,
          value: i
        } = _ref22;
...
var xh = Ur;
exports.default = xh;
exports.languages = Cs;
exports.options = _s;
exports.parsers = Vr;
exports.printers = Lo;
//# sourceMappingURL=html-DHPY-4Rw.js.map
