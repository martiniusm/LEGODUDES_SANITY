...
var G = class {
    constructor(e, t, s, n) {
      this.input = t, this.errLocation = s, this.ctxLocation = n, this.message = "Parser Error: ".concat(e, " ").concat(s, " [").concat(t, "] in ").concat(n);
    }
  },
  P = class {
    constructor(e, t) {
...
function tt(r, e, t) {
  return new O(r, e, f.Character, t, String.fromCharCode(t));
}
function or(r, e, t) {
  return new O(r, e, f.Identifier, 0, t);
}
function cr(r, e, t) {
  return new O(r, e, f.PrivateIdentifier, 0, t);
}
function hr(r, e, t) {
  return new O(r, e, f.Keyword, 0, t);
}
function Ke(r, e, t) {
  return new O(r, e, f.Operator, 0, t);
}
function pr(r, e, t) {
  return new O(r, e, f.String, 0, t);
}
function ur(r, e, t) {
  return new O(r, e, f.Number, t, "");
}
function lr(r, e, t) {
  return new O(r, e, f.Error, 0, t);
}
var Ce = new O(-1, -1, f.Character, 0, ""),
  be = class {
    ...
    scanToken() {
      ...
      return this.advance(), this.error("Unexpected character [".concat(String.fromCharCode(s), "]"), 0);
    }
    scanCharacter(e, t) {
    ...
    scanNumber(e) {
      ...
      for (this.advance();;) {
        if (!K(this.peek)) if (this.peek === 95) {
          ...
          s = !0;
        } else if (this.peek === 46) t = !1;else if (xr(this.peek)) {
    ...
    scanString() {
      ...
      for (; this.peek != t;) if (this.peek == 92) {
        ...
        if (this.advance(), this.peek == 117) {
          ...
          if (/^[0-9a-f]+$/i.test(g)) h = parseInt(g, 16);else return this.error("Invalid unicode escape [\\u".concat(g, "]"), 0);
    ...
    error(e, t) {
      let s = this.index + t;
      return lr(s, this.index, "Lexer Error: ".concat(e, " at column ").concat(s, " in expression [").concat(this.input, "]"));
    }
  };
function rt(r) {
...
var gr = [/^\s*$/, /[<>]/, /^[{}]$/, /&(#|[a-z])/i, /^\/\//];
function ot(r, e) {
  if (e != null && !(Array.isArray(e) && e.length == 2)) throw new Error("Expected '".concat(r, "' to be an array, [start, end]."));
  if (e != null) {
    let t = e[0],
      s = e[1];
    gr.forEach(n => {
      if (n.test(t) || n.test(s)) throw new Error("['".concat(t, "', '").concat(s, "'] contains unusable interpolation symbol."));
    });
  }
}
var Te = class r {
    static fromArray(e) {
      return e ? (ot("interpolation", e), new r(e[0], e[1])) : F;
    }
    constructor(e, t) {
      this.start = e, this.end = t;
    }
...
var _e = class {
  ...
  fe = class {
    ...
    parseAction(e, t, s, n) {
      let i = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : F;
    ...
    parseBinding(e, t, s) {
      let n = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : F;
    ...
    parseSimpleBinding(e, t, s) {
      let n = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : F;
      let i = this._parseBindingAst(e, t, s, n),
        a = this.checkSimpleExpression(i);
      return a.length > 0 && this._reportError("Host binding expression cannot contain ".concat(a.join(" ")), e, t), new R(i, e, t, s, this.errors);
    }
    ...
    parseInterpolation(e, t, s, n) {
      ...
      for (let y = 0; y < h.length; ++y) {
        let E = h[y].text,
          S = this._stripComments(E),
          o = this._lexer.tokenize(S),
          u = new U(e, t, s, o, 0, this.errors, g[y]).parseChain();
        d.push(u);
      }
    ...
    createInterpolationAst(e, t, s, n, i) {
      let a = new P(0, s.length),
        h = new me(a, a.toAbsolute(i), e, t);
      return new R(h, s, n, i, this.errors);
    }
    splitInterpolation(e, t, s) {
      let n = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : F;
      let i = [],
        a = [],
        h = [],
      ...
      for (; d < e.length;) if (y) {
        ...
        let u = d,
          v = u + S.length,
          c = this._getInterpolationEndIndex(e, o, v);
        if (c === -1) {
          y = !1, E = !0;
          break;
        }
        let x = c + o.length,
          l = e.substring(v, c);
        l.trim().length === 0 && this._reportError("Blank expressions are not allowed in interpolated strings", e, "at column ".concat(d, " in"), t), a.push({
          text: l,
          start: u,
          end: x
        });
        let k = ((_ref = g == null ? void 0 : g.get(u)) !== null && _ref !== void 0 ? _ref : u) + S.length;
        h.push(k), d = x, y = !1;
      } else {
        let u = d;
    ...
    _checkNoInterpolation(e, t, _ref2) {
      let {
        start: s,
        end: n
      } = _ref2;
      let i = -1,
        a = -1;
      for (let h of this._forEachUnquotedChar(e, 0)) if (i === -1) e.startsWith(s) && (i = h);else if (a = this._getInterpolationEndIndex(e, n, h), a > -1) break;
      i > -1 && a > -1 && this._reportError("Got interpolation (".concat(s).concat(n, ") where expression was expected"), e, "at column ".concat(i, " in"), t);
    }
...
var U = class {
    constructor(e, t, s, n, i, a, h) {
      this.input = e, this.location = t, this.absoluteOffset = s, this.tokens = n, this.parseFlags = i, this.errors = a, this.offset = h, this.rparensExpected = 0, this.rbracketsExpected = 0, this.rbracesExpected = 0, this.context = pe.None, this.sourceSpanCache = new Map(), this.index = 0;
    }
    peek(e) {
      let t = this.index + e;
    ...
    sourceSpan(e, t) {
      let s = "".concat(e, "@").concat(this.inputIndex, ":").concat(t);
    ...
    prettyPrintToken(e) {
      return e === Ce ? "end of input" : "token ".concat(e);
    }
    ...
    parseChain() {
      ...
      for (; this.index < this.tokens.length;) {
        ...
        if (e.push(s), this.consumeOptionalCharacter(59)) for (this.parseFlags & 1 || this.error("Binding expression cannot contain chained expression"); this.consumeOptionalCharacter(59););else if (this.index < this.tokens.length) {
          let n = this.index;
          if (this.error("Unexpected token '".concat(this.next, "'")), this.index === n) break;
        }
      }
      if (e.length === 0) {
        let s = this.offset,
    ...
    parseConditional() {
      ...
      if (this.consumeOptionalOperator("?")) {
        ...
        if (this.consumeOptionalCharacter(58)) n = this.parsePipe();else {
          ...
          this.error("Conditional expression ".concat(a, " requires all 3 expressions")), n = new $(this.span(e), this.sourceSpan(e));
        }
    ...
    parseCallChain() {
      let e = this.inputIndex,
        t = this.parsePrimary();
      for (;;) if (this.consumeOptionalCharacter(46)) t = this.parseAccessMember(t, e, !1);else if (this.consumeOptionalOperator("?.")) this.consumeOptionalCharacter(40) ? t = this.parseCall(t, e, !0) : t = this.consumeOptionalCharacter(91) ? this.parseKeyedReadOrWrite(t, e, !0) : this.parseAccessMember(t, e, !0);else if (this.consumeOptionalCharacter(91)) t = this.parseKeyedReadOrWrite(t, e, !1);else if (this.consumeOptionalCharacter(40)) t = this.parseCall(t, e, !1);else if (this.consumeOptionalOperator("!")) t = new te(this.span(e), this.sourceSpan(e), t);else return t;
    }
    parsePrimary() {
      let e = this.inputIndex;
      if (this.consumeOptionalCharacter(40)) {
        ...
        if (this.next.isKeywordTrue()) return this.advance(), new C(this.span(e), this.sourceSpan(e), !0);
        if (this.next.isKeywordFalse()) return this.advance(), new C(this.span(e), this.sourceSpan(e), !1);
        ...
        if (this.consumeOptionalCharacter(91)) {
          ...
          if (this.next.isIdentifier()) return this.parseAccessMember(new L(this.span(e), this.sourceSpan(e)), e, !1);
          if (this.next.isNumber()) {
            ...
            return this.advance(), new C(this.span(e), this.sourceSpan(e), t);
          } else return this.next.isPrivateIdentifier() ? (this._reportErrorForPrivateIdentifier(this.next, null), new $(this.span(e), this.sourceSpan(e))) : this.index >= this.tokens.length ? (this.error("Unexpected end of expression: ".concat(this.input)), new $(this.span(e), this.sourceSpan(e))) : (this.error("Unexpected token ".concat(this.next)), new $(this.span(e), this.sourceSpan(e)));
        }
      }
    }
    parseExpressionList(e) {
      let t = [];
      do if (!this.next.isCharacter(e)) t.push(this.parsePipe());else break; while (this.consumeOptionalCharacter(44));
      return t;
    }
    parseLiteralMap() {
      let e = [],
      ...
      if (this.expectCharacter(123), !this.consumeOptionalCharacter(125)) {
        ...
        do {
          ...
          if (e.push({
            key: a,
            quoted: i
          }), i) this.expectCharacter(58), t.push(this.parsePipe());else if (this.consumeOptionalCharacter(58)) t.push(this.parsePipe());else {
            let h = this.span(n),
              g = this.sourceSpan(n);
    ...
    parseAccessMember(e, t, s) {
      let n = this.inputIndex,
        i = this.withContext(pe.Writable, () => {
          var _this$expectIdentifie;
          let g = (_this$expectIdentifie = this.expectIdentifierOrKeyword()) !== null && _this$expectIdentifie !== void 0 ? _this$expectIdentifie : "";
          return g.length === 0 && this.error("Expected identifier for property access", e.span.end), g;
        }),
        a = this.sourceSpan(n),
        h;
      if (s) this.consumeOptionalAssignment() ? (this.error("The '?.' operator cannot be used in the assignment"), h = new $(this.span(t), this.sourceSpan(t))) : h = new z(this.span(t), this.sourceSpan(t), a, e, i);else if (this.consumeOptionalAssignment()) {
    ...
    consumeOptionalAssignment() {
      return this.parseFlags & 2 && this.next.isOperator("!") && this.peek(1).isOperator("=") ? (this.advance(), this.advance(), !0) : this.consumeOptionalOperator("=");
    }
    parseCallArguments() {
      if (this.next.isCharacter(41)) return [];
      let e = [];
      do e.push(this.parsePipe()); while (this.consumeOptionalCharacter(44));
      return e;
    }
    expectTemplateBindingKey() {
      ...
      do e += this.expectIdentifierOrKeywordOrString(), t = this.consumeOptionalOperator("-"), t && (e += "-"); while (t);
      return {
        source: e,
    ...
    parseKeyedReadOrWrite(e, t, s) {
      return this.withContext(pe.Writable, () => {
        ...
        if (n instanceof $ && this.error("Key access cannot be empty"), this.rbracketsExpected--, this.expectCharacter(93), this.consumeOptionalOperator("=")) {
          if (s) this.error("The '?.' operator cannot be used in the assignment");else {
    ...
    _reportErrorForPrivateIdentifier(e, t) {
      let s = "Private identifiers are not supported. Unexpected private identifier: ".concat(e);
      t !== null && (s += ", ".concat(t)), this.error(s);
    }
    skip() {
      let e = this.next;
...
function ut(r) {
  return Oe(r, (e, t) => t.parseBinding(e, ...Ae));
}
function xt(r) {
  return Oe(r, (e, t) => t.parseAction(e, !1, ...Ae));
}
function dt(r) {
  return Oe(r, (e, t) => {
  ...
  let e = pt(),
    {
      templateBindings: t,
      errors: s
    } = e.parseTemplateBindings(De, r, ht, Ue, Ue);
  return vt(s), t;
}
function vt(r) {
  if (r.length !== 0) {
...
function mt(r) {
  return typeof r == "string" ? e => e === r : e => r.test(e);
}
function wt(r, e, t) {
  let s = mt(e);
  for (let n = t; n >= 0; n--) {
  ...
  throw new Error("Cannot find front char ".concat(e, " from index ").concat(t, " in ").concat(JSON.stringify(r)));
}
function yt(r, e, t) {
  let s = mt(e);
  ...
  throw new Error("Cannot find character ".concat(e, " from index ").concat(t, " in ").concat(JSON.stringify(r)));
}
function Et(r) {
...
var $r = (r, e, t) => {
    if (!(r && e == null)) return Array.isArray(e) || typeof e == "string" ? e[t < 0 ? e.length + t : t] : e.at(t);
  },
  Ne = $r;
var D = function (r, e) {
  ...
  switch (s) {
    ...
    case "BindingPipe":
      {
        let {
          ...
          c = n(o),
          x = e.getCharacterIndex(/\S/, e.getCharacterIndex("|", S(c)) + 1),
          l = a("Identifier", {
            name: u
          }, {
            start: x,
    ...
    case "EmptyExpr":
      return a("NGEmptyExpression", {}, r.sourceSpan, {
        hasParentParens: t
      });
    case "ImplicitReceiver":
      return a("ThisExpression", {}, r.sourceSpan, {
        hasParentParens: t
      });
    case "KeyedRead":
    case "SafeKeyedRead":
      {
        let o = s === "SafeKeyedRead",
          ...
          v = Object.prototype.hasOwnProperty.call(r, "receiver") ? r.receiver : r.obj,
          c = n(u);
        return h(v, c, {
          computed: !0,
          optional: o
        ...
        let {
          ...
          c = o.map((_ref5, p) => {
            ...
            let k = v[p],
              m = E(k),
              N = S(k),
              ue = e.getCharacterIndex(/\S/, p === 0 ? r.sourceSpan.start + 1 : e.getCharacterIndex(",", S(v[p - 1])) + 1),
              It = m === ue ? N : e.getCharacterLastIndex(/\S/, e.getCharacterLastIndex(":", m - 1) - 1) + 1,
              He = {
                start: ue,
                end: It
              },
    ...
    case "LiteralPrimitive":
      {
        ...
        switch (typeof o) {
          ...
          case "object":
            return a("NullLiteral", {}, r.sourceSpan, {
              hasParentParens: t
            });
          case "string":
          ...
          default:
            throw new Error("Unexpected LiteralPrimitive value type ".concat(typeof o));
        }
      }
    case "Call":
    case "SafeCall":
      {
        let o = s === "SafeCall",
          ...
          c = v.length === 1 ? [i(v[0])] : v.map(n),
          x = n(u),
          l = d(x),
          p = o || l ? "OptionalCallExpression" : "CallExpression";
        return a(p, {
          callee: x,
          arguments: c,
    ...
    case "SafePropertyRead":
      {
        let o = s === "SafePropertyRead",
          ...
          c = e.getCharacterLastIndex(/\S/, r.sourceSpan.end - 1) + 1,
          x = a("Identifier", {
            name: v
          }, {
            start: c - v.length,
    ...
    case "PropertyWrite":
      {
        let {
          ...
          c = n(v),
          x = e.getCharacterLastIndex(/\S/, e.getCharacterLastIndex("=", E(c) - 1) - 1) + 1,
          l = a("Identifier", {
            name: u
          }, {
            start: x - u.length,
    ...
    default:
      throw new Error("Unexpected node ".concat(s));
  }
  function n(o) {
    return D(o, e);
  }
...
function $t(r, e) {
  ...
  let [t] = r,
    ...
    n = e.text.slice(t.sourceSpan.start, t.sourceSpan.end).trim().length === 0 ? r.slice(1) : r,
    i = [],
    a = null;
  for (let c = 0; c < n.length; c++) {
    ...
    if (a && E(a) && S(x) && x.value && x.value.source === a.key.source) {
      let l = d("NGMicrosyntaxKey", {
        ...
        m = i.pop();
      if (m.type === "NGMicrosyntaxExpression") i.push(k(m));else if (m.type === "NGMicrosyntaxKeyedExpression") {
        let N = k(m.expression);
        i.push(p({
          ...m,
          expression: N
        }, N.end));
      } else throw new Error("Unexpected type ".concat(m.type));
    } else i.push(h(x, c));
    a = x;
  }
  return d("NGMicrosyntax", {
    body: i
  }, i.length === 0 ? r[0].sourceSpan : {
    start: i[0].start,
    end: Ne(!1, i, -1).end
  });
  function h(c, x) {
...
var Ct = ke(ut),
  At = ke(dt),
  Ge = ke(xt),
  Ot = r => $t(ft(r), new ve(r));
function We(r) {
  var _ref6, _ref7;
  var s, n, i;
  let e = (_ref6 = (s = r.range) == null ? void 0 : s[0]) !== null && _ref6 !== void 0 ? _ref6 : r.start,
    t = (i = (_ref7 = (n = r.declaration) == null ? void 0 : n.decorators) !== null && _ref7 !== void 0 ? _ref7 : r.decorators) == null ? void 0 : i[0];
  return t ? Math.min(We(t), e) : e;
}
function Nt(r) {
  var _ref8;
  var e;
  return (_ref8 = (e = r.range) == null ? void 0 : e[1]) !== null && _ref8 !== void 0 ? _ref8 : r.end;
}
function Re(r) {
  return {
    astFormat: "estree",
    parse(e) {
      ...
      return {
        type: "NGRoot",
        node: r === Ge && t.type !== "NGChainedExpression" ? {
          ...t,
...
exports.default = hs;
exports.parsers = Ve;
//# sourceMappingURL=angular-xdwV3Kt6.js.map
