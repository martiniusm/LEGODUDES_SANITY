...
var Dt = (a, t) => () => (t || a((t = {
  ...
  Qs = (a, t) => {
    for (var e in t) $e(a, e, {
      get: t[e],
      enumerable: !0
    });
  },
  Zs = (a, t, e, s) => {
    if (t && typeof t == "object" || typeof t == "function") for (let i of Xs(t)) !Ys.call(a, i) && i !== e && $e(a, i, {
      get: () => t[i],
      enumerable: !(s = Js(t, i)) || s.enumerable
    });
    return a;
  };
var Ve = (a, t, e) => (e = a != null ? Ws(Gs(a)) : {}, Zs(t || !a || !a.__esModule ? $e(e, "default", {
  value: a,
  enumerable: !0
}) : e, a));
var wt = Dt(Pe => {
  ...
  var Mt = "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED",
    ...
    Ee = _ref => {
      ...
      return a === "UpdateExpression" ? Ot.UpdateExpression[String(t)] : Ot[a];
    },
    ti = {
      AccessorIsGenerator: _ref2 => {
        let {
          kind: a
        } = _ref2;
        return "A ".concat(a, "ter cannot be a generator.");
      },
      ...
      DeclarationMissingInitializer: _ref3 => {
        let {
          kind: a
        } = _ref3;
        return "Missing initializer in ".concat(a, " declaration.");
      },
      ...
      DuplicateExport: _ref4 => {
        let {
          exportName: a
        } = _ref4;
        return "`".concat(a, "` has already been exported. Exported identifiers must be unique.");
      },
      DuplicateProto: "Redefinition of __proto__ property.",
      DuplicateRegExpFlags: "Duplicate regular expression flag.",
      DynamicImportPhaseRequiresImportExpressions: _ref5 => {
        let {
          phase: a
        } = _ref5;
        return "'import.".concat(a, "(...)' can only be parsed when using the 'createImportExpressions' option.");
      },
      ElementAfterRest: "Rest element must be last element.",
      EscapedCharNotAnIdentifier: "Invalid Unicode escape.",
      ExportBindingIsString: _ref6 => {
        let {
          localName: a,
          exportName: t
        } = _ref6;
        return "A string literal cannot be used as an exported binding without `from`.\n- Did you mean `export { '".concat(a, "' as '").concat(t, "' } from 'some-module'`?");
      },
      ExportDefaultFromAsIdentifier: "'from' is not allowed as an identifier after 'export default'.",
      ForInOfLoopInitializer: _ref7 => {
        let {
          type: a
        } = _ref7;
        return "'".concat(a === "ForInStatement" ? "for-in" : "for-of", "' loop variable declaration may not have an initializer.");
      },
      ForInUsing: "For-in loop may not start with 'using' declaration.",
      ForOfAsync: "The left-hand side of a for-of loop may not be 'async'.",
      ForOfLet: "The left-hand side of a for-of loop may not start with 'let'.",
      GeneratorInSingleStatementContext: "Generators can only be declared at the top level or inside a block.",
      IllegalBreakContinue: _ref8 => {
        let {
          type: a
        } = _ref8;
        return "Unsyntactic ".concat(a === "BreakStatement" ? "break" : "continue", ".");
      },
      IllegalLanguageModeDirective: "Illegal 'use strict' directive in function with non-simple parameter list.",
      IllegalReturn: "'return' outside of function.",
      ImportAttributesUseAssert: "The `assert` keyword in import attributes is deprecated and it has been replaced by the `with` keyword. You can enable the `deprecatedAssertSyntax: true` option in the import attributes plugin to suppress this error.",
      ImportBindingIsString: _ref9 => {
        let {
          importName: a
        } = _ref9;
        return "A string literal cannot be used as an imported binding.\n- Did you mean `import { \"".concat(a, "\" as foo }`?");
      },
      ImportCallArgumentTrailingComma: "Trailing comma is disallowed inside import(...) arguments.",
      ImportCallArity: _ref10 => {
        let {
          maxArgumentCount: a
        } = _ref10;
        return "`import()` requires exactly ".concat(a === 1 ? "one argument" : "one or two arguments", ".");
      },
      ...
      InvalidDigit: _ref11 => {
        ...
        return "Expected number in radix ".concat(a, ".");
      },
      ...
      InvalidEscapedReservedWord: _ref12 => {
        ...
        return "Escape sequence in keyword ".concat(a, ".");
      },
      InvalidIdentifier: _ref13 => {
        let {
          identifierName: a
        } = _ref13;
        return "Invalid identifier ".concat(a, ".");
      },
      InvalidLhs: _ref14 => {
        let {
          ancestor: a
        } = _ref14;
        return "Invalid left-hand side in ".concat(Ee(a), ".");
      },
      InvalidLhsBinding: _ref15 => {
        let {
          ancestor: a
        } = _ref15;
        return "Binding invalid left-hand side in ".concat(Ee(a), ".");
      },
      InvalidLhsOptionalChaining: _ref16 => {
        let {
          ancestor: a
        } = _ref16;
        return "Invalid optional chaining in the left-hand side of ".concat(Ee(a), ".");
      },
      ...
      InvalidOrUnexpectedToken: _ref17 => {
        ...
        return "Unexpected character '".concat(a, "'.");
      },
      ...
      InvalidPrivateFieldResolution: _ref18 => {
        ...
        return "Private name #".concat(a, " is not defined.");
      },
      ...
      LabelRedeclaration: _ref19 => {
        ...
        return "Label '".concat(a, "' is already declared.");
      },
      ...
      MissingPlugin: _ref20 => {
        ...
        return "This experimental syntax requires enabling the parser plugin: ".concat(a.map(t => JSON.stringify(t)).join(", "), ".");
      },
      MissingOneOfPlugins: _ref21 => {
        let {
          missingPlugin: a
        } = _ref21;
        return "This experimental syntax requires enabling one of the following parser plugin(s): ".concat(a.map(t => JSON.stringify(t)).join(", "), ".");
      },
      ...
      ModuleAttributesWithDuplicateKeys: _ref22 => {
        ...
        return "Duplicate key \"".concat(a, "\" is not allowed in module attributes.");
      },
      ModuleExportNameHasLoneSurrogate: _ref23 => {
        let {
          surrogateCharCode: a
        } = _ref23;
        return "An export name cannot include a lone surrogate, found '\\u".concat(a.toString(16), "'.");
      },
      ModuleExportUndefined: _ref24 => {
        let {
          localName: a
        } = _ref24;
        return "Export '".concat(a, "' is not defined.");
      },
      ...
      PrivateInExpectedIn: _ref25 => {
        ...
        return "Private names are only allowed in property accesses (`obj.#".concat(a, "`) or in `in` expressions (`#").concat(a, " in obj`).");
      },
      PrivateNameRedeclaration: _ref26 => {
        let {
          identifierName: a
        } = _ref26;
        return "Duplicate private name #".concat(a, ".");
      },
      ...
      UnexpectedKeyword: _ref27 => {
        ...
        return "Unexpected keyword '".concat(a, "'.");
      },
      ...
      UnexpectedReservedWord: _ref28 => {
        ...
        return "Unexpected reserved word '".concat(a, "'.");
      },
      ...
      UnexpectedToken: _ref29 => {
        ...
        return "Unexpected token".concat(t ? " '".concat(t, "'.") : "").concat(a ? ", expected \"".concat(a, "\"") : "");
      },
      ...
      UnsupportedMetaProperty: _ref30 => {
        ...
        return "The only valid meta property for ".concat(a, " is ").concat(a, ".").concat(t, ".");
      },
      ...
      VarRedeclaration: _ref31 => {
        ...
        return "Identifier '".concat(a, "' has already been declared.");
      },
    ...
    si = {
      ...
      StrictEvalArguments: _ref32 => {
        ...
        return "Assigning to '".concat(a, "' in strict mode.");
      },
      StrictEvalArgumentsBinding: _ref33 => {
        let {
          bindingName: a
        } = _ref33;
        return "Binding '".concat(a, "' in strict mode.");
      },
    ...
    ri = {
      ...
      PipeTopicUnconfiguredToken: _ref34 => {
        ...
        return "Invalid topic token ".concat(a, ". In order to use ").concat(a, " as a topic reference, the pipelineOperator plugin must be configured with { \"proposal\": \"hack\", \"topicToken\": \"").concat(a, "\" }.");
      },
      ...
      PipeUnparenthesizedBody: _ref35 => {
        ...
        return "Hack-style pipe body cannot be an unparenthesized ".concat(Ee({
          type: a
  ...
  function oi(a) {
    ...
    return function s(i, r) {
      ...
      return Object.assign(n, e, {
        ...
        let h = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
        var l;
        let {
          line: c,
          column: u,
        ...
        configurable: !0,
        get() {
          let o = "".concat(t(r), " (").concat(i.line, ":").concat(i.column, ")");
  ...
  var p = Object.assign({}, $(ei), $(ti), $(si), $(_templateObject || (_templateObject = _taggedTemplateLiteral(["pipelineOperator"])))(ri)),
    {
      defineProperty: hi
    } = Object,
    Bt = (a, t) => hi(a, t, {
  ...
  var li = a => class extends a {
      ...
      parseClassProperty() {
        let s = super.parseClassProperty(...arguments);
        return this.getPluginOption("estree", "classFeatures") && (s.type = "PropertyDefinition"), s;
      }
      parseClassPrivateProperty() {
        let s = super.parseClassPrivateProperty(...arguments);
      ...
      resetEndLocation(e) {
        let s = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.state.lastTokEndLoc;
  ...
  function P(a) {
    let t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var e, s, i, r;
    return ++fe, mt.push(a), yt.push((e = t.binop) != null ? e : -1), xt.push((s = t.beforeExpr) != null ? s : !1), Pt.push((i = t.startsExpr) != null ? i : !1), gt.push((r = t.prefix) != null ? r : !1), U.push(new ve(a, t)), fe;
  }
  function T(a) {
    let t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var e, s, i, r;
    return ++fe, dt.set(a, fe), mt.push(a), yt.push((e = t.binop) != null ? e : -1), xt.push((s = t.beforeExpr) != null ? s : !1), Pt.push((i = t.startsExpr) != null ? i : !1), gt.push((r = t.prefix) != null ? r : !1), U.push(new ve("name", t)), fe;
  }
  var pi = {
    bracketL: P("[", {
      beforeExpr: b,
  ...
  var At = {
    ...
    Ci = new Set(At.keyword),
    Ei = new Set(At.strict),
    Ii = new Set(At.strictBind);
  function Zt(a, t) {
  ...
  var vi = new Set(["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete", "implements", "interface", "let", "package", "private", "protected", "public", "static", "yield", "eval", "arguments", "enum", "await"]);
  function Li(a) {
    return vi.has(a);
  }
  var me = class {
  ...
  var Ze = class extends Qe {
      ...
      finalizeComment(t) {
        ...
        if (t.leadingNode !== null || t.trailingNode !== null) t.leadingNode !== null && is(t.leadingNode, e), t.trailingNode !== null && Di(t.trailingNode, e);else {
          let {
            containingNode: s,
            start: i
          } = t;
  ...
  var et = class a {
      constructor() {
        this.flags = 1024, this.curLine = void 0, this.lineStart = void 0, this.startLoc = void 0, this.endLoc = void 0, this.errors = [], this.potentialArrowAt = -1, this.noArrowAt = [], this.noArrowParamsConversionAt = [], this.topicContext = {
          ...
          maxTopicIndex: null
        }, this.labels = [], this.commentsLen = 0, this.commentStack = [], this.pos = 0, this.type = 139, this.value = null, this.start = 0, this.end = 0, this.lastTokEndLoc = null, this.lastTokStartLoc = null, this.context = [w.brace], this.firstInvalidTemplateEscapePos = null, this.strictErrors = new Map(), this.tokensLength = 0;
      }
      get strict() {
      ...
      case 120:
        {
          ...
          return ({
            code: l,
            pos: t
          } = tt(a, t, e, s, 2, !1, n, r)), o(l === null ? null : String.fromCharCode(l));
        }
      case 117:
        {
          let l;
          return ({
            code: l,
            pos: t
          } = ns(a, t, e, s, n, r)), o(l === null ? null : String.fromCodePoint(l));
        }
      case 116:
        return o("	");
      case 98:
  ...
  function tt(a, t, e, s, i, r, n, o) {
    ...
    return ({
      n: l,
      pos: t
    } = as(a, t, e, s, 16, i, r, !1, o, !n)), l === null && (n ? o.invalidEscapeSequence(h, e, s) : t = h - 1), {
      code: l,
      pos: t
    };
  }
  function as(a, t, e, s, i, r, n, o, h, l) {
    let c = t,
      ...
      d = !1,
      y = 0;
    for (let I = 0, C = r !== null && r !== void 0 ? r : 1 / 0; I < C; ++I) {
      let E = a.charCodeAt(t),
        k;
      if (E === 95 && o !== "bail") {
        let Se = a.charCodeAt(t - 1),
          oe = a.charCodeAt(t + 1);
        if (o) {
      ...
      if (E >= 97 ? k = E - 97 + 10 : E >= 65 ? k = E - 65 + 10 : Oi(E) ? k = E - 48 : k = 1 / 0, k >= i) {
        ...
        if (k <= 9 && h.invalidDigit(t, e, s, i)) k = 0;else if (n) k = 0, d = !0;else break;
      }
      ++t, y = y * i + k;
    }
  ...
  function ns(a, t, e, s, i, r) {
    ...
    if (n === 123) {
      if (++t, ({
        code: o,
        pos: t
      } = tt(a, t, e, s, a.indexOf("}", t) - t, !0, i, r)), ++t, o !== null && o > 1114111) if (i) r.invalidCodePoint(t, e, s);else return {
        code: null,
        pos: t
      };
    } else ({
  ...
  var Ri = new Set([103, 109, 115, 105, 121, 117, 100, 118]),
    O = class {
      constructor(t) {
    ...
    st = class extends Ze {
      ...
      setStrict(t) {
        this.state.strict = t, t && (this.state.strictErrors.forEach(_ref38 => {
          let [e, s] = _ref38;
          return this.raise(e, s);
        ...
        e: for (; this.state.pos < this.length;) {
          ...
          switch (s) {
            ...
            case 47:
              ...
              break;
            default:
              if (Mi(s)) ++this.state.pos;else if (s === 45 && !this.inModule && this.options.annexB) {
      ...
      readRegexp() {
        ...
        for (;; ++r) {
          ...
          if (s) s = !1;else {
            if (l === 91) i = !0;else if (l === 93 && i) i = !1;else if (l === 47 && !i) break;
            s = l === 92;
          }
        }
        ...
        for (; r < this.length;) {
          ...
          if (Ri.has(l)) l === 118 ? o.includes("u") && this.raise(p.IncompatibleRegExpUVFlags, h()) : l === 117 && o.includes("v") && this.raise(p.IncompatibleRegExpUVFlags, h()), o.includes(c) && this.raise(p.DuplicateRegExpFlags, h());else if (Z(l) || l === 92) this.raise(p.MalformedRegExpFlags, h());else break;
          ++r, o += c;
        }
      ...
      readInt(t, e) {
        ...
        let {
          n: r,
          pos: n
        } = as(this.input, this.state.pos, this.state.lineStart, this.state.curLine, t, e, s, i, this.errorHandlers_readInt, !1);
      ...
      readCodePoint(t) {
        let {
          code: e,
          pos: s
        } = ns(this.input, this.state.pos, this.state.lineStart, this.state.curLine, t, this.errorHandlers_readCodePoint);
      ...
      readString(t) {
        let {
          ...
          curLine: i,
          lineStart: r
        } = jt(t === 34 ? "double" : "single", this.input, this.state.pos + 1, this.state.lineStart, this.state.curLine, this.errorHandlers_readStringContents_string);
        ...
        let t = this.input[this.state.pos],
          {
            ...
            curLine: r,
            lineStart: n
          } = jt("template", this.input, this.state.pos + 1, this.state.lineStart, this.state.curLine, this.errorHandlers_readStringContents_template);
      ...
      readWord1(t) {
        ...
        for (t !== void 0 && (this.state.pos += t <= 65535 ? 1 : 2); this.state.pos < this.length;) {
          ...
          if (Z(r)) this.state.pos += r <= 65535 ? 1 : 2;else if (r === 92) {
      ...
      updateContext(t) {}
      unexpected(t, e) {
        throw this.raise(p.UnexpectedToken, t !== null && t !== void 0 ? t : this.state.startLoc, {
          expected: e ? H(e) : null
        });
      }
      expectPlugin(t, e) {
        if (this.hasPlugin(t)) return !0;
        throw this.raise(p.MissingPlugin, e !== null && e !== void 0 ? e : this.state.startLoc, {
          missingPlugin: [t]
        });
      }
      expectOnePlugin(t) {
    ...
    at = class {
      ...
      validateAsPattern() {
        let {
          ...
          e = t[t.length - 1];
        e.canBeArrowParameterDeclaration() && e.iterateErrors(_ref39 => {
          let [s, i] = _ref39;
  ...
  var ot = class extends st {
      ...
      tryParse(t) {
        ...
        try {
          let i = t(function () {
            let r = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
            throw s.node = r, s;
          });
      ...
      initializeScopes() {
        let t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.options.sourceType === "module";
  ...
  var ht = class extends ot {
      ...
      resetEndLocation(t) {
        let e = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.state.lastTokEndLoc;
    ...
    qi = new Set(["_", "any", "bool", "boolean", "empty", "extends", "false", "interface", "mixed", "null", "number", "static", "string", "true", "typeof", "void"]),
    g = $(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["flow"])))({
      AmbiguousConditionalArrow: "Ambiguous expression: wrap the arrow functions in parentheses to disambiguate.",
      AmbiguousDeclareModuleKind: "Found both `declare module.exports` and `declare export` in the same module. Modules can only have 1 since they are either an ES module or they are a CommonJS module.",
      AssignReservedType: _ref40 => {
        let {
          reservedType: a
        } = _ref40;
        return "Cannot overwrite reserved type ".concat(a, ".");
      },
      DeclareClassElement: "The `declare` modifier can only appear on class fields.",
      DeclareClassFieldInitializer: "Initializers are not allowed in fields with the `declare` modifier.",
      DuplicateDeclareModuleExports: "Duplicate `declare module.exports` statement.",
      EnumBooleanMemberNotInitialized: _ref41 => {
        let {
          memberName: a,
          enumName: t
        } = _ref41;
        return "Boolean enum members need to be initialized. Use either `".concat(a, " = true,` or `").concat(a, " = false,` in enum `").concat(t, "`.");
      },
      EnumDuplicateMemberName: _ref42 => {
        let {
          memberName: a,
          enumName: t
        } = _ref42;
        return "Enum member names need to be unique, but the name `".concat(a, "` has already been used before in enum `").concat(t, "`.");
      },
      EnumInconsistentMemberValues: _ref43 => {
        let {
          enumName: a
        } = _ref43;
        return "Enum `".concat(a, "` has inconsistent member initializers. Either use no initializers, or consistently use literals (either booleans, numbers, or strings) for all member initializers.");
      },
      EnumInvalidExplicitType: _ref44 => {
        let {
          invalidEnumType: a,
          enumName: t
        } = _ref44;
        return "Enum type `".concat(a, "` is not valid. Use one of `boolean`, `number`, `string`, or `symbol` in enum `").concat(t, "`.");
      },
      EnumInvalidExplicitTypeUnknownSupplied: _ref45 => {
        let {
          enumName: a
        } = _ref45;
        return "Supplied enum type is not valid. Use one of `boolean`, `number`, `string`, or `symbol` in enum `".concat(a, "`.");
      },
      EnumInvalidMemberInitializerPrimaryType: _ref46 => {
        let {
          enumName: a,
          memberName: t,
          explicitType: e
        } = _ref46;
        return "Enum `".concat(a, "` has type `").concat(e, "`, so the initializer of `").concat(t, "` needs to be a ").concat(e, " literal.");
      },
      EnumInvalidMemberInitializerSymbolType: _ref47 => {
        let {
          enumName: a,
          memberName: t
        } = _ref47;
        return "Symbol enum members cannot be initialized. Use `".concat(t, ",` in enum `").concat(a, "`.");
      },
      EnumInvalidMemberInitializerUnknownType: _ref48 => {
        let {
          enumName: a,
          memberName: t
        } = _ref48;
        return "The enum member initializer for `".concat(t, "` needs to be a literal (either a boolean, number, or string) in enum `").concat(a, "`.");
      },
      EnumInvalidMemberName: _ref49 => {
        let {
          enumName: a,
          memberName: t,
          suggestion: e
        } = _ref49;
        return "Enum member names cannot start with lowercase 'a' through 'z'. Instead of using `".concat(t, "`, consider using `").concat(e, "`, in enum `").concat(a, "`.");
      },
      EnumNumberMemberNotInitialized: _ref50 => {
        let {
          enumName: a,
          memberName: t
        } = _ref50;
        return "Number enum members need to be initialized, e.g. `".concat(t, " = 1` in enum `").concat(a, "`.");
      },
      EnumStringMemberInconsistentlyInitialized: _ref51 => {
        let {
          enumName: a
        } = _ref51;
        return "String enum members need to consistently either all use initializers, or use no initializers, in enum `".concat(a, "`.");
      },
      ...
      UnexpectedReservedType: _ref52 => {
        let {
          reservedType: a
        } = _ref52;
        return "Unexpected reserved type ".concat(a, ".");
      },
      ...
      UnsupportedDeclareExportKind: _ref53 => {
        let {
          unsupportedExportKind: a,
          suggestion: t
        } = _ref53;
        return "`declare export ".concat(a, "` is not supported. Use `").concat(t, "` instead.");
      },
  ...
  var Wi = /\*?\s*@((?:no)?flow)\b/,
    Ji = a => class extends a {
      ...
      flowParseObjectType(_ref54) {
        ...
        for (s && this.match(6) ? (this.expect(6), l = 9, c = !0) : (this.expect(5), l = 8, c = !1), h.exact = c; !this.match(l);) {
          ...
          if (this.eat(0)) y != null && this.unexpected(y), this.eat(0) ? (E && this.unexpected(E.loc.start), h.internalSlots.push(this.flowParseObjectTypeInternalSlot(C, d))) : h.indexers.push(this.flowParseObjectTypeIndexer(C, d, E));else if (this.match(10) || this.match(47)) y != null && this.unexpected(y), E && this.unexpected(E.loc.start), h.callProperties.push(this.flowParseObjectTypeCallProperty(C, d));else {
            ...
            let Se = this.flowParseObjectTypeProperty(C, d, y, E, k, i, n !== null && n !== void 0 ? n : !c);
        ...
        if (l || u.length > 0) {
          ...
          if (u.length > 0) {
            ...
            ({
              consequent: h,
              failed: l
            } = this.tryParseConditionalConsequent()), [c, u] = this.getArrowLikeExpressions(h);
          }
          l && c.length > 1 && this.raise(g.AmbiguousConditionalArrow, r.startLoc), l && c.length === 1 && (this.state = r, f.push(c[0].start), this.state.noArrowAt = f, ({
            consequent: h,
            failed: l
          } = this.tryParseConditionalConsequent()));
        }
      ...
      parseImportSpecifier(e, s, i, r, n) {
        ...
        if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
          ...
          if (h !== null && M(this.state.type)) e.imported = this.parseIdentifier(!0), e.importKind = h;else {
      ...
      flowEnumErrorBooleanMemberNotInitialized(e, _ref55) {
        let {
          enumName: s,
          memberName: i
        } = _ref55;
      ...
      flowEnumStringMembers(e, s, _ref57) {
        let {
          enumName: i
        } = _ref57;
      ...
      flowEnumParseExplicitType(_ref58) {
        let {
          enumName: e
        } = _ref58;
    ...
    J = $(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["jsx"])))({
      AttributeIsEmpty: "JSX attributes must only be assigned a non-empty expression.",
      MissingClosingTagElement: _ref59 => {
        let {
          openingTagName: a
        } = _ref59;
        return "Expected corresponding JSX closing tag for <".concat(a, ">.");
      },
      MissingClosingTagFragment: "Expected corresponding JSX closing tag for <>.",
      UnexpectedSequenceExpression: "Sequence expressions cannot be directly nested inside JSX. Did you mean to wrap it in parentheses (...)?",
      UnexpectedToken: _ref60 => {
        let {
          unexpected: a,
          HTMLEntity: t
        } = _ref60;
        return "Unexpected token `".concat(a, "`. Did you mean `").concat(t, "` or `{'").concat(a, "'}`?");
      },
  ...
  var Xi = a => class extends a {
      ...
      jsxReadWord() {
        let e,
          s = this.state.pos;
        do e = this.input.charCodeAt(++this.state.pos); while (Z(e) || e === 45);
      ...
      updateContext(e) {
        ...
        if (i === 56 && e === 142) s.splice(-2, 2, w.j_cTag), this.state.canStartJSXElement = !1;else if (i === 142) s.push(w.j_oTag);else if (i === 143) {
          let r = s[s.length - 1];
    ...
    lt = class extends me {
      constructor() {
        super(...arguments), this.tsNames = new Map();
      }
    },
    ct = class extends ye {
      constructor() {
    ...
    Gi = (a, t) => Object.hasOwnProperty.call(a, t) && a[t],
    hs = a => a.type === "ParenthesizedExpression" ? hs(a.expression) : a,
    pt = class extends ht {
      toAssignable(t) {
  ...
  function Qi(a) {
    if (a == null) throw new Error("Unexpected ".concat(a, " value."));
    return a;
  }
  function Vt(a) {
    if (!a) throw new Error("Assert fail");
  }
  var x = $(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["typescript"])))({
    AbstractMethodHasImplementation: _ref62 => {
      let {
        methodName: a
      } = _ref62;
      return "Method '".concat(a, "' cannot have an implementation because it is marked abstract.");
    },
    AbstractPropertyHasInitializer: _ref63 => {
      let {
        propertyName: a
      } = _ref63;
      return "Property '".concat(a, "' cannot have an initializer because it is marked abstract.");
    },
    ...
    DeclareAccessor: _ref64 => {
      ...
      return "'declare' is not allowed in ".concat(a, "ters.");
    },
    ...
    DuplicateModifier: _ref66 => {
      ...
      return "Duplicate modifier: '".concat(a, "'.");
    },
    EmptyHeritageClauseType: _ref67 => {
      let {
        token: a
      } = _ref67;
      return "'".concat(a, "' list cannot be empty.");
    },
    ...
    IncompatibleModifiers: _ref68 => {
      ...
      return "'".concat(a[0], "' modifier cannot be used with '").concat(a[1], "' modifier.");
    },
    ...
    IndexSignatureHasAccessibility: _ref69 => {
      ...
      return "Index signatures cannot have an accessibility modifier ('".concat(a, "').");
    },
    ...
    InvalidModifierOnTypeMember: _ref70 => {
      ...
      return "'".concat(a, "' modifier cannot appear on a type member.");
    },
    InvalidModifierOnTypeParameter: _ref71 => {
      let {
        modifier: a
      } = _ref71;
      return "'".concat(a, "' modifier cannot appear on a type parameter.");
    },
    InvalidModifierOnTypeParameterPositions: _ref72 => {
      let {
        modifier: a
      } = _ref72;
      return "'".concat(a, "' modifier can only appear on a type parameter of a class, interface or type alias.");
    },
    InvalidModifiersOrder: _ref73 => {
      let {
        orderedModifiers: a
      } = _ref73;
      return "'".concat(a[0], "' modifier must precede '").concat(a[1], "' modifier.");
    },
    ...
    PrivateElementHasAccessibility: _ref74 => {
      ...
      return "Private elements cannot have an accessibility modifier ('".concat(a, "').");
    },
    ...
    SingleTypeParameterWithoutTrailingComma: _ref75 => {
      ...
      return "Single type parameter ".concat(a, " should have a trailing comma. Example usage: <").concat(a, ",>.");
    },
    ...
    UnsupportedSignatureParameterKind: _ref76 => {
      ...
      return "Name in a signature must be an Identifier, ObjectPattern or ArrayPattern, instead got ".concat(a, ".");
    }
  });
  function Zi(a) {
    switch (a) {
  ...
  var tr = a => class extends a {
    ...
    tsParseModifiers(_ref77, n) {
      ...
      for (;;) {
        let {
          ...
          c = this.tsParseModifier(e.concat(s !== null && s !== void 0 ? s : []), i);
        if (!c) break;
    ...
    tsParsePropertyOrMethodSignature(e, s) {
      ...
      if (this.match(10) || this.match(47)) {
        ...
        let n = "parameters",
          o = "typeAnnotation";
        if (r.kind === "get") r[n].length > 0 && (this.raise(p.BadGetterArity, this.state.curPosition()), this.isThisParam(r[n][0]) && this.raise(x.AccesorCannotDeclareThisParameter, this.state.curPosition()));else if (r.kind === "set") {
    ...
    tsParseTupleElementType() {
      ...
      if (l === 58) i = !0, n = !1, r = this.parseIdentifier(!0), this.expect(14), o = this.tsParseType();else if (l === 63) {
        n = !0;
    ...
    tsParseTypeAnnotation() {
      let e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !0;
      let s = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.startNode();
      return this.tsInType(() => {
    ...
    parseVarStatement(e, s) {
      ...
      for (let {
        id: o,
        init: h
      } of n.declarations) h && (s !== "const" || o.typeAnnotation ? this.raise(x.InitializerNotAllowedInAmbientContext, h) : ir(h, this.hasPlugin("estree")) || this.raise(x.ConstInitiailizerMustBeStringOrNumericLiteralOrLiteralEnumReference, h));
      return n;
    }
    ...
    parseMethod(e, s, i, r, n, o, h) {
      ...
      if (l.abstract && (this.hasPlugin("estree") ? !!l.value.body : !!l.body)) {
        ...
        this.raise(x.AbstractMethodHasImplementation, l, {
          methodName: u.type === "Identifier" && !l.computed ? u.name : "[".concat(this.input.slice(u.start, u.end), "]")
        });
      }
      return l;
    }
  ...
  var zt = $(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["placeholders"])))({
  ...
  function or(a) {
    ...
    if (N(a, "recordAndTuple") && K(a, "recordAndTuple", "syntaxType") != null && !Wt.includes(K(a, "recordAndTuple", "syntaxType"))) throw new Error("The 'syntaxType' option of the 'recordAndTuple' plugin must be one of: " + Wt.map(t => "'".concat(t, "'")).join(", "));
  ...
  var ut = class extends pt {
      ...
      parseExprOp(t, e, s) {
        if (this.isPrivateName(t)) {
          ...
          (s >= Ie(58) || !this.prodParam.hasIn || !this.match(58)) && this.raise(p.PrivateInExpectedIn, t, {
            identifierName: r
        ...
        if (yi(i) && (this.prodParam.hasIn || !this.match(58))) {
          ...
          if (r > s) {
            ...
            let o = i === 41 || i === 42,
              h = i === 40;
            if (h && (r = Ie(42)), this.next(), i === 39 && this.hasPlugin(["pipelineOperator", {
              proposal: "minimal"
      ...
      parseParenAndDistinguishExpression(t) {
        ...
        let n = this.state.startLoc,
          ...
          u;
        for (; !this.match(11);) {
          if (l) l = !1;else if (this.expect(12, h.optionalParametersLoc === null ? null : h.optionalParametersLoc), this.match(11)) {
      ...
      parseObjectProperty(t, e, s, i) {
        ...
        if (!t.computed && t.key.type === "Identifier") {
          if (this.checkReservedWord(t.key.name, t.key.loc.start, !0, !1), s) t.value = this.parseMaybeDefault(e, V(t.key));else if (this.match(29)) {
      ...
      parsePropertyName(t, e) {
        if (this.eat(0)) t.computed = !0, t.key = this.parseMaybeAssignAllowIn(), this.expect(3);else {
          let {
            ...
            r;
          if (M(s)) r = this.parseIdentifier(!0);else switch (s) {
            case 134:
      ...
      parseFunctionBody(t, e) {
        ...
        if (this.expressionScope.enter(os()), i) t.body = this.parseMaybeAssign(), this.checkParams(t, !1, e, !1);else {
  ...
  var ft = class extends ut {
      ...
      parseProgram(t) {
        let e = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 139;
        let s = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.options.sourceType;
      ...
      parseFunction(t) {
        ...
        return this.state.maybeInArrowParameters = !1, this.scope.enter(2), this.prodParam.enter(ke(n, t.generator)), i || (t.id = this.parseFunctionId()), this.parseFunctionParams(t, !1), this.withSmartMixTopicForbiddingContext(() => {
      ...
      parseClassMemberWithIsStatic(t, e, s, i) {
        ...
        } else if (this.isClassProperty()) d ? this.pushClassPrivateProperty(t, h) : this.pushClassProperty(t, o);else if (f && y.name === "async" && !this.isLineTerminator()) {
      ...
      parseClassId(t, e, s) {
        let i = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 8331;
        if (S(this.state.type)) t.id = this.parseIdentifier(), e && this.declareNameFromIdentifier(t.id, i);else if (s || !e) t.id = null;else throw this.raise(p.MissingClassName, this.state.startLoc);
      }
      parseClassSuper(t) {
      ...
      parseExport(t, e) {
        ...
        if (l || c || u) {
          var f;
          let d = t;
          if (this.checkExport(d, !0, !1, !!d.source), ((f = d.declaration) == null ? void 0 : f.type) === "ClassDeclaration") this.maybeTakeDecorators(e, d.declaration, d);else if (e) throw this.raise(p.UnsupportedDecoratorExport, t);
          return this.finishNode(d, "ExportNamedDeclaration");
        }
        if (this.eat(65)) {
          let d = t,
            y = this.parseExportDefaultExpression();
          if (d.declaration = y, y.type === "ClassDeclaration") this.maybeTakeDecorators(e, y, d);else if (e) throw this.raise(p.UnsupportedDecoratorExport, t);
      ...
      shouldParseExportDeclaration() {
        ...
        return t === 26 && (this.expectOnePlugin(["decorators", "decorators-legacy"]), this.hasPlugin("decorators")) ? (this.getPluginOption("decorators", "decoratorsBeforeExport") === !0 && this.raise(p.DecoratorBeforeExport, this.state.startLoc), !0) : t === 74 || t === 75 || t === 68 || t === 80 || this.isLet() || this.isAsyncFunction();
      }
      checkExport(t, e, s, i) {
        if (e) {
          var r;
      ...
      isJSONModuleImport(t) {
        return t.assertions != null ? t.assertions.some(_ref78 => {
          let {
            key: e,
            value: s
          } = _ref78;
      ...
      finishImportSpecifier(t, e) {
        let s = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 8201;
...
var Ds = Dt(G => {
  ...
  function Ls(a) {
    ...
    let e = "";
    for (; e !== a;) e = a, a = a.replace(jr, "".concat(t, "$1 $2").concat(t));
    a = a.replace(Es, "").trimRight();
    let s = Object.create(null),
      i = a.replace(Is, "").replace(Es, "").trimRight(),
      r;
    for (; r = Is.exec(a);) {
  ...
  function Kr(_ref79) {
    ...
    let e = "\n",
      ...
      r = " */",
      n = Object.keys(t),
      o = n.flatMap(l => Ns(l, t[l])).map(l => "".concat(i, " ").concat(l).concat(e)).join("");
    if (!a) {
      if (n.length === 0) return "";
      if (n.length === 1 && !Array.isArray(t[n[0]])) {
        let l = t[n[0]];
        return "".concat(s, " ").concat(Ns(n[0], l)[0]).concat(r);
      }
    }
    let h = a.split(e).map(l => "".concat(i, " ").concat(l)).join(e) + e;
    return s + e + (a ? h : "") + (a && n.length ? i + e : "") + o + r;
  }
  function Ns(a, t) {
    return vs.concat(t).map(e => "@".concat(a, " ").concat(e).trim());
  }
});
var Lt = {};
Qs(Lt, {
...
function D(a) {
  var _ref80, _ref81;
  var s, i, r;
  let t = (_ref80 = (s = a.range) == null ? void 0 : s[0]) !== null && _ref80 !== void 0 ? _ref80 : a.start,
    e = (r = (_ref81 = (i = a.declaration) == null ? void 0 : i.decorators) !== null && _ref81 !== void 0 ? _ref81 : a.decorators) == null ? void 0 : r[0];
  return e ? Math.min(D(e), t) : t;
}
function B(a) {
  var _ref82;
  var t;
  return (_ref82 = (t = a.range) == null ? void 0 : t[1]) !== null && _ref82 !== void 0 ? _ref82 : a.end;
}
function Ir(a) {
  let t = new Set(a);
...
function Dr(a) {
  ...
  function e(s) {
    let i = s[t],
      r = a[i];
    if (!Array.isArray(r)) throw Object.assign(new Error("Missing visitor keys for '".concat(i, "'.")), {
      node: s
    });
    return r;
  }
...
function ea(a, t, e) {
  let s = a(t, e),
    i = s.errors.find(r => !sa.has(r.reasonCode));
  if (i) throw i;
  return s;
}
function ta(_ref83) {
  ...
  return function (e) {
    var _s$__babelSourceType;
    let s = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    if ((s.parser === "babel" || s.parser === "__babel_estree") && Zr(e, s)) return s.parser = "babel-flow", Vs.parse(e, s);
    let i = t;
    ((_s$__babelSourceType = s.__babelSourceType) !== null && _s$__babelSourceType !== void 0 ? _s$__babelSourceType : Os(s)) === "script" && (i = i.map(l => ({
      ...l,
      sourceType: "script"
    }))), /#[[{]/.test(e) && (i = i.map(l => R([Yr], l)));
    let n = /%[A-Z]/.test(e);
...
var sa = new Set(["StrictNumericEscape", "StrictWith", "StrictOctalLiteral", "StrictDelete", "StrictEvalArguments", "StrictEvalArgumentsBinding", "StrictFunction", "EmptyTypeArguments", "EmptyTypeParameters", "ConstructorHasTypeParameters", "UnsupportedParameterPropertyKind", "DuplicateAccessibilityModifier", "DecoratorExportClass", "ParamDupe", "InvalidDecimal", "RestTrailingComma", "UnsupportedParameterDecorator", "UnterminatedJsxContent", "UnexpectedReservedWord", "ModuleAttributesWithDuplicateKeys", "LineTerminatorBeforeArrow", "InvalidEscapeSequenceTemplate", "NonAbstractClassHasAbstractMethod", "OptionalTypeBeforeRequired", "PatternIsOptional", "OptionalBindingPattern", "DeclareClassFieldHasInitializer", "TypeImportCannotSpecifyDefaultAndNamed", "DeclareFunctionHasImplementation", "ConstructorClassField", "VarRedeclaration", "InvalidPrivateFieldResolution", "DuplicateExport"]),
  $s = [R(["jsx"])],
  Rs = ae({
  ...
  ia = ae({
    optionsCombinations: $s.map(a => R(["estree"], a))
  }),
  qs = {
    babel: Rs,
    "babel-flow": Vs,
...
function W(a, t) {
  let [e, s] = [a.loc.start, a.loc.end].map(_ref84 => {
    let {
      line: i,
      column: r
    } = _ref84;
  ...
  return Re("".concat(t, " is not allowed in JSON."), {
    loc: {
      start: e,
      end: s
    }
    ...
    case "UnaryExpression":
      {
        ...
        if (t !== "+" && t !== "-") throw W(a, "Operator '".concat(a.operator, "'"));
        if (e.type === "NumericLiteral" || e.type === "Identifier" && (e.name === "Infinity" || e.name === "NaN")) return;
        throw W(e, "Operator '".concat(t, "' before '").concat(e.type, "'"));
      }
    case "Identifier":
      if (a.name !== "Infinity" && a.name !== "NaN" && a.name !== "undefined") throw W(a, "Identifier '".concat(a.name, "'"));
      return;
...
exports.default = Fn;
exports.parsers = aa;
//# sourceMappingURL=babel-vy_YSl4a.js.map
