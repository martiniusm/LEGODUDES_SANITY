...
var Wa = (e, t) => () => (t || e((t = {
  ...
  Na = (e, t, r, n) => {
    if (t && typeof t == "object" || typeof t == "function") for (let s of Ra(t)) !qa.call(e, s) && s !== r && On(e, s, {
      get: () => t[s],
      enumerable: !(n = ja(t, s)) || n.enumerable
    });
    return e;
  };
var Ga = (e, t, r) => (r = e != null ? Ma(Ja(e)) : {}, Na(t || !e || !e.__esModule ? On(r, "default", {
  value: e,
  enumerable: !0
}) : r, e));
var Ys = (e, t, r) => {
...
var it = (e, t, r) => (Ys(e, t, "read from private field"), r ? r.call(e) : t.get(e)),
  Xs = (e, t, r) => {
    if (t.has(e)) throw TypeError("Cannot add the same private member more than once");
    t instanceof WeakSet ? t.add(e) : t.set(e, r);
  },
  Vs = (e, t, r, n) => (Ys(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r);
var yi = Wa(Pt => {
  ...
  function Di(e) {
    let t = "\n";
    e = e.replace(Hp, "").replace($p, "").replace(Qp, "$1");
    let r = "";
    for (; r !== e;) r = e, e = e.replace(zp, "".concat(t, "$1 $2").concat(t));
    e = e.replace(oi, "").trimRight();
    let n = Object.create(null),
      s = e.replace(pi, "").replace(oi, "").trimRight(),
      u;
    for (; u = pi.exec(e);) {
      let i = u[2].replace(Kp, "");
      typeof n[u[1]] == "string" || Array.isArray(n[u[1]]) ? n[u[1]] = mi.concat(n[u[1]], i) : n[u[1]] = i;
    }
    return {
      comments: s,
      pragmas: n
  ...
  function rc(_ref) {
    ...
    let r = "\n",
      ...
      u = " */",
      i = Object.keys(t),
      a = i.flatMap(p => ci(p, t[p])).map(p => "".concat(s, " ").concat(p).concat(r)).join("");
    if (!e) {
      if (i.length === 0) return "";
      if (i.length === 1 && !Array.isArray(t[i[0]])) {
        let p = t[i[0]];
        return "".concat(n, " ").concat(ci(i[0], p)[0]).concat(u);
      }
    }
    let o = e.split(r).map(p => "".concat(s, " ").concat(p)).join(r) + r;
    return n + r + (e ? o : "") + (e && i.length ? s + r : "") + a + u;
  }
  function ci(e, t) {
    return mi.concat(t).map(r => "@".concat(e, " ").concat(r).trim());
  }
});
var qs = {};
Tr(qs, {
...
Tr(Rs, {
  canAttachComment: () => Fp,
  embed: () => ai,
  experimentalFeatures: () => Hl,
  getCommentChildNodes: () => Cp,
  getVisitorKeys: () => Br,
  handleComments: () => ns,
  insertPragma: () => Ei,
  isBlockComment: () => ee,
...
function* Ka(e, t) {
  ...
  for (let n = 0; n < r.length; n++) {
    let s = r[n];
    for (let u of Ha(s, t)) yield u, r.push(u);
  }
}
function zs(e, _ref2) {
  let {
...
function Qa(e) {
  ...
  for (let r of e) {
    ...
    n <= 31 || n >= 127 && n <= 159 || n >= 768 && n <= 879 || (t += tu(n) ? 1 : 2);
  }
  return t;
}
var Ze = Qa;
...
function eo(e, t) {
  ...
  let n = Je(e, r.backwards ? t - 1 : t, r),
    s = qe(e, n, r);
  return n !== s;
}
var Z = eo;
...
var Ot = to;
function ro(e, t) {
  return t === !1 ? !1 : e.charAt(t) === "/" && e.charAt(t + 1) === "/" ? nu(e, t) : t;
}
var vt = ro;
function no(e, t) {
  let r = null,
    n = t;
  for (; n !== r;) r = n, n = ru(e, n), n = Ot(e, n), n = Je(e, n);
  return n = vt(e, n), n = qe(e, n), n !== !1 && Z(e, n);
}
var _t = no;
function so(e) {
...
function ao(e, t) {
  let r = e.slice(1, -1),
    n = t.parser === "json" || t.parser === "jsonc" || t.parser === "json5" && t.quoteProps === "preserve" && !t.singleQuote ? '"' : t.__isInHtmlAttribute ? "'" : hr(r, t.singleQuote);
  return uu(r, n, !(t.parser === "css" || t.parser === "less" || t.parser === "scss" || t.__embeddedInHtml));
}
var at = ao;
function j(e) {
  var _ref3, _ref4;
  var n, s, u;
  let t = (_ref3 = (n = e.range) == null ? void 0 : n[0]) !== null && _ref3 !== void 0 ? _ref3 : e.start,
    r = (u = (_ref4 = (s = e.declaration) == null ? void 0 : s.decorators) !== null && _ref4 !== void 0 ? _ref4 : e.decorators) == null ? void 0 : u[0];
  return r ? Math.min(j(r), t) : t;
}
function I(e) {
  var _ref5;
  var t;
  return (_ref5 = (t = e.range) == null ? void 0 : t[1]) !== null && _ref5 !== void 0 ? _ref5 : e.end;
}
function gt(e, t) {
  let r = j(e);
...
function oo(e, t) {
  let r = I(e);
  return Number.isInteger(r) && r === I(t);
}
function iu(e, t) {
  return gt(e, t) && oo(e, t);
}
function co(e) {
  let t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "type";
  function r(n) {
    let s = n[t],
      u = e[s];
    if (!Array.isArray(u)) throw Object.assign(new Error("Missing visitor keys for '".concat(s, "'.")), {
      node: n
    });
    return u;
  }
...
var Do = M(["Block", "CommentBlock", "MultiLine"]),
  ee = Do;
var yo = M(["AnyTypeAnnotation", "ThisTypeAnnotation", "NumberTypeAnnotation", "VoidTypeAnnotation", "BooleanTypeAnnotation", "BigIntTypeAnnotation", "SymbolTypeAnnotation", "StringTypeAnnotation", "NeverTypeAnnotation", "UndefinedTypeAnnotation", "UnknownTypeAnnotation", "EmptyTypeAnnotation", "MixedTypeAnnotation"]),
  br = yo;
function fo(e, t) {
  let r = t.split(".");
...
function jt(e) {
  return e.type === "AssignmentExpression" || e.type === "BinaryExpression" || e.type === "LogicalExpression" || e.type === "NGPipeExpression" || e.type === "ConditionalExpression" || w(e) || q(e) || e.type === "SequenceExpression" || e.type === "TaggedTemplateExpression" || e.type === "BindExpression" || e.type === "UpdateExpression" && !e.prefix || Ae(e) || e.type === "TSNonNullExpression" || e.type === "ChainExpression";
}
function lu(e) {
  var _ref7, _ref8, _ref9, _ref10, _ref11, _e$left;
  return e.expressions ? e.expressions[0] : (_ref7 = (_ref8 = (_ref9 = (_ref10 = (_ref11 = (_e$left = e.left) !== null && _e$left !== void 0 ? _e$left : e.test) !== null && _ref11 !== void 0 ? _ref11 : e.callee) !== null && _ref10 !== void 0 ? _ref10 : e.object) !== null && _ref9 !== void 0 ? _ref9 : e.tag) !== null && _ref8 !== void 0 ? _ref8 : e.argument) !== null && _ref7 !== void 0 ? _ref7 : e.expression;
}
function Ir(e) {
...
var Rt = M(["Line", "CommentLine", "SingleLine", "HashbangComment", "HTMLOpen", "HTMLClose", "Hashbang", "InterpreterDirective"]),
  mu = M(["ExportDefaultDeclaration", "DeclareExportDeclaration", "ExportNamedDeclaration", "ExportAllDeclaration", "DeclareExportAllDeclaration"]),
  G = M(["ArrayExpression", "TupleExpression"]),
  se = M(["ObjectExpression", "RecordExpression"]);
function Pe(e) {
  return e.type === "NumericLiteral" || e.type === "Literal" && typeof e.value == "number";
}
function qn(e) {
  return e.type === "UnaryExpression" && (e.operator === "+" || e.operator === "-") && Pe(e.argument);
}
function te(e) {
...
var rr = M(["Literal", "BooleanLiteral", "BigIntLiteral", "DecimalLiteral", "DirectiveLiteral", "NullLiteral", "NumericLiteral", "RegExpLiteral", "StringLiteral"]),
  Du = M(["Identifier", "ThisExpression", "Super", "PrivateName", "PrivateIdentifier", "Import"]),
  Le = M(["ObjectTypeAnnotation", "TSTypeLiteral", "TSMappedType"]),
  Mt = M(["FunctionExpression", "ArrowFunctionExpression"]);
function Co(e) {
...
var U = M(["JSXElement", "JSXFragment"]);
function ht(e) {
...
function yu(e) {
  return (e.type === "TypeAnnotation" || e.type === "TSTypeAnnotation") && e.typeAnnotation.type === "FunctionTypeAnnotation" && !e.static && !gt(e, e.typeAnnotation);
}
var me = M(["BinaryExpression", "LogicalExpression", "NGPipeExpression"]);
function Et(e) {
  return q(e) || e.type === "BindExpression" && !!e.object;
}
var Ao = M(["TSThisType", "NullLiteralTypeAnnotation", "BooleanLiteralTypeAnnotation", "StringLiteralTypeAnnotation", "BigIntLiteralTypeAnnotation", "NumberLiteralTypeAnnotation", "TSLiteralType", "TSTemplateLiteralType"]);
function Jt(e) {
  return Pr(e) || br(e) || Ao(e) || (e.type === "GenericTypeAnnotation" || e.type === "TSTypeReference") && !e.typeParameters;
}
function To(e) {
...
function St(e, t) {
  ...
  if (e.arguments.length === 1) {
    if (_n(e) && t && St(t)) return Mt(e.arguments[0]);
    if (To(e)) return _n(e.arguments[0]);
  } else if ((e.arguments.length === 2 || e.arguments.length === 3) && (e.arguments[0].type === "TemplateLiteral" || te(e.arguments[0])) && go(e.callee)) return e.arguments[2] && !Pe(e.arguments[2]) ? !1 : (e.arguments.length === 2 ? Mt(e.arguments[1]) : Co(e.arguments[1]) && $(e.arguments[1]).length <= 1) || _n(e.arguments[1]);
  return !1;
}
var fu = e => t => ((t == null ? void 0 : t.type) === "ChainExpression" && (t = t.expression), e(t)),
  w = fu(M(["CallExpression", "OptionalCallExpression"])),
  q = fu(M(["MemberExpression", "OptionalMemberExpression"]));
function Eu(e) {
  let t = "expressions";
  e.type === "TSTemplateLiteralType" && (t = "types");
  let r = e[t];
  return r.length === 0 ? !1 : r.every(n => {
    if (Rn(n) || Fu(n)) return !0;
  });
}
function Fu(e) {
  let {
  ...
  if (A(e)) return !1;
  if (e.type === "ChainExpression") return Fu(e.expression, {
    maxDepth: t
  });
  if (!q(e)) return !1;
  let r = e,
    n = 0;
  for (; q(r) && n++ <= t;) if (!Rn(r.property) || (r = r.object, A(r))) return !1;
  return Rn(r);
}
function Rn(e) {
  return A(e) ? !1 : rr(e) || Du(e);
}
function Nn(e) {
...
function wr(e, t) {
  return (e.type === "TemplateLiteral" && pu(e) || e.type === "TaggedTemplateExpression" && pu(e.quasi)) && !Z(t, j(e), {
    backwards: !0
  });
}
function Or(e) {
  if (!A(e)) return !1;
  let t = v(!1, ot(e, x.Dangling), -1);
  return t && !ee(t);
}
function Au(e) {
  ...
  for (let r of e) if (Mt(r)) {
    ...
    for (let n of ae(r)) if (Mt(n)) return !0;
  }
  return !1;
}
function vr(e) {
...
function be(e) {
  ...
  let r = n => be(n, t - 1);
  if (Wn(e)) return Ze((_e$pattern = e.pattern) !== null && _e$pattern !== void 0 ? _e$pattern : e.regex.pattern) <= 5;
  if (rr(e) || Du(e) || e.type === "ArgumentPlaceholder") return !0;
  ...
  return q(e) ? be(e.object, t) && be(e.property, t) : e.type === "UnaryExpression" && So.has(e.operator) || e.type === "UpdateExpression" ? be(e.argument, t) : !1;
}
function De(e) {
  var _ref12;
  var t;
  return (_ref12 = (t = e.extra) == null ? void 0 : t.raw) !== null && _ref12 !== void 0 ? _ref12 : e.raw;
}
function du(e) {
  return e;
}
function ye(e) {
  let t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "es5";
...
function sr(e, t) {
  return !(er(t) !== er(e) || e === "**" || cu[e] && cu[t] || t === "%" && kr[e] || e === "%" && kr[t] || t !== e && kr[t] && kr[e] || Jn[e] && Jn[t]);
}
...
function ae(e) {
  ...
  if (e.type === "ChainExpression") return ae(e.expression);
  let t = e.arguments;
  return e.type === "ImportExpression" && (t = [e.source], e.attributes && t.push(e.attributes), e.options && t.push(e.options)), jn.set(e, t), t;
}
function ur(e, t) {
  let {
    node: r
  } = e;
  if (r.type === "ChainExpression") return e.call(() => ur(e, t), "expression");
...
function Yn(e, t) {
  let r = [];
  if (e.type === "ChainExpression" && r.push("expression"), e.type === "ImportExpression") {
...
function A(e, t, r) {
  if (!L(e == null ? void 0 : e.comments)) return !1;
  let n = hu(t, r);
...
function Ce(e) {
  return e && (e.type === "ObjectProperty" || e.type === "Property" && !ht(e));
}
var Ae = M(["TSAsExpression", "TSSatisfiesExpression", "AsExpression", "AsConstExpression", "SatisfiesExpression"]),
  We = M(["UnionTypeAnnotation", "TSUnionType"]),
  _r = M(["IntersectionTypeAnnotation", "TSIntersectionType"]);
var bo = new Set(["range", "raw", "comments", "leadingComments", "trailingComments", "innerComments", "extra", "start", "end", "loc", "flags", "errors", "tokens"]),
  qt = e => {
...
function Su(e, t, r) {
  ...
  if ((e.type === "Property" || e.type === "ObjectProperty" || e.type === "MethodDefinition" || e.type === "ClassProperty" || e.type === "ClassMethod" || e.type === "PropertyDefinition" || e.type === "TSDeclareMethod" || e.type === "TSPropertySignature" || e.type === "ObjectTypeProperty") && typeof e.key == "object" && e.key && (e.key.type === "Literal" || e.key.type === "NumericLiteral" || e.key.type === "StringLiteral" || e.key.type === "Identifier") && delete t.key, e.type === "JSXElement" && e.openingElement.name.name === "style" && e.openingElement.attributes.some(i => i.type === "JSXAttribute" && i.name.name === "jsx")) for (let {
    type: i,
    expression: a
  } of t.children) i === "JSXExpressionContainer" && a.type === "TemplateLiteral" && qt(a);
  e.type === "JSXAttribute" && e.name.name === "css" && e.value.type === "JSXExpressionContainer" && e.value.expression.type === "TemplateLiteral" && qt(t.value.expression), e.type === "JSXAttribute" && ((s = e.value) == null ? void 0 : s.type) === "Literal" && /["']|&quot;|&apos;/.test(e.value.value) && (t.value.value = H(!1, t.value.value, /["']|&quot;|&apos;/g, '"'));
...
var et = "string",
  ...
  Ye = "indent-if-break",
  Xe = "line-suffix",
  Ve = "line-suffix-boundary",
  ce = "line",
  Oe = "label",
  ve = "break-parent",
  Mr = new Set([tt, Ge, Ue, rt, pe, de, xe, Ye, Xe, Ve, ce, Oe, ve]);
function Po(e) {
...
var nt = Po;
var ko = e => new Intl.ListFormat("en-US", {
  type: "disjunction"
}).format(e);
function Io(e) {
  let t = e === null ? "null" : typeof e;
  if (t !== "string" && t !== "object") return "Unexpected doc '".concat(t, "', \nExpected it to be 'string' or 'object'.");
  if (nt(e)) throw new Error("doc is valid.");
  let r = Object.prototype.toString.call(e);
  if (r !== "[object Object]") return "Unexpected doc '".concat(r, "'.");
  let n = ko([...Mr].map(s => "'".concat(s, "'")));
  return "Unexpected doc.type '".concat(e.type, "'.\nExpected it to be ").concat(n, ".");
}
var Xn = class Xn extends Error {
    constructor(t) {
      (super(Io(t)), _defineProperty(this, "name", "InvalidDocError")), this.doc = t;
    }
  },
  Ft = Xn;
var bu = {};
...
var qr = e => {
  ...
  if (e.type !== de) throw new Error("Expect doc to be 'array' or '".concat(de, "'."));
  return e.parts;
};
function ct(e, t) {
...
function Oo(e) {
  if (e.type === pe && e.break || e.type === ce && e.hard || e.type === ve) return !0;
}
function re(e) {
  return wu(e, Oo, !1);
}
...
function Ou(e) {
  let t = new Set(),
    r = [];
  function n(u) {
    if (u.type === ve && Lu(r), u.type === pe) {
      if (r.push(u), t.has(u)) return !1;
      t.add(u);
    }
  }
  function s(u) {
    u.type === pe && r.pop().break && Lu(r);
  }
  Vn(e, n, s, !0);
}
function vo(e) {
  return e.type === ce && !e.hard ? e.soft ? "" : " " : e.type === xe ? e.flatContents : e;
}
function ar(e) {
  return ct(e, vo);
}
function _o(e) {
  switch (nt(e)) {
    ...
    case pe:
      ...
      if (e.contents.type === pe && e.contents.id === e.id && e.contents.break === e.break && e.contents.expandedStates === e.expandedStates) return e.contents;
      break;
    case Ue:
    case Ge:
    case Ye:
    ...
    case Ne:
      {
        ...
        for (let r of e) {
          ...
          typeof n == "string" && typeof v(!1, t, -1) == "string" ? t[t.length - 1] += n : t.push(n), t.push(...s);
        }
...
function Ie(e) {
  ...
  return ct(e, r => typeof r == "string" ? P(t, r.split("\n")) : r);
}
function Mo(e) {
...
function Mu(e, t) {
  let r = e.node;
  if (Rt(r)) return t.originalText.slice(j(r), I(r)).trimEnd();
  if (ee(r)) return _u(r) ? Ro(r) : ["/*", Ie(r.value), "*/"];
  throw new Error("Not a comment: " + JSON.stringify(r));
}
function Ro(e) {
  let t = e.value.split("\n");
  return ["/*", P(C, t.map((r, n) => n === 0 ? r.trimEnd() : " " + (n < t.length - 1 ? r.trim() : r.trimStart()))), "*/"];
}
var ns = {};
Tr(ns, {
  endOfLine: () => Yo,
...
function zn(e, t) {
  var _e$comments;
  ((_e$comments = e.comments) !== null && _e$comments !== void 0 ? _e$comments : e.comments = []).push(t), t.printed = !1, t.nodeDescription = Jo(e);
}
function oe(e, t) {
  t.leading = !0, t.trailing = !1, zn(e, t);
}
function he(e, t, r) {
  t.leading = !1, t.trailing = !1, r && (t.marker = r), zn(e, t);
}
function K(e, t) {
...
function qo(e, t) {
  let r = null,
    n = t;
  for (; n !== r;) r = n, n = Je(e, n), n = Ot(e, n), n = vt(e, n), n = qe(e, n);
  return n;
}
var lt = qo;
function Wo(e, t) {
...
var Te = No;
function Go(e) {
  return ee(e) && e.value[0] === "*" && /@(?:type|satisfies)\b/.test(e.value);
}
var ju = Go;
function Uo(e) {
  return [Yu, Ju, Nu, $o, Zn, es, Ru, qu, ip, sp, rs, Uu, ap, Wu, Gu, ts, Ho, fp].some(t => t(e));
}
function Yo(e) {
  return [Vo, Nu, Ju, Uu, Zn, es, Ru, qu, Gu, np, up, rs, cp, ts, Dp, yp].some(t => t(e));
}
function Xo(e) {
  return [Yu, Zn, es, Ko, rp, Wu, rs, tp, ep, mp, ts, lp].some(t => t(e));
}
function bt(e, t) {
  let r = (e.body || e.properties).find(_ref14 => {
    let {
      type: n
    } = _ref14;
...
function Qn(e, t) {
  e.type === "BlockStatement" ? bt(e, t) : oe(e, t);
}
function Vo(_ref15) {
  let {
    comment: e,
...
function Zn(_ref16) {
  ...
  if (Ke(s, I(e)) === ")") return K(t, e), !0;
  if (t === r.consequent && n === r.alternate) {
    if (t.type === "BlockStatement") K(t, e);else {
      let i = Rt(e) || e.loc.start.line === e.loc.end.line,
        a = e.loc.start.line === t.loc.start.line;
      i && a ? K(t, e) : he(r, e);
    }
    return !0;
  }
  return n.type === "BlockStatement" ? (bt(n, e), !0) : n.type === "IfStatement" ? (Qn(n.consequent, e), !0) : r.consequent === n ? (oe(n, e), !0) : !1;
}
function es(_ref17) {
  let {
    comment: e,
  ...
  return (r == null ? void 0 : r.type) !== "WhileStatement" || !n ? !1 : Ke(s, I(e)) === ")" ? (K(t, e), !0) : n.type === "BlockStatement" ? (bt(n, e), !0) : r.body === n ? (oe(n, e), !0) : !1;
}
function Ru(_ref18) {
  let {
    comment: e,
  ...
  return (r == null ? void 0 : r.type) !== "TryStatement" && (r == null ? void 0 : r.type) !== "CatchClause" || !n ? !1 : r.type === "CatchClause" && t ? (K(t, e), !0) : n.type === "BlockStatement" ? (bt(n, e), !0) : n.type === "TryStatement" ? (Qn(n.finalizer, e), !0) : n.type === "CatchClause" ? (Qn(n.body, e), !0) : !1;
}
function $o(_ref19) {
  let {
    comment: e,
  ...
  return q(t) && (r == null ? void 0 : r.type) === "Identifier" ? (oe(t, e), !0) : !1;
}
function Ho(_ref20) {
  let {
    comment: e,
...
function Ju(_ref21) {
  ...
  return (!t || !i) && ((r == null ? void 0 : r.type) === "ConditionalExpression" || (r == null ? void 0 : r.type) === "ConditionalTypeAnnotation" || (r == null ? void 0 : r.type) === "TSConditionalType") && n ? u.experimentalTernaries && r.alternate === n && !(ee(e) && !Te(u.originalText, j(e), I(e))) ? (he(r, e), !0) : (oe(n, e), !0) : !1;
}
function Ko(_ref22) {
  let {
    comment: e,
  ...
  return Ce(r) && r.shorthand && r.key === t && r.value.type === "AssignmentPattern" ? (K(r.value.left, e), !0) : !1;
}
var zo = new Set(["ClassDeclaration", "ClassExpression", "DeclareClass", "DeclareInterface", "InterfaceDeclaration", "TSInterfaceDeclaration"]);
function qu(_ref23) {
  let {
    comment: e,
    precedingNode: t,
  ...
  if (zo.has(r == null ? void 0 : r.type)) {
    if (L(r.decorators) && (n == null ? void 0 : n.type) !== "Decorator") return K(v(!1, r.decorators, -1), e), !0;
    if (r.body && n === r.body) return bt(r.body, e), !0;
    if (n) {
      if (r.superClass && n === r.superClass && t && (t === r.id || t === r.typeParameters)) return K(t, e), !0;
      for (let s of ["implements", "extends", "mixins"]) if (r[s] && n === r[s][0]) return t && (t === r.id || t === r.typeParameters || t === r.superClass) ? K(t, e) : he(r, e, s), !0;
    }
  }
  return !1;
}
var Qo = new Set(["ClassMethod", "ClassProperty", "PropertyDefinition", "TSAbstractPropertyDefinition", "TSAbstractMethodDefinition", "TSDeclareMethod", "MethodDefinition", "ClassAccessorProperty", "AccessorProperty", "TSAbstractAccessorProperty"]);
function Wu(_ref24) {
  let {
    comment: e,
    precedingNode: t,
  ...
  return r && t && Ke(n, I(e)) === "(" && (r.type === "Property" || r.type === "TSDeclareMethod" || r.type === "TSAbstractMethodDefinition") && t.type === "Identifier" && r.key === t && Ke(n, I(t)) !== ":" ? (K(t, e), !0) : (t == null ? void 0 : t.type) === "Decorator" && Qo.has(r == null ? void 0 : r.type) ? (K(t, e), !0) : !1;
}
var Zo = new Set(["FunctionDeclaration", "FunctionExpression", "ClassMethod", "MethodDefinition", "ObjectMethod"]);
function ep(_ref25) {
  let {
    comment: e,
    precedingNode: t,
  ...
  return Ke(n, I(e)) !== "(" ? !1 : t && Zo.has(r == null ? void 0 : r.type) ? (K(t, e), !0) : !1;
}
function tp(_ref26) {
  let {
    comment: e,
  ...
  let n = lt(r, I(e));
  return n !== !1 && r.slice(n, n + 2) === "=>" ? (he(t, e), !0) : !1;
}
function rp(_ref27) {
  let {
    comment: e,
  ...
  return Ke(r, I(e)) !== ")" ? !1 : t && (Xu(t) && $(t).length === 0 || pt(t) && ae(t).length === 0) ? (he(t, e), !0) : ((t == null ? void 0 : t.type) === "MethodDefinition" || (t == null ? void 0 : t.type) === "TSAbstractMethodDefinition") && $(t.value).length === 0 ? (he(t.value, e), !0) : !1;
}
function Nu(_ref28) {
  let {
    comment: e,
...
function Gu(_ref29) {
  ...
  return (t == null ? void 0 : t.type) === "LabeledStatement" ? (oe(t, e), !0) : !1;
}
function ts(_ref30) {
  let {
    comment: e,
  ...
  return ((t == null ? void 0 : t.type) === "ContinueStatement" || (t == null ? void 0 : t.type) === "BreakStatement") && !t.label ? (K(t, e), !0) : !1;
}
function np(_ref31) {
  let {
    comment: e,
  ...
  return w(r) && t && r.callee === t && r.arguments.length > 0 ? (oe(r.arguments[0], e), !0) : !1;
}
function sp(_ref32) {
  let {
    comment: e,
  ...
  return We(r) ? (ir(e) && (n.prettierIgnore = !0, e.unignore = !0), t ? (K(t, e), !0) : !1) : (We(n) && ir(e) && (n.types[0].prettierIgnore = !0, e.unignore = !0), !1);
}
function up(_ref33) {
  let {
    comment: e,
...
function rs(_ref34) {
  ...
  var u;
  return ((u = n == null ? void 0 : n.body) == null ? void 0 : u.length) === 0 ? (s ? he(n, e) : oe(n, e), !0) : (t == null ? void 0 : t.type) === "Program" && t.body.length === 0 && !L(t.directives) ? (s ? he(t, e) : oe(t, e), !0) : (r == null ? void 0 : r.type) === "Program" && r.body.length === 0 && (t == null ? void 0 : t.type) === "ModuleExpression" ? (he(r, e), !0) : !1;
}
function ip(_ref35) {
  let {
    comment: e,
  ...
  return (t == null ? void 0 : t.type) === "ForInStatement" || (t == null ? void 0 : t.type) === "ForOfStatement" ? (oe(t, e), !0) : !1;
}
function Uu(_ref36) {
  let {
    comment: e,
  ...
  if ((r == null ? void 0 : r.type) === "ImportSpecifier" || (r == null ? void 0 : r.type) === "ExportSpecifier") return oe(r, e), !0;
...
function ap(_ref37) {
  ...
  return (t == null ? void 0 : t.type) === "AssignmentPattern" ? (oe(t, e), !0) : !1;
}
var op = new Set(["VariableDeclarator", "AssignmentExpression", "TypeAlias", "TSTypeAliasDeclaration"]),
  pp = new Set(["ObjectExpression", "RecordExpression", "ArrayExpression", "TupleExpression", "TemplateLiteral", "TaggedTemplateExpression", "ObjectTypeAnnotation", "TSTypeLiteral"]);
function cp(_ref38) {
  let {
    comment: e,
    enclosingNode: t,
  ...
  return op.has(t == null ? void 0 : t.type) && r && (pp.has(r.type) || ee(e)) ? (oe(r, e), !0) : !1;
}
function lp(_ref39) {
  let {
    comment: e,
  ...
  return !r && ((t == null ? void 0 : t.type) === "TSMethodSignature" || (t == null ? void 0 : t.type) === "TSDeclareFunction" || (t == null ? void 0 : t.type) === "TSAbstractMethodDefinition") && Ke(n, I(e)) === ";" ? (K(t, e), !0) : !1;
}
function Yu(_ref40) {
  let {
    comment: e,
  ...
  if (ir(e) && (t == null ? void 0 : t.type) === "TSMappedType" && (r == null ? void 0 : r.type) === "TSTypeParameter" && r.constraint) return t.prettierIgnore = !0, e.unignore = !0, !0;
}
function mp(_ref41) {
  let {
    comment: e,
  ...
  return (r == null ? void 0 : r.type) !== "TSMappedType" ? !1 : (n == null ? void 0 : n.type) === "TSTypeParameter" && n.name ? (oe(n.name, e), !0) : (t == null ? void 0 : t.type) === "TSTypeParameter" && t.constraint ? (K(t.constraint, e), !0) : !1;
}
function Dp(_ref42) {
  let {
    comment: e,
  ...
  return !t || t.type !== "SwitchCase" || t.test || !r || r !== t.consequent[0] ? !1 : (r.type === "BlockStatement" && Rt(e) ? bt(r, e) : he(t, e), !0);
}
function yp(_ref43) {
  let {
    comment: e,
  ...
  return We(t) && ((r.type === "TSArrayType" || r.type === "ArrayTypeAnnotation") && !n || _r(r)) ? (K(v(!1, t.types, -1), e), !0) : !1;
}
function fp(_ref44) {
  let {
    comment: e,
  ...
  if (((t == null ? void 0 : t.type) === "ObjectPattern" || (t == null ? void 0 : t.type) === "ArrayPattern") && (n == null ? void 0 : n.type) === "TSTypeAnnotation") return r ? K(r, e) : he(t, e), !0;
}
...
var Ep = new Set(["EmptyStatement", "TemplateElement", "Import", "TSEmptyBodyFunctionExpression", "ChainExpression"]);
function Fp(e) {
  return !Ep.has(e.type);
}
function Cp(e, t) {
  var r;
...
function ss(e) {
  ...
  return (U(t) || r && (r.type === "JSXSpreadAttribute" || r.type === "JSXSpreadChild" || We(r) || (r.type === "ClassDeclaration" || r.type === "ClassExpression") && r.superClass === t)) && (!Bt(t) || We(r));
}
function Ap(e, _ref45) {
  let {
    parser: t
  } = _ref45;
  if (t === "flow" || t === "babel-flow") return e = H(!1, e, /[\s(]/g, ""), e === "" || e === "/*" || e === "/*::";
}
function Vu(e) {
  switch (e) {
    case "cr":
...
function Tp(e, t, r) {
  return t === Number.NEGATIVE_INFINITY ? e.root || $u() : t < 0 ? us(e, {
    type: "dedent"
  }, r) : t ? t.type === "root" ? {
    ...e,
    root: e
...
function is(e) {
  ...
  if (t > 0 || r > 0) for (e.length = n + 1; r-- > 0;) e.push(pr);
  return t;
}
function Wr(e, t, r, n, s, u) {
  ...
  for (; r >= 0;) {
    ...
    switch (nt(m)) {
      ...
      case pe:
        {
          ...
          let y = m.break ? Se : p,
            c = m.expandedStates && y === Se ? v(!1, m.expandedStates, -1) : m.contents;
          a.push({
            mode: y,
            doc: c
          });
      ...
      case xe:
        {
          let c = (m.groupId ? s[m.groupId] || ut : p) === Se ? m.breakContents : m.flatContents;
          c && a.push({
            mode: p,
            doc: c
          });
          ...
          case Se:
            {
              ...
              let h = {
                ...
                g = n - u,
                S = p.length > 0;
              if (!l.break && Wr(h, i, g, S, r)) i.push(h);else if (l.expandedStates) {
                let B = v(!1, l.expandedStates, -1);
                if (l.break) {
                  i.push({
                    ind: c,
                    mode: Se,
                  ...
                  break;
                } else for (let O = 1; O < l.expandedStates.length + 1; O++) if (O >= l.expandedStates.length) {
                  i.push({
                    ind: c,
                    mode: Se,
                    doc: B
      ...
      case de:
        {
          ...
          Wr({
            ...
            mode: ut,
            doc: [S, B, X]
          }, [], h, p.length > 0, r, !0) ? i.push(Fe, T, O) : _ ? i.push(Fe, W, O) : i.push(Fe, W, R);
          break;
        }
      case xe:
      case Ye:
        {
          ...
          if (h === Se) {
            let g = l.type === xe ? l.breakContents : l.negate ? l.contents : E(l.contents);
            g && i.push({
              ind: c,
              mode: f,
              doc: g
          ...
          if (h === ut) {
            let g = l.type === xe ? l.flatContents : l.negate ? E(l.contents) : l.contents;
            g && i.push({
              ind: c,
              mode: f,
              doc: g
      ...
      case ce:
        switch (f) {
          ...
          case Se:
            ...
            l.literal ? c.root ? (a.push(s, c.root.value), u = c.root.length) : (a.push(s), u = 0) : (u -= is(a), a.push(s + c.value), u = c.length);
            break;
        }
        break;
      case Oe:
...
function Gr(e, t, r) {
  ...
  if (n.type === "TemplateLiteral" && Bp(e)) {
    let m = hp(e, r, t);
    if (m) return m;
  }
  let u = "expressions";
  ...
  return e.each(_ref46 => {
    ...
    if (!o) {
      let S = n[u][m],
        B = Te(r.originalText, I(y), j(n.quasis[m + 1]));
      if (!B) {
        let O = Nr(h, {
          ...r,
          printWidth: Number.POSITIVE_INFINITY
      ...
      B && (A(S) || q(S) || S.type === "ConditionalExpression" || S.type === "SequenceExpression" || Ae(S) || me(S)) && (h = [E([F, h]), F]);
    }
    let g = l === 0 && f.endsWith("\n") ? ge(Number.NEGATIVE_INFINITY, h) : Iu(h, l, c);
    i.push(D(["${", g, ke, "}"]));
  }, "quasis"), i.push("`"), i;
}
function zu(e) {
...
function hp(e, t, r) {
  ...
  if (s.length > 1 || s.some(u => u.length > 0)) {
    ...
    for (let {
      cells: c
    } of y.filter(f => !f.hasLineBreak)) for (let [f, l] of c.entries()) m[f] = Math.max(m[f], Ze(l));
    return i.push(ke, "`", E([C, P(C, y.map(c => P(" | ", c.cells.map((f, l) => c.hasLineBreak ? f : f + " ".repeat(m[l] - Ze(f))))))]), C, "`"), i;
  }
}
function Sp(e, t) {
  let {
    ...
    n = t();
  return A(r) && (n = D([E([F, n]), F])), ["${", n, ke, "}"];
}
function Gt(e, t) {
  return e.map(r => Sp(r, t), "expressions");
}
function Ur(e, t) {
  return ct(e, r => typeof r == "string" ? t ? H(!1, r, /(\\*)`/g, "$1$1\\`") : as(r) : r);
}
function as(e) {
  return H(!1, e, /([\\`]|\${)/g, "\\$1");
}
...
var os = [(e, t) => e.type === "ObjectExpression" && t === "properties", (e, t) => e.type === "CallExpression" && e.callee.type === "Identifier" && e.callee.name === "Component" && t === "arguments", (e, t) => e.type === "Decorator" && t === "expression"];
function Zu(e) {
  let t = n => n.type === "TemplateLiteral",
    r = (n, s) => Ce(n) && !n.computed && n.key.type === "Identifier" && n.key.name === "styles" && s === "value";
  return e.match(t, (n, s) => G(n) && s === "elements", r, ...os) || e.match(t, r, ...os);
}
function ei(e) {
  return e.match(t => t.type === "TemplateLiteral", (t, r) => Ce(t) && !t.computed && t.key.type === "Identifier" && t.key.name === "template" && r === "value", ...os);
}
function Qu(e, t) {
  return A(e, x.Block | x.Leading, _ref48 => {
    let {
      value: r
    } = _ref48;
    return r === " ".concat(t, " ");
...
function Yr(_ref49, r) {
  let {
    node: e,
    parent: t
  } = _ref49;
  return Qu(e, r) || bp(t) && Qu(t, r);
}
function bp(e) {
...
async function Pp(e, t, r) {
  let {
    ...
    u = 0,
    i = s.reduce((m, y, c) => c === 0 ? y : m + "@prettier-placeholder-" + u++ + "-id" + y, ""),
    a = await e(i, {
      parser: "scss"
    }),
    o = Gt(r, t),
...
function kp(e, t) {
  if (!L(t)) return e;
  let r = 0,
    n = ct(Nt(e), s => typeof s != "string" || !s.includes("@prettier-placeholder") ? s : s.split(/@prettier-placeholder-(\d+)-id/).map((u, i) => i % 2 === 0 ? Ie(u) : (r++, t[u])));
...
function Lp(_ref51) {
  ...
  switch (t.type) {
    case "MemberExpression":
      return Xr(t.object) || ti(t);
    case "CallExpression":
      return Xr(t.callee) || t.callee.type === "MemberExpression" && (t.callee.object.type === "MemberExpression" && (Xr(t.callee.object.object) || ti(t.callee.object)) || t.callee.object.type === "CallExpression" && Xr(t.callee.object.callee));
    case "Identifier":
      return t.name === "css";
    default:
      return !1;
...
async function vp(e, t, r) {
  ...
  for (let a = 0; a < s; a++) {
    ...
    let B = null;
    S ? B = _p(c) : B = await e(y, {
      parser: "graphql"
    }), B ? (B = Ur(B, !1), !p && h && i.push(""), i.push(B), !m && g && i.push("")) : !p && !m && h && i.push(""), l && i.push(l);
  }
  return ["`", E([C, P(C, i)]), C, "`"];
}
function _p(e) {
...
var ni = jp;
var ps = 0;
async function si(e, t, r, n, s) {
  let {
      node: u
    } = n,
    i = ps;
  ps = ps + 1 >>> 0;
  let a = S => "PRETTIER_HTML_PLACEHOLDER_".concat(S, "_").concat(i, "_IN_JS"),
    o = u.quasis.map((S, B, O) => B === O.length - 1 ? S.value.cooked : S.value.cooked + a(B)).join(""),
    p = Gt(n, r),
    m = new RegExp(a("(\\d+)"), "g"),
    y = 0,
    c = await t(o, {
    ...
    f = ct(c, S => {
      ...
      for (let R = 0; R < O.length; R++) {
        let _ = O[R];
        if (R % 2 === 0) {
          _ && (_ = as(_), s.__embeddedInHtml && (_ = H(!1, _, /<\/(?=script\b)/gi, "<\\/")), B.push(_));
          continue;
        }
        let T = Number(_);
        B.push(p[T]);
    ...
    l = /^\s/.test(o) ? " " : "",
    h = /\s$/.test(o) ? " " : "",
    g = s.htmlWhitespaceSensitivity === "ignore" ? C : l && h ? d : null;
  return g ? D(["`", E([g, D(f)]), g, "`"]) : st({
    hug: !1
  }, D(["`", l, y > 1 ? E(D(f)) : D(f), h, "`"]));
}
function Rp(e) {
...
async function Np(e, t, r) {
  let {
    ...
    s = H(!1, n.quasis[0].value.raw, /((?:\\\\)*)\\`/g, (o, p) => "\\".repeat(p.length / 2) + "`"),
    u = Gp(s),
    i = u !== "";
  i && (s = H(!1, s, new RegExp("^".concat(u), "gm"), ""));
  let a = Ur(await e(s, {
    parser: "markdown",
    __inJsTemplate: !0
  }), !0);
  return ["`", i ? E([F, a]) : [Jr, ku(a)], F, "`"];
}
function Gp(e) {
  let t = e.match(/^([^\S\n]*)\S/m);
  return t === null ? "" : t[1];
...
function Xp(e) {
  ...
  if (t.type !== "TemplateLiteral" || Vp(t)) return;
  let r;
  for (let n of [ri, ni, ui, ii]) if (r = n(e), !!r) return t.quasis.length === 1 && t.quasis[0].value.raw.trim() === "" ? "``" : async function () {
    let u = await r(...arguments);
    return u && st({
      embed: !0,
      ...u.label
    }, u);
...
function sc(e) {
  ...
  let r = (0, At.extract)(e),
    {
      pragmas: n,
      comments: s
    } = (0, At.parseWithComments)(r);
  return {
    shebang: t,
    text: e,
    pragmas: n,
...
function cs(e, t) {
  ...
  if (t.__isInHtmlInterpolation && !t.bracketSpacing && pc(r) && cr(e)) return !0;
  if (ic(r)) return !1;
  ...
  switch (s.type) {
    ...
    case "ExportDefaultDeclaration":
      return Ci(e, t) || r.type === "SequenceExpression";
    case "Decorator":
      if (n === "expression") {
        if (q(r) && r.computed) return !0;
        let c = !1,
          f = !1,
          l = r;
        for (; l;) switch (l.type) {
      ...
      break;
    case "TypeAnnotation":
      if (e.match(void 0, void 0, (c, f) => f === "returnType" && c.type === "ArrowFunctionExpression") && oc(r)) return !0;
      break;
    case "BinaryExpression":
  ...
  switch (r.type) {
        ...
        case "BinaryExpression":
          {
            ...
            let l = er(c),
              h = s.operator,
              g = er(h);
            return g > l || n === "right" && g === l || g === l && !sr(h, c) ? !0 : g < l && c === "%" ? h === "+" || h === "-" : !!Tu(h);
          }
        default:
          return !1;
      }
    ...
    case "NGPipeExpression":
      return !(s.type === "NGRoot" || s.type === "NGMicrosyntaxExpression" || s.type === "ObjectProperty" && !((y = r.extra) != null && y.parenthesized) || G(s) || n === "arguments" && w(s) || n === "right" && s.type === "NGPipeExpression" || n === "property" && s.type === "MemberExpression" || s.type === "AssignmentExpression");
    case "JSXFragment":
    case "JSXElement":
      return n === "callee" || n === "left" && s.type === "BinaryExpression" && s.operator === "<" || !G(s) && s.type !== "ArrowFunctionExpression" && s.type !== "AssignmentExpression" && s.type !== "AssignmentPattern" && s.type !== "BinaryExpression" && s.type !== "NewExpression" && s.type !== "ConditionalExpression" && s.type !== "ExpressionStatement" && s.type !== "JsExpressionRoot" && s.type !== "JSXAttribute" && s.type !== "JSXElement" && s.type !== "JSXExpressionContainer" && s.type !== "JSXFragment" && s.type !== "LogicalExpression" && !w(s) && !Ce(s) && s.type !== "ReturnStatement" && s.type !== "ThrowStatement" && s.type !== "TypeCastExpression" && s.type !== "VariableDeclarator" && s.type !== "YieldExpression";
    case "TSInstantiationExpression":
      return n === "object" && q(s);
  }
  return !1;
}
var ic = M(["BlockStatement", "BreakStatement", "ClassBody", "ClassDeclaration", "ClassMethod", "ClassProperty", "PropertyDefinition", "ClassPrivateProperty", "ContinueStatement", "DebuggerStatement", "DeclareClass", "DeclareExportAllDeclaration", "DeclareExportDeclaration", "DeclareFunction", "DeclareInterface", "DeclareModule", "DeclareModuleExports", "DeclareVariable", "DeclareEnum", "DoWhileStatement", "EnumDeclaration", "ExportAllDeclaration", "ExportDefaultDeclaration", "ExportNamedDeclaration", "ExpressionStatement", "ForInStatement", "ForOfStatement", "ForStatement", "FunctionDeclaration", "IfStatement", "ImportDeclaration", "InterfaceDeclaration", "LabeledStatement", "MethodDefinition", "ReturnStatement", "SwitchStatement", "ThrowStatement", "TryStatement", "TSDeclareFunction", "TSEnumDeclaration", "TSImportEqualsDeclaration", "TSInterfaceDeclaration", "TSModuleDeclaration", "TSNamespaceExportDeclaration", "TypeAlias", "VariableDeclaration", "WhileStatement", "WithStatement"]);
function ac(e) {
  let t = 0,
    {
      node: r
...
function Ci(e, t) {
  ...
  return r.type === "FunctionExpression" || r.type === "ClassExpression" ? n.type === "ExportDefaultDeclaration" || !cs(e, t) : !jt(r) || n.type !== "ExportDefaultDeclaration" && cs(e, t) ? !1 : e.call(() => Ci(e, t), ...Ir(r));
}
function cc(e) {
  let {
    node: t,
...
function ms(e, t) {
  ...
  return e.each(() => {
    ...
    p ? u.push(Dc(e, t)) : m && (a = yc(e, t, a), i.push(a.doc));
  }, "comments"), {
    leading: u,
    trailing: i
  };
...
var Ds = class Ds extends Error {
    constructor(t, r) {
      let n = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "type";
      (super("Unexpected ".concat(r, " node ").concat(n, ": ").concat(JSON.stringify(t[n]), ".")), _defineProperty(this, "name", "UnexpectedNodeError")), this.node = t;
    }
  },
  _e = Ds;
function ys(e) {
...
var Me,
  fs = class {
    ...
    hasLeadingWhitespace(t) {
      return it(this, Me).has(t.charAt(0));
    }
    hasTrailingWhitespace(t) {
      return it(this, Me).has(v(!1, t, -1));
    }
    trimStart(t) {
      let r = this.getLeadingWhitespaceCount(t);
      return t.slice(r);
    ...
    split(t) {
      ...
      let n = "[".concat(ys([...it(this, Me)].join("")), "]+"),
        s = new RegExp(r ? "(".concat(n, ")") : n);
      return t.split(s);
    }
...
function fc(e, t, r) {
  ...
  if (n.type === "JSXElement" && kc(n)) return [r("openingElement"), r("closingElement")];
  ...
  n.children = n.children.map(T => Ic(T) ? {
    type: "JSXText",
    value: " ",
    raw: " "
  } : T);
  let i = n.children.some(U),
    a = n.children.filter(T => T.type === "JSXExpressionContainer").length > 1,
    o = n.type === "JSXElement" && n.openingElement.attributes.length > 1,
    p = re(s) || i || o || a,
    m = e.parent.rootMarker === "mdx",
    y = t.singleQuote ? "{' '}" : '{" "}',
    c = m ? " " : b([y, F], " "),
    f = ((R = (O = n.openingElement) == null ? void 0 : O.name) == null ? void 0 : R.name) === "fbt",
    l = Ec(e, t, r, c, f),
    h = n.children.some(T => lr(T));
  for (let T = l.length - 2; T >= 0; T--) {
    let W = l[T] === "" && l[T + 1] === "",
      Fe = l[T] === C && l[T + 1] === "" && l[T + 2] === C,
      X = (l[T] === F || l[T] === C) && l[T + 1] === "" && l[T + 2] === c,
      ue = l[T] === c && l[T + 1] === "" && (l[T + 2] === F || l[T + 2] === C),
      z = l[T] === c && l[T + 1] === "" && l[T + 2] === c,
      wt = l[T] === F && l[T + 1] === "" && l[T + 2] === C || l[T] === C && l[T + 1] === "" && l[T + 2] === F;
    Fe && h || W || X || z || wt ? l.splice(T, 2) : ue && l.splice(T + 1, 2);
  }
  for (; l.length > 0 && Es(v(!1, l, -1));) l.pop();
  for (; l.length > 1 && Es(l[0]) && Es(l[1]);) l.shift(), l.shift();
  let g = [];
  for (let [T, W] of l.entries()) {
    if (W === c) {
      if (T === 1 && l[T - 1] === "") {
        if (l.length === 2) {
          g.push(y);
...
function Ec(e, t, r, n, s) {
  let u = [];
  return e.each(_ref58 => {
    let {
      node: i,
      next: a
    } = _ref58;
    if (i.type === "JSXText") {
      ...
      if (lr(i)) {
        let p = Vr.split(o, !0);
        p[0] === "" && (u.push(""), p.shift(), /\n/.test(p[0]) ? u.push(xi(s, p[1], i, a)) : u.push(n), p.shift());
        let m;
        if (v(!1, p, -1) === "" && (p.pop(), m = p.pop()), p.length === 0) return;
        for (let [y, c] of p.entries()) y % 2 === 1 ? u.push(d) : u.push(c);
        m !== void 0 ? /\n/.test(m) ? u.push(xi(s, v(!1, u, -1), i, a)) : u.push(n) : u.push(Ti(s, v(!1, u, -1), i, a));
...
var Fc = new Set(["ArrayExpression", "TupleExpression", "JSXAttribute", "JSXElement", "JSXExpressionContainer", "JSXFragment", "ExpressionStatement", "CallExpression", "OptionalCallExpression", "ConditionalExpression", "JsExpressionRoot"]);
function Cc(e, t, r) {
  let {
    parent: n
  } = e;
  if (Fc.has(n.type)) return t;
  let s = e.match(void 0, i => i.type === "ArrowFunctionExpression", w, i => i.type === "JSXExpressionContainer"),
    u = Be(e, r);
  ...
  if (s.push(r("name")), n.value) {
    ...
    if (te(n.value)) {
      let i = De(n.value),
        ...
        o = hr(a, t.jsxSingleQuote);
      a = o === '"' ? H(!1, a, '"', "&quot;") : H(!1, a, "'", "&apos;"), u = e.call(() => le(e, Ie(o + a + o), t), "value");
    } else u = r("value");
    s.push("=", u);
  }
  return s;
...
function dc(e, t, r) {
  let {
    ...
    s = (u, i) => u.type === "JSXEmptyExpression" || !A(u) && (G(u) || se(u) || u.type === "ArrowFunctionExpression" || u.type === "AwaitExpression" && (s(u.argument, u) || u.argument.type === "JSXElement") || w(u) || u.type === "ChainExpression" && w(u.expression) || u.type === "FunctionExpression" || u.type === "TemplateLiteral" || u.type === "TaggedTemplateExpression" || u.type === "DoExpression" || U(i) && (u.type === "ConditionalExpression" || me(u)));
  return s(n.expression, e.parent) ? D(["{", r("expression"), ke, "}"]) : D(["{", E([F, r("expression")]), F, ke, "}"]);
}
function Tc(e, t, r) {
  var a, o;
  let {
...
function xc(e, t, r) {
  return e.selfClosing ? [d, "/>"] : gc(e, t, r) ? [">"] : [F, ">"];
}
function gc(e, t, r) {
  let n = e.attributes.length > 0 && A(v(!1, e.attributes, -1), x.Trailing);
...
function hc(e, t, r) {
  ...
  s.push("</");
  let u = r("name");
  return A(n.name, x.Leading | x.Line) ? s.push(E([C, u]), C) : A(n.name, x.Leading | x.Block) ? s.push(" ", u) : s.push(u), s.push(">"), s;
}
function Sc(e, t) {
  let {
      node: r
...
function Pc(e, t, r) {
  ...
  return ["{", e.call(_ref59 => {
    let {
      node: s
    } = _ref59;
    let u = ["...", r()];
    return !A(s) || !ss(e) ? u : [E([F, le(e, u, t)]), F];
...
function kc(e) {
  ...
  let t = e.children[0];
  return t.type === "JSXText" && !lr(t);
}
function lr(e) {
  return e.type === "JSXText" && (Vr.hasNonWhitespaceCharacter(De(e)) || !/\n/.test(De(e)));
}
function Ic(e) {
  return e.type === "JSXExpressionContainer" && te(e.expression) && e.expression.value === " " && !A(e.expression);
}
function hi(e) {
  let {
    node: t,
...
function Hr(e, t, r) {
  ...
  let {
    ...
    o = n.operator === "|>" && ((R = e.root.extra) == null ? void 0 : R.__isUsingHackPipeline),
    p = Fs(e, r, t, !1, a);
  if (a) return p;
  if (o) return D(p);
  ...
  let m = s.type === "ReturnStatement" || s.type === "ThrowStatement" || s.type === "JSXExpressionContainer" && u.type === "JSXAttribute" || n.operator !== "|" && s.type === "JsExpressionRoot" || n.type !== "NGPipeExpression" && (s.type === "NGRoot" && t.parser === "__ng_binding" || s.type === "NGMicrosyntaxExpression" && u.type === "NGMicrosyntax" && u.body.length === 1) || n === s.body && s.type === "ArrowFunctionExpression" || n !== s.body && s.type === "ForStatement" || s.type === "ConditionalExpression" && u.type !== "ReturnStatement" && u.type !== "ThrowStatement" && !w(u) || s.type === "TemplateLiteral",
    y = s.type === "AssignmentExpression" || s.type === "VariableDeclarator" || s.type === "ClassProperty" || s.type === "PropertyDefinition" || s.type === "TSAbstractPropertyDefinition" || s.type === "ClassPrivateProperty" || Ce(s),
    c = me(n.left) && sr(n.operator, n.left.operator);
  if (m || Ut(n) && !c || !Ut(n) && y) return D(p);
  if (p.length === 0) return "";
  let f = U(n.right),
    l = p.findIndex(_ => typeof _ != "string" && !Array.isArray(_) && _.type === pe),
    h = p.slice(0, l === -1 ? 1 : l + 1),
    g = p.slice(h.length, f ? -1 : void 0),
    S = Symbol("logicalChain-" + ++wc),
    B = D([...h, E(g)], {
      id: S
    });
  if (!f) return B;
...
function Fs(e, t, r, n, s) {
  ...
  if (!me(u)) return [D(t())];
  let i = [];
  sr(u.operator, u.left.operator) ? i = e.call(g => Fs(g, t, r, !0, s), "left") : i.push(D(t("left")));
  let a = Ut(u),
    o = (u.operator === "|>" || u.type === "NGPipeExpression" || Oc(e, r)) && !we(r.originalText, u.right),
    p = u.type === "NGPipeExpression" ? "|" : u.operator,
    m = u.type === "NGPipeExpression" && u.arguments.length > 0 ? D(E([F, ": ", P([d, ": "], e.map(() => ge(2, D(t())), "arguments"))])) : "",
    y;
  if (a) y = [p, " ", t("right"), m];else {
    let S = p === "|>" && ((h = e.root.extra) == null ? void 0 : h.__isUsingHackPipeline) ? e.call(B => Fs(B, t, r, !0, s), "right") : t("right");
    y = [o ? d : "", p, o ? " " : d, S, m];
  }
  let {
      parent: c
    ...
    l = f || !(s && u.type === "LogicalExpression") && c.type !== u.type && u.left.type !== u.type && u.right.type !== u.type;
  if (i.push(o ? "" : " ", l ? D(y, {
    shouldBreak: f
  }) : y), n && A(u)) {
    let g = Nt(le(e, i, r));
    return Array.isArray(g) || g.type === de ? qr(g) : [g];
  }
  return i;
}
function Ut(e) {
  return e.type !== "LogicalExpression" ? !1 : !!(se(e.right) && e.right.properties.length > 0 || G(e.right) && e.right.elements.length > 0 || U(e.right));
}
var Si = e => e.type === "BinaryExpression" && e.operator === "|";
function Oc(e, t) {
  return (t.parser === "__vue_expression" || t.parser === "__vue_ts_expression") && Si(e.node) && !e.hasAncestor(r => !Si(r) && r.type !== "JsExpressionRoot");
}
function bi(e, t, r) {
  let {
    node: n
  ...
  if (n.type.startsWith("NG")) switch (n.type) {
    ...
    case "NGChainedExpression":
      return D(P([";", d], e.map(() => _c(e) ? r() : ["(", r(), ")"], "expressions")));
    case "NGEmptyExpression":
      return "";
    case "NGMicrosyntax":
      return e.map(() => [e.isFirst ? "" : Bi(e) ? " " : [";", d], r()], "body");
    ...
    case "NGMicrosyntaxKeyedExpression":
      {
        let {
          ...
          i = Bi(e) || (s === 1 && (n.key.name === "then" || n.key.name === "else" || n.key.name === "as") || (s === 2 || s === 3) && (n.key.name === "else" && u.body[s - 1].type === "NGMicrosyntaxKeyedExpression" && u.body[s - 1].key.name === "then" || n.key.name === "track")) && u.body[0].type === "NGMicrosyntaxExpression";
...
var vc = M(["CallExpression", "OptionalCallExpression", "AssignmentExpression"]);
function _c(_ref61) {
  let {
    node: e
  } = _ref61;
...
function Cs(e, t, r) {
  ...
  return D([P(d, e.map(r, "decorators")), Ii(n, t) ? C : d]);
}
function Pi(e, t, r) {
  return Li(e.node) ? [P(C, e.map(r, "declaration", "decorators")), C] : "";
}
function ki(e, t, r) {
  let {
      node: n,
  ...
  if (!L(u) || Li(s) || $r(e)) return "";
  let i = n.type === "ClassExpression" || n.type === "ClassDeclaration" || Ii(n, t);
  return [e.key === "declaration" && mu(s) ? C : i ? Ee : "", P(d, e.map(r, "decorators")), d];
}
function Ii(e, t) {
...
var mt = class mt extends Error {
  constructor() {
    super(...arguments);
    _defineProperty(this, "name", "ArgExpansionBailout");
  }
};
function Mc(e, t, r) {
  let {
  ...
  if (Jc(s)) return ["(", r(["arguments", 0]), ", ", r(["arguments", 1]), ")"];
  let u = !1,
    i = s.length - 1,
    a = [];
  ur(e, (_ref62, f) => {
    ...
    let l = r();
    f === i || (fe(c, t) ? (u = !0, l = [l, ",", C, C]) : l = [l, ",", d]), a.push(l);
  });
  ...
  if (u || e.parent.type !== "Decorator" && Au(s)) return m();
  if (Rc(s)) {
    let c = a.slice(1);
    if (c.some(re)) return m();
    let f;
    try {
      f = r(Yn(n, 0), {
        expandFirstArg: !0
      ...
      if (l instanceof mt) return m();
      throw l;
    }
    return re(f) ? [Ee, He([["(", D(f, {
      shouldBreak: !0
    }), ", ", ...c, ")"], m()])] : He([["(", f, ", ", ...c, ")"], ["(", D(f, {
      shouldBreak: !0
    }), ", ", ...c, ")"], m()]);
  ...
  let y = ["(", E([F, ...a]), b(p), F, ")"];
  return vr(e) ? y : D(y, {
    shouldBreak: a.some(re) || u
  });
}
function mr(e) {
  let t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : !1;
  return se(e) && (e.properties.length > 0 || A(e)) || G(e) && (e.elements.length > 0 || A(e)) || e.type === "TSTypeAssertion" && mr(e.expression) || Ae(e) && mr(e.expression) || e.type === "FunctionExpression" || e.type === "ArrowFunctionExpression" && (!e.returnType || !e.returnType.typeAnnotation || e.returnType.typeAnnotation.type !== "TSTypeReference" || qc(e.body)) && (e.body.type === "BlockStatement" || e.body.type === "ArrowFunctionExpression" && mr(e.body, !0) || se(e.body) || G(e.body) || !t && (w(e.body) || e.body.type === "ConditionalExpression") || U(e.body)) || e.type === "DoExpression" || e.type === "ModuleExpression";
}
function jc(e, t, r) {
  var u, i;
  let n = v(!1, e, -1);
...
function Rc(e) {
  ...
  let [t, r] = e;
  return t.type === "ModuleExpression" && Wc(r) ? !0 : !A(t) && (t.type === "FunctionExpression" || t.type === "ArrowFunctionExpression" && t.body.type === "BlockStatement") && r.type !== "FunctionExpression" && r.type !== "ArrowFunctionExpression" && r.type !== "ConditionalExpression" && wi(r) && !mr(r);
}
function wi(e) {
  var t;
  if (e.type === "ParenthesizedExpression") return wi(e.expression);
  ...
  return pt(e) && ae(e).length > 1 ? !1 : me(e) ? be(e.left, 1) && be(e.right, 1) : Wn(e) || be(e);
}
function Jc(e) {
  return e.length === 2 && e[0].type === "ArrowFunctionExpression" && $(e[0]).length === 0 && e[0].body.type === "BlockStatement" && e[1].type === "ArrayExpression" && !e.some(t => A(t));
}
function qc(e) {
...
var Dr = Mc;
var Nc = e => ((e.type === "ChainExpression" || e.type === "TSNonNullExpression") && (e = e.expression), w(e) && ae(e).length > 0);
function Oi(e, t, r) {
  var p;
  let n = r("object"),
    s = ds(e, t, r),
    ...
    o = i && (i.type === "NewExpression" || i.type === "BindExpression" || i.type === "AssignmentExpression" && i.left.type !== "Identifier") || u.computed || u.object.type === "Identifier" && u.property.type === "Identifier" && !q(a) || (a.type === "AssignmentExpression" || a.type === "VariableDeclarator") && (Nc(u.object) || ((p = n.label) == null ? void 0 : p.memberChain));
...
function ds(e, t, r) {
  let n = r("property"),
    ...
    u = V(e);
  return s.computed ? !s.property || Pe(s.property) ? [u, "[", n, "]"] : D([u, "[", E([F, n]), F, "]"]) : [u, ".", n];
}
function vi(e, t, r) {
  if (e.node.type === "ChainExpression") return e.call(() => vi(e, t, r), "expression");
  let {
      parent: n
    } = e,
  ...
  function i(k) {
    let {
      ...
      Q = lt(N, I(k));
    return N.charAt(Q) === ")" ? Q !== !1 && _t(N, Q + 1) : fe(k, t);
  }
  function a(k) {
    let {
      node: N
    } = k;
    if (N.type === "ChainExpression") return k.call(() => a(k), "expression");
    if (w(N) && (Et(N.callee) || w(N.callee))) {
      let Q = i(N);
      u.unshift({
        node: N,
        hasTrailingEmptyLine: Q,
        printed: [le(k, [V(k), ze(k, t, r), Dr(k, t, r)], t), Q ? C : ""]
      }), k.call(je => a(je), "callee");
    } else Et(N) ? (u.unshift({
      node: N,
      needsParens: Be(k, t),
      printed: le(k, q(N) ? ds(k, t, r) : Kr(k, t, r), t)
    }), k.call(Q => a(Q), "object")) : N.type === "TSNonNullExpression" ? (u.unshift({
      node: N,
      printed: le(k, "!", t)
    }), k.call(Q => a(Q), "expression")) : u.unshift({
      node: N,
      printed: r()
    });
  }
  ...
  u.unshift({
    node: o,
    printed: [V(e), ze(e, t, r), Dr(e, t, r)]
  }), o.callee && e.call(k => a(k), "callee");
  let p = [],
    m = [u[0]],
    y = 1;
  for (; y < u.length && (u[y].node.type === "TSNonNullExpression" || w(u[y].node) || q(u[y].node) && u[y].node.computed && Pe(u[y].node.property)); ++y) m.push(u[y]);
  if (!w(u[0].node)) for (; y + 1 < u.length && Et(u[y].node) && Et(u[y + 1].node); ++y) m.push(u[y]);
  p.push(m), m = [];
  let c = !1;
  for (; y < u.length; ++y) {
    if (c && Et(u[y].node)) {
      if (u[y].node.computed && Pe(u[y].node.property)) {
        m.push(u[y]);
        continue;
      }
      p.push(m), m = [], c = !1;
    }
    (w(u[y].node) || u[y].node.type === "ImportExpression") && (c = !0), m.push(u[y]), A(u[y].node, x.Trailing) && (p.push(m), m = [], c = !1);
  }
  m.length > 0 && p.push(m);
  function f(k) {
    return /^[A-Z]|^[$_]+$/.test(k);
  ...
  function h(k) {
    ...
    let Q = v(!1, k[0], -1).node;
    return q(Q) && Q.property.type === "Identifier" && (f(Q.property.name) || N);
  }
  let g = p.length >= 2 && !A(p[1][0].node) && h(p);
  function S(k) {
    let N = k.map(Q => Q.printed);
    return k.length > 0 && v(!1, k, -1).needsParens ? ["(", ...N, ")"] : N;
  }
  function B(k) {
    return k.length === 0 ? "" : E([C, P(C, k.map(S))]);
  }
  let O = p.map(S),
    R = O,
    _ = g ? 3 : 2,
    T = p.flat(),
    W = T.slice(1, -1).some(k => A(k.node, x.Leading)) || T.slice(0, -1).some(k => A(k.node, x.Trailing)) || p[_] && A(p[_][0].node, x.Leading);
  if (p.length <= _ && !W && !p.some(k => v(!1, k, -1).hasTrailingEmptyLine)) return vr(e) ? R : D(R);
  let Fe = v(!1, p[g ? 1 : 0], -1).node,
    X = !w(Fe) && i(Fe),
    ue = [S(p[0]), g ? p.slice(1, 2).map(S) : "", X ? C : "", B(p.slice(g ? 2 : 1))],
    z = u.map(_ref63 => {
      let {
        node: k
      } = _ref63;
  ...
  function wt() {
    let k = v(!1, v(!1, p, -1), -1).node,
      N = v(!1, O, -1);
    return w(k) && re(N) && z.slice(0, -1).some(Q => Q.arguments.some(Mt));
  }
  let Ht;
  return W || z.length > 2 && z.some(k => !k.arguments.every(N => be(N))) || O.slice(0, -1).some(re) || wt() ? Ht = D(ue) : Ht = [re(R) || X ? Ee : "", He([R, ue])], st({
    memberChain: !0
  }, Ht);
}
var _i = vi;
function zr(e, t, r) {
  ...
  if (p || o.length > 0 && !u && !i && (Uc(n, s) || St(n, s))) {
    let c = [];
    if (ur(e, () => {
      c.push(r());
    }), !(p && (y = c[0].label) != null && y.embed)) return [u ? "new " : "", r("callee"), a, ze(e, t, r), "(", P(", ", c), ")"];
  }
  if (!i && !u && Et(n.callee) && !e.call(c => Be(c, t), "callee", ...(n.callee.type === "ChainExpression" ? ["expression"] : []))) return _i(e, t, r);
  let m = [u ? "new " : "", i ? Gc(n) : r("callee"), a, ze(e, t, r), Dr(e, t, r)];
  return i || w(n.callee) ? D(m) : m;
}
function Gc(e) {
  return e.phase ? "import.".concat(e.phase) : "import";
}
function Uc(e, t) {
  if (e.callee.type !== "Identifier") return !1;
  if (e.callee.name === "require") {
    let r = ae(e);
    return r.length === 1 && te(r[0]) || r.length > 1;
  }
  if (e.callee.name === "define") {
    let r = ae(e);
    return t.type === "ExpressionStatement" && (r.length === 1 || r.length === 2 && r[0].type === "ArrayExpression" || r.length === 3 && te(r[0]) && r[1].type === "ArrayExpression");
  }
  return !1;
}
function dt(e, t, r, n, s, u) {
  let i = Yc(e, t, r, n, u),
    a = u ? r(u, {
      assignmentLayout: i
    }) : "";
  switch (i) {
    case "break-after-operator":
      return D([D(n), s, D(E([d, a]))]);
    case "never-break-after-operator":
      return D([D(n), s, " ", a]);
    case "fluid":
      {
        let o = Symbol("assignment");
        return D([D(n), s, D(E(d), {
          id: o
        }), ke, Ct(a, {
          groupId: o
        })]);
...
function ji(e, t, r) {
  ...
  return dt(e, t, r, r("left"), [" ", n.operator], "right");
}
function Ri(e, t, r) {
  return dt(e, t, r, r("id"), " =", "init");
}
function Yc(e, t, r, n, s) {
  ...
  let a = !Qr(i);
  if (e.match(Qr, Ji, c => !a || c.type !== "ExpressionStatement" && c.type !== "VariableDeclaration")) return a ? i.type === "ArrowFunctionExpression" && i.body.type === "ArrowFunctionExpression" ? "chain-tail-arrow-chain" : "chain-tail" : "chain";
  if (!a && Qr(i.right) || we(t.originalText, i)) return "break-after-operator";
  if (i.type === "CallExpression" && i.callee.name === "require" || t.parser === "json5" || t.parser === "jsonc" || t.parser === "json") return "never-break-after-operator";
  let m = vu(n);
  if (Vc(u) || zc(u) || Ts(u) && m) return "break-lhs";
  let y = Zc(u, n, t);
  return e.call(() => Xc(e, t, r, y), s) ? "break-after-operator" : $c(u) ? "break-lhs" : !m && (y || i.type === "TemplateLiteral" || i.type === "TaggedTemplateExpression" || i.type === "BooleanLiteral" || Pe(i) || i.type === "ClassExpression") ? "never-break-after-operator" : "fluid";
}
function Xc(e, t, r, n) {
  let s = e.node;
  if (me(s) && !Ut(s)) return !0;
  switch (s.type) {
...
function zc(e) {
  ...
  let r = Mi(t.typeAnnotation);
  return L(r) && r.length > 1 && r.some(n => L(Mi(n)) || n.type === "TSConditionalType");
}
function Ts(e) {
  var t;
...
function qi(e, t, r) {
  ...
  if (w(s)) {
    if ((i = zr(e, t, r).label) != null && i.memberChain) return !1;
    let o = ae(s);
    return !(o.length === 0 || o.length === 1 && nr(o[0], t)) || el(s, r) ? !1 : e.call(u, "callee");
  }
  return q(s) ? e.call(u, "object") : n && (s.type === "Identifier" || s.type === "ThisExpression");
}
function Zc(e, t, r) {
  return Ce(e) ? (t = Nt(t), typeof t == "string" && Ze(t) < r.tabWidth + 3) : !1;
}
function el(e, t) {
  let r = tl(e);
  if (L(r)) {
    ...
    if (r.length === 1) {
      let s = r[0];
      if (We(s) || _r(s) || s.type === "TSTypeLiteral" || s.type === "ObjectTypeAnnotation") return !0;
    }
...
function tl(e) {
  var _e$typeParameters;
  var t;
  return (t = (_e$typeParameters = e.typeParameters) !== null && _e$typeParameters !== void 0 ? _e$typeParameters : e.typeArguments) == null ? void 0 : t.params;
}
function rl(e) {
  function t(r) {
    switch (r.type) {
...
function Dt(e, t, r, n, s) {
  let u = e.node,
    i = $(u),
    a = s ? ze(e, r, t) : "";
  if (i.length === 0) return [a, "(", J(e, r, {
    filter: l => Ke(r.originalText, I(l)) === ")"
  }), ")"];
  let {
      parent: o
    } = e,
  ...
  if (gu(e, (l, h) => {
    let g = h === i.length - 1;
    g && u.rest && y.push("..."), y.push(t()), !g && (y.push(","), p || m ? y.push(" ") : fe(i[h], r) ? y.push(C, C) : y.push(d));
  }), n && !sl(e)) {
    if (re(a) || re(y)) throw new mt();
    return D([ar(a), "(", ar(y), ")"]);
  }
  let c = i.every(l => !L(l.decorators));
  return m && c ? [a, "(", ...y, ")"] : p ? [a, "(", ...y, ")"] : (Lr(o) || yu(o) || o.type === "TypeAlias" || o.type === "UnionTypeAnnotation" || o.type === "IntersectionTypeAnnotation" || o.type === "FunctionTypeAnnotation" && o.returnType === u) && i.length === 1 && i[0].name === null && u.this !== i[0] && i[0].typeAnnotation && u.typeParameters === null && Jt(i[0].typeAnnotation) && !u.rest ? r.arrowParens === "always" ? ["(", ...y, ")"] : y : [a, "(", E([F, ...y]), b(!xu(u) && ye(r, "all") ? "," : ""), F, ")"];
}
function xs(e) {
  if (!e) return !1;
  let t = $(e);
...
var ul = M(["VoidTypeAnnotation", "TSVoidKeyword", "NullLiteralTypeAnnotation", "TSNullKeyword"]),
  il = M(["ObjectTypeAnnotation", "TSTypeLiteral", "GenericTypeAnnotation", "TSTypeReference"]);
function al(e) {
  let {
    types: t
  } = e;
  if (t.some(n => A(n))) return !1;
  let r = t.find(n => il(n));
  return r ? t.every(n => n === r || ul(n)) : !1;
}
function gs(e) {
  return Jt(e) || Le(e) ? !0 : We(e) ? al(e) : !1;
}
function Ni(e, t, r) {
  let n = t.semi ? ";" : "",
    {
    ...
    u = [ne(e), "opaque type ", r("id"), r("typeParameters")];
...
function Zr(e, t, r) {
  ...
  return [dt(e, t, r, u, " =", i), n];
}
function en(e, t, r) {
  let n = !1;
  return D(e.map(_ref64 => {
    let {
      isFirst: s,
      previous: u,
      node: i,
    ...
    let p = Le(i),
      m = Le(u);
    return m && p ? [" & ", n ? E(o) : o] : !m && !p ? E([" &", d, o]) : (a > 1 && (n = !0), [" & ", a > 1 ? E(o) : o]);
  }, "types"));
}
function tn(e, t, r) {
  let {
    ...
    u = s.type !== "TypeParameterInstantiation" && (s.type !== "TSConditionalType" || !t.experimentalTernaries) && (s.type !== "ConditionalTypeAnnotation" || !t.experimentalTernaries) && s.type !== "TSTypeParameterInstantiation" && s.type !== "GenericTypeAnnotation" && s.type !== "TSTypeReference" && s.type !== "TSTypeAssertion" && s.type !== "TupleTypeAnnotation" && s.type !== "TSTupleType" && !(s.type === "FunctionTypeParam" && !s.name && e.grandparent.this !== s) && !((s.type === "TypeAlias" || s.type === "VariableDeclarator" || s.type === "TSTypeAliasDeclaration") && we(t.originalText, n)),
    i = gs(n),
    a = e.map(m => {
      let y = r();
      return i || (y = ge(2, y)), le(m, y, t);
    }, "types");
  if (i) return P(" | ", a);
  let o = u && !we(t.originalText, n),
    p = [b([o ? d : "", "| "]), P([d, "| "], a)];
  return Be(e, t) ? D([E(p), F]) : (s.type === "TupleTypeAnnotation" || s.type === "TSTupleType") && s[s.type === "TupleTypeAnnotation" && s.types ? "types" : "elementTypes"].length > 1 ? D([E([b(["(", F]), p]), F, b(")")]) : D(u ? E(p) : p);
}
function ol(e) {
  var n;
  let {
...
function rn(e, t, r) {
  ...
  let u = Dt(e, r, t, !1, !0),
    i = [];
  return n.type === "FunctionTypeAnnotation" ? i.push(ol(e) ? " => " : ": ", r("returnType")) : i.push(Y(e, r, n.returnType ? "returnType" : "typeAnnotation")), kt(n, i) && (u = D(u)), s.push(u, i), D(s);
}
function nn(e, t, r) {
...
var pl = new WeakSet();
function Y(e, t) {
  let r = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "typeAnnotation";
  let {
    node: {
      [r]: n
    }
...
function ln(e, t) {
  ...
  return [r.asserts ? "asserts " : "", t("parameterName"), r.typeAnnotation ? [" is ", Y(e, t)] : ""];
}
function V(e) {
  let {
    node: t
...
var cl = new Set(["DeclareClass", "DeclareFunction", "DeclareVariable", "DeclareExportDeclaration", "DeclareExportAllDeclaration", "DeclareOpaqueType", "DeclareTypeAlias", "DeclareEnum", "DeclareInterface"]);
function ne(e) {
  let {
    node: t
  } = e;
...
var ll = new Set(["TSAbstractMethodDefinition", "TSAbstractPropertyDefinition", "TSAbstractAccessorProperty"]);
function Yt(_ref66) {
  let {
    node: e
  } = _ref66;
...
function yt(e, t, r) {
  return e.type === "EmptyStatement" ? ";" : e.type === "BlockStatement" || r ? [" ", t] : E([d, t]);
}
function Dn(e, t) {
...
function ml(e, t, r, n) {
  ...
  return A(s, x.Dangling) ? D([r, J(e, t, {
    indent: !0
  }), F, n]) : [r, n];
}
function Vt(e, t, r) {
  let {
    ...
    o = n[a];
  if (o.length === 0) s.push(ml(e, t, u, i));else {
    let p = v(!1, o, -1),
      m = (p == null ? void 0 : p.type) !== "RestElement",
      y = p === null,
      c = Symbol("array"),
      f = !t.__inJestEach && o.length > 1 && o.every((g, S, B) => {
        let O = g == null ? void 0 : g.type;
        if (!G(g) && !se(g)) return !1;
        let R = B[S + 1];
        if (R && O !== R.type) return !1;
    ...
    s.push(D([u, E([F, l ? yl(e, t, r, h) : [Dl(e, t, a, r), h], J(e, t)]), F, i], {
      shouldBreak: f,
      id: c
    }));
  }
...
function As(e, t) {
  return G(e) && e.elements.length > 1 && e.elements.every(r => r && (Pe(r) || qn(r) && !A(r.argument)) && !A(r, x.Trailing | x.Line, n => !Z(t.originalText, j(n), {
    backwards: !0
  })));
}
function Ui(_ref67, _ref68) {
  let {
    node: e
  } = _ref67;
  let {
...
function Dl(e, t, r, n) {
  let s = [];
  return e.each(_ref69 => {
    let {
      node: u,
      isLast: i
    } = _ref69;
    s.push(u ? D(n()) : ""), i || s.push([",", d, u && Ui(e, t) ? F : ""]);
  }, r), s;
}
function yl(e, t, r, n) {
  let s = [];
  return e.each(_ref70 => {
    let {
      isLast: u,
      next: i
    } = _ref70;
    s.push([r(), u ? n : ","]), u || s.push(Ui(e, t) ? [C, C] : A(i, x.Leading | x.Line) ? C : d);
  }, "elements"), Wt(s);
}
var Yi = new Proxy(() => {}, {
    get: () => Yi
...
function ft(e, t, r) {
  ...
  if (t.quoteProps === "consistent" && !fn.has(s)) {
    let i = (s.properties || s.body || s.members).some(a => !a.computed && a.key && te(a.key) && !Gn(a, t));
    fn.set(s, i);
  }
  if ((u.type === "Identifier" || Pe(u) && Un(Qe(De(u))) && String(u.value) === Qe(De(u)) && !(t.parser === "typescript" || t.parser === "babel-ts")) && (t.parser === "json" || t.parser === "jsonc" || t.quoteProps === "consistent" && fn.get(s))) {
    let i = at(JSON.stringify(u.type === "Identifier" ? u.name : u.value.toString()), t);
    return e.call(a => le(a, i, t), "key");
  }
  return Gn(n, t) && (t.quoteProps === "as-needed" || t.quoteProps === "consistent" && !fn.get(s)) ? e.call(i => le(i, /^\d/.test(u.value) ? Qe(u.value) : u.value, t), "key") : r("key");
}
function Ss(e, t, r) {
  let {
    node: n
  } = e;
  return n.shorthand ? r("value") : dt(e, t, r, ft(e, t, r), ":", "value");
}
var El = _ref71 => {
  let {
    node: e,
  ...
  return t === "value" && e.type === "FunctionExpression" && (r.type === "ObjectMethod" || r.type === "ClassMethod" || r.type === "ClassPrivateMethod" || r.type === "MethodDefinition" || r.type === "TSAbstractMethodDefinition" || r.type === "TSDeclareMethod" || r.type === "Property" && ht(r));
};
function En(e, t, r, n) {
  if (El(e)) return Fn(e, r, t);
  let {
      node: s
    } = e,
    u = !1;
  if ((s.type === "FunctionDeclaration" || s.type === "FunctionExpression") && n != null && n.expandLastArg) {
    ...
    w(m) && (ae(m).length > 1 || $(s).every(y => y.type === "Identifier" && !y.typeAnnotation)) && (u = !0);
  }
  let i = [ne(e), s.async ? "async " : "", "function".concat(s.generator ? "*" : "", " "), s.id ? t("id") : ""],
    a = Dt(e, t, r, u),
    o = An(e, t),
    p = kt(s, o);
  return i.push(ze(e, r, t), D([p ? D(a) : a, o]), s.body ? " " : "", t("body")), r.semi && (s.declare || !s.body) && i.push(";"), i;
}
function yr(e, t, r) {
  let {
      node: n
    ...
    u = n.value || n,
    i = [];
  return !s || s === "init" || s === "method" || s === "constructor" ? u.async && i.push("async ") : (yn.ok(s === "get" || s === "set"), i.push(s, " ")), u.generator && i.push("*"), i.push(ft(e, t, r), n.optional || n.key.optional ? "?" : "", n === u ? Fn(e, t, r) : r("value")), i;
}
function Fn(e, t, r) {
  let {
      node: n
...
function Xi(e, t, r) {
  ...
  if (n.argument) {
    let o = r("argument");
    Cl(t, n.argument) ? o = ["(", E([C, o]), C, ")"] : (me(n.argument) || n.argument.type === "SequenceExpression" || t.experimentalTernaries && n.argument.type === "ConditionalExpression" && (n.argument.consequent.type === "ConditionalExpression" || n.argument.alternate.type === "ConditionalExpression")) && (o = D([b("("), E([F, o]), F, b(")")])), u.push(" ", o);
  }
...
function Cl(e, t) {
  if (we(e.originalText, t) || A(t, x.Leading, r => Te(e.originalText, j(r), I(r))) && !U(t)) return !0;
  if (jt(t)) {
    let r = t,
      n;
    for (; n = lu(r);) if (r = n, we(e.originalText, r)) return !0;
  }
  return !1;
}
var Bs = new WeakMap();
function Hi(e) {
  return Bs.has(e) || Bs.set(e, e.type === "ConditionalExpression" && !ie(e, t => t.type === "ObjectExpression")), Bs.get(e);
}
...
function zi(e, t, r) {
  ...
  (function g() {
    let {
      ...
      B = Al(e, t, r, n);
    if (s.length === 0) s.push(B);else {
      let {
        leading: O,
        trailing: R
      } = ms(e, t);
      s.push([O, B]), i.unshift(R);
    }
    o && (a || (a = S.returnType && $(S).length > 0 || S.typeParameters || $(S).some(O => O.type !== "Identifier"))), !o || S.body.type !== "ArrowFunctionExpression" ? (u = r("body", n), p = S.body) : e.call(g, "body");
  })();
  let m = !we(t.originalText, p) && (Ki(p) || dl(p, u, t) || !a && Hi(p)),
    ...
    l,
    h = !1;
  return o && (y || n.assignmentLayout) && (h = !0, l = n.assignmentLayout === "chain-tail-arrow-chain" || y && !m), u = xl(e, t, n, {
    bodyDoc: u,
    bodyComments: i,
    functionBody: p,
...
function Al(e, t, r, n) {
  let {
    ...
    u = [];
  if (s.async && u.push("async "), Cn(e, t)) u.push(r(["params", 0]));else {
    let a = n.expandLastArg || n.expandFirstArg,
      o = An(e, r);
    if (a) {
      if (re(o)) throw new mt();
      o = D(ar(o));
    }
    u.push(D([Dt(e, r, t, a, !0), o]));
  }
  let i = J(e, t, {
    filter(a) {
      let o = lt(t.originalText, I(a));
...
function dl(e, t, r) {
  var n, s;
  return G(e) || se(e) || e.type === "ArrowFunctionExpression" || e.type === "DoExpression" || e.type === "BlockStatement" || U(e) || ((n = t.label) == null ? void 0 : n.hug) !== !1 && (((s = t.label) == null ? void 0 : s.embed) || wr(e, r.originalText));
}
function Tl(e, t, _ref72) {
  let {
    signatureDocs: r,
    shouldBreak: n
  } = _ref72;
  ...
  return u !== "callee" && pt(s) || me(s) ? D([r[0], " =>", E([d, P([" =>", d], r.slice(1))])], {
    shouldBreak: n
  }) : u === "callee" && pt(s) || t.assignmentLayout ? D(P([" =>", d], r), {
    shouldBreak: n
  }) : D(E(P([" =>", d], r)), {
    shouldBreak: n
  });
}
function xl(e, t, r, _ref73) {
  let {
    bodyDoc: n,
    bodyComments: s,
    functionBody: u,
  ...
  let {
    ...
    m = (r.expandLastArg || o.type === "JSXExpressionContainer") && !A(a) ? F : "";
  return i && Hi(u) ? [" ", D([b("", "("), E([F, n]), b("", ")"), p, m]), s] : (Ki(u) && (n = D(["(", E([F, n]), F, ")"])), i ? [" ", n, s] : [E([d, n, s]), p, m]);
}
var gl = (e, t, r) => {
    if (!(e && t == null)) {
...
function fr(e, t, r, n) {
  let {
    ...
    u = [],
    i = Qi(!1, s[n], a => a.type !== "EmptyStatement");
  return e.each(_ref74 => {
    let {
      node: a
    } = _ref74;
...
function bs(e, t, r) {
  ...
  if (!s && !u && !i) return "";
  let a = [];
  return s && (a.push(fr(e, t, r, "directives")), (u || i) && (a.push(C), fe(v(!1, n.directives, -1), t) && a.push(C))), u && a.push(fr(e, t, r, "body")), i && a.push(J(e, t)), n.type === "Program" && ((o = e.parent) == null ? void 0 : o.type) !== "ModuleExpression" && a.push(C), a;
}
function hl(e) {
  let t = new WeakMap();
  return function (r) {
...
function Zi(e, t, r) {
  ...
  return D([n.variance ? r("variance") : "", "[", E([r("keyTparam"), " in ", r("sourceType")]), "]", Sl(n.optional), ": ", r("propType")]);
}
function Ps(e, t) {
  return e === "+" || e === "-" ? e + t : t;
}
function ea(e, t, r) {
  let {
    ...
    s = Te(t.originalText, j(n), j(n.typeParameter));
  return D(["{", E([t.bracketSpacing ? d : F, D([r("typeParameter"), n.optional ? Ps(n.optional, "?") : "", n.typeAnnotation ? ": " : "", r("typeAnnotation")]), t.semi ? b(";") : ""]), J(e, t), t.bracketSpacing ? d : F, "}"], {
    shouldBreak: s
  });
}
var Er = Tn("typeParameters");
function Bl(e, t, r) {
  let {
    node: n
  } = e;
  return $(n).length === 1 && n.type.startsWith("TS") && !n[r][0].constraint && e.parent.type === "ArrowFunctionExpression" && !(t.filepath && /\.ts$/.test(t.filepath));
}
function It(e, t, r, n) {
  let {
    node: s
  ...
  let u = e.getNode(2),
    i = u && St(u),
    a = e.match(m => !(m[n].length === 1 && Le(m[n][0])), void 0, (m, y) => y === "typeAnnotation", m => m.type === "Identifier", Ts);
...
function xn(e, t, r) {
  ...
  if (s.type === "TSMappedType") return s.readonly && u.push(Ps(s.readonly, "readonly"), " "), u.push("[", i), n.constraint && u.push(" in ", r("constraint")), s.nameType && u.push(" as ", e.callParent(() => r("nameType"))), u.push("]"), u;
  if (n.variance && u.push(r("variance")), n.in && u.push("in "), n.out && u.push("out "), u.push(i), n.bound && (n.usesExtendsBound && u.push(" extends "), u.push(Y(e, r, "bound"))), n.constraint) {
    ...
    u.push(" extends", D(E(d), {
      id: a
    }), ke, Ct(r("constraint"), {
      groupId: a
    }));
  }
  return n.default && u.push(" = ", r("default")), D(u);
}
var ta = M(["ClassProperty", "PropertyDefinition", "ClassPrivateProperty", "ClassAccessorProperty", "AccessorProperty", "TSAbstractPropertyDefinition", "TSAbstractAccessorProperty"]);
function gn(e, t, r) {
  let {
      node: n
    } = e,
    s = [ne(e), Yt(e), "class"],
    u = A(n.id, x.Trailing) || A(n.typeParameters, x.Trailing) || A(n.superClass) || L(n.extends) || L(n.mixins) || L(n.implements),
    i = [],
    a = [];
  if (n.id && i.push(" ", r("id")), i.push(r("typeParameters")), n.superClass) {
    let o = [kl(e, t, r), r("superTypeParameters")],
      p = e.call(m => ["extends ", le(m, o, t)], "superClass");
    u ? a.push(d, D(p)) : a.push(" ", p);
  } else a.push(ks(e, t, r, "extends"));
  if (a.push(ks(e, t, r, "mixins"), ks(e, t, r, "implements")), u) {
    let o;
    na(n) ? o = [...i, E(a)] : o = E([...i, a]), s.push(D(o, {
      id: ra(n)
    }));
  } else s.push(...i, ...a);
  return s.push(" ", r("body")), s;
}
var ra = Tn("heritageGroup");
function Is(e) {
  return b(C, "", {
    groupId: ra(e)
  });
...
function na(e) {
  return e.typeParameters && !A(e.typeParameters, x.Trailing | x.Line) && !Pl(e);
}
function ks(e, t, r, n) {
  let {
    node: s
  ...
  return [na(s) ? b(" ", d, {
    groupId: Er(s.typeParameters)
  }) : d, u, u && C, n, D(E([d, P([",", d], e.map(r, n))]))];
}
function kl(e, t, r) {
  let n = r("superClass"),
    {
  ...
  return s.type === "AssignmentExpression" ? D(b(["(", E([F, n]), F, ")"], n)) : n;
}
function hn(e, t, r) {
  let {
      node: n
    ...
    s = [];
  return L(n.decorators) && s.push(Cs(e, t, r)), s.push(Xt(n)), n.static && s.push("static "), s.push(Yt(e)), n.override && s.push("override "), s.push(yr(e, t, r)), s;
}
function Sn(e, t, r) {
  let {
      node: n
...
function sa(e, t, r) {
  let {
    ...
    s = [];
  return e.each(_ref75 => {
    let {
      node: u,
      next: i,
      isLast: a
    } = _ref75;
    s.push(r()), !t.semi && ta(u) && Il(u, i) && s.push(";"), a || (s.push(C), fe(u, t) && s.push(C));
  }, "body"), A(n, x.Dangling) && s.push(J(e, t)), [L(n.body) ? Is(e.parent) : "", "{", s.length > 0 ? [E([C, s]), C] : "", "}"];
}
function Il(e, t) {
  var s;
  let {
...
function ua(e, t) {
  if (t.semi || Ls(e, t) || Os(e, t)) return !1;
  let {
    node: r,
    key: n,
    parent: s
  } = e;
  return !!(r.type === "ExpressionStatement" && (n === "body" && (s.type === "Program" || s.type === "BlockStatement" || s.type === "StaticBlock" || s.type === "TSModuleBlock") || n === "consequent" && s.type === "SwitchCase") && e.call(() => ia(e, t), "expression"));
}
function ia(e, t) {
  let {
    node: r
  ...
  return Be(e, t) ? !0 : jt(r) ? e.call(() => ia(e, t), ...Ir(r)) : !1;
}
function Ls(_ref76, r) {
  let {
    node: e,
    parent: t
  } = _ref76;
  return (r.parentParser === "markdown" || r.parentParser === "mdx") && e.type === "ExpressionStatement" && U(e.expression) && t.type === "Program" && t.body.length === 1;
}
function ws(e) {
  switch (e.type) {
    case "MemberExpression":
...
function aa(e, t, r) {
  let n = [r("expression")];
  return Os(e, t) ? ws(e.node.expression) && n.push(";") : Ls(e, t) || t.semi && n.push(";"), n;
}
function oa(e, t, r) {
  if (t.__isVueBindings || t.__isVueForBindingLeft) {
    ...
    let s = P([",", d], n);
    return t.__isVueForBindingLeft ? ["(", E([F, D(s)]), F, ")"] : s;
  }
...
function la(e, t) {
  ...
  switch (r.type) {
    ...
    case "NumericLiteral":
      return Qe(r.extra.raw);
    case "StringLiteral":
      return Ie(at(r.extra.raw, t));
    case "NullLiteral":
      return "null";
    case "BooleanLiteral":
    ...
    case "Literal":
      {
        if (r.regex) return pa(r.regex);
        if (r.bigint) return Bn(r.raw);
        if (r.decimal) return Qe(r.decimal) + "m";
        let {
          value: n
        } = r;
        return typeof n == "number" ? Qe(r.raw) : typeof n == "string" ? Ll(e) ? ca(r.raw, t) : Ie(at(r.raw, t)) : String(n);
      }
  }
}
function Ll(e) {
...
function pa(_ref78) {
  ...
  return t = [...t].sort().join(""), "/".concat(e, "/").concat(t);
}
function ca(e, t) {
  let r = e.slice(1, -1);
...
function ma(e, t, r) {
  ...
  return ["import", n.module ? " module" : "", n.phase ? " ".concat(n.phase) : "", _s(n), fa(e, t, r), ya(e, t, r), Fa(e, t, r), t.semi ? ";" : ""];
}
...
function bn(e, t, r) {
  let {
    ...
    s = [Pi(e, t, r), ne(e), "export", Da(n) ? " default" : ""],
    {
      declaration: u,
      exported: i
    } = n;
  return A(n, x.Dangling) && (s.push(" ", J(e, t)), Or(n) && s.push(C)), u ? s.push(" ", r("declaration")) : (s.push(_l(n)), n.type === "ExportAllDeclaration" || n.type === "DeclareExportAllDeclaration" ? (s.push(" *"), i && s.push(" as ", r("exported"))) : s.push(fa(e, t, r)), s.push(ya(e, t, r), Fa(e, t, r))), s.push(vl(n, t)), s;
}
var Ol = M(["ClassDeclaration", "FunctionDeclaration", "TSInterfaceDeclaration", "DeclareClass", "DeclareFunction", "TSDeclareFunction", "EnumDeclaration"]);
function vl(e, t) {
  return t.semi && (!e.declaration || Da(e) && !Ol(e.declaration)) ? ";" : "";
}
function vs(e) {
  let t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : !0;
  return e && e !== "value" ? "".concat(t ? " " : "").concat(e).concat(t ? "" : " ") : "";
}
function _s(e, t) {
  return vs(e.importKind, t);
}
function _l(e) {
  return vs(e.exportKind);
}
function ya(e, t, r) {
  let {
    node: n
  ...
  if (!n.source) return "";
  let s = [];
  return Ea(n, t) && s.push(" from"), s.push(" ", r("source")), s;
}
function fa(e, t, r) {
  let {
    node: n
  ...
  if (L(n.specifiers)) {
    ...
    e.each(() => {
      let a = e.node.type;
      if (a === "ExportNamespaceSpecifier" || a === "ExportDefaultSpecifier" || a === "ImportNamespaceSpecifier" || a === "ImportDefaultSpecifier") u.push(r());else if (a === "ExportSpecifier" || a === "ImportSpecifier") i.push(r());else throw new _e(n, "specifier");
    }, "specifiers"), s.push(P(", ", u)), i.length > 0 && (u.length > 0 && s.push(", "), i.length > 1 || u.length > 0 || n.specifiers.some(o => A(o)) ? s.push(D(["{", E([t.bracketSpacing ? d : F, P([",", d], i)]), b(ye(t) ? "," : ""), t.bracketSpacing ? d : F, "}"])) : s.push(["{", t.bracketSpacing ? " " : "", ...i, t.bracketSpacing ? " " : "", "}"]));
  } else s.push("{}");
  return s;
}
function Ea(e, t) {
  return e.type !== "ImportDeclaration" || L(e.specifiers) || e.importKind === "type" ? !0 : Fr(t, j(e), j(e.source)).trimEnd().endsWith("from");
}
function Ml(e, t) {
  var n, s;
...
function Fa(e, t, r) {
  ...
  if (!s) return "";
  let u = [" ".concat(s, " {")];
  return L(n.attributes) && (t.bracketSpacing && u.push(" "), u.push(P(", ", e.map(r, "attributes"))), t.bracketSpacing && u.push(" ")), u.push("}"), u;
}
function Ca(e, t, r) {
  let {
      node: n
    ...
    m = "",
    y = "";
  return s === "ExportNamespaceSpecifier" || s === "ImportNamespaceSpecifier" ? m = "*" : o && (m = r(i)), p && !jl(n) && (y = r(a)), [vs(s === "ImportSpecifier" ? n.importKind : n.exportKind, !1), m, m && y ? " as " : "", y];
}
function jl(e) {
  ...
  if (t.type !== r.type || !iu(t, r)) return !1;
  if (te(t)) return t.value === r.value && De(t) === De(r);
  switch (t.type) {
    case "Identifier":
...
function Tt(e, t, r) {
  ...
  let n = t.semi ? ";" : "",
    ...
    i = s.type === "TSEnumDeclaration" || s.type === "EnumBooleanBody" || s.type === "EnumNumberBody" || s.type === "EnumStringBody" || s.type === "EnumSymbolBody",
    a = [s.type === "TSTypeLiteral" || i ? "members" : s.type === "TSInterfaceBody" ? "body" : "properties"];
  u && a.push("indexers", "callProperties", "internalSlots");
  let o = a.flatMap(T => e.map(_ref79 => {
    let {
      node: W
    } = _ref79;
    return {
  ...
  let {
    ...
    S = o.map(T => {
      let W = [...g, D(T.printed)];
      return g = [f, d], (T.node.type === "TSPropertySignature" || T.node.type === "TSMethodSignature" || T.node.type === "TSConstructSignatureDeclaration" || T.node.type === "TSCallSignatureDeclaration") && A(T.node, x.PrettierIgnore) && g.shift(), fe(T.node, t) && g.push(C), W;
    });
  if (s.inexact || s.hasUnknownMembers) {
    let T;
    if (A(s, x.Dangling)) {
      let W = A(s, x.Line);
      T = [J(e, t), W || Z(t.originalText, I(v(!1, ot(s), -1))) ? C : d, "..."];
    } else T = ["..."];
    S.push([...g, ...T]);
  }
  let B = (_ = v(!1, o, -1)) == null ? void 0 : _.node,
    O = !(s.inexact || s.hasUnknownMembers || B && (B.type === "RestElement" || (B.type === "TSPropertySignature" || B.type === "TSCallSignatureDeclaration" || B.type === "TSMethodSignature" || B.type === "TSConstructSignatureDeclaration") && A(B, x.PrettierIgnore))),
    R;
  if (S.length === 0) {
...
function Jl(e, t, r) {
  ...
  return i.type === n.type && i[u] === n ? ge(2, a) : a;
}
var ql = new Map([["AssignmentExpression", "right"], ["VariableDeclarator", "init"], ["ReturnStatement", "argument"], ["ThrowStatement", "argument"], ["UnaryExpression", "argument"], ["YieldExpression", "argument"], ["AwaitExpression", "argument"]]);
function Wl(e) {
  let {
    node: t
  } = e;
  ...
  for (let s = 0; !r; s++) {
    ...
    if (u.type === "ChainExpression" && u.expression === n || w(u) && u.callee === n || q(u) && u.object === n || u.type === "TSNonNullExpression" && u.expression === n) {
      n = u;
      continue;
    }
    u.type === "NewExpression" && u.callee === n || Ae(u) && u.expression === n ? (r = e.getParentNode(s + 1), n = u) : r = u;
  }
  return n === t ? !1 : r[ql.get(r.type)] === n;
}
function Aa(e, t, r) {
  let {
      node: n
    ...
    f = c.type === n.type && a.some(X => c[X] === n),
    l = c.type === n.type && !f,
    h,
    g,
    S = 0;
  do g = h || n, h = e.getParentNode(S), S++; while (h && h.type === n.type && a.every(X => h[X] !== g));
  let B = h || c,
    O = g;
  if (s && (U(n[a[0]]) || U(o) || U(p) || Rl(O))) {
    y = !0, l = !0;
    let X = z => [b("("), E([F, z]), F, b(")")],
      ue = z => z.type === "NullLiteral" || z.type === "Literal" && z.value === null || z.type === "Identifier" && z.name === "undefined";
    m.push(" ? ", ue(o) ? r(u) : X(r(u)), " : ", p.type === n.type || ue(p) ? r(i) : X(r(i)));
  } else {
    let X = z => t.useTabs ? E(r(z)) : ge(2, r(z)),
      ue = [d, "? ", o.type === n.type ? b("", "(") : "", X(u), o.type === n.type ? b("", ")") : "", d, ": ", X(i)];
    m.push(c.type !== n.type || c[i] === n || f ? ue : t.useTabs ? Rr(E(ue)) : ge(Math.max(0, t.tabWidth - 2), ue));
  }
  let R = [u, i, ...a].some(X => A(n[X], ue => ee(ue) && Te(t.originalText, j(ue), I(ue)))),
    _ = X => c === B ? D(X, {
      shouldBreak: R
    }) : R ? [X, Ee] : X,
    T = !y && (q(c) || c.type === "NGPipeExpression" && c.left === n) && !c.computed,
    W = Wl(e),
    Fe = _([Jl(e, t, r), l ? m : E(m), s && T && !W ? F : ""]);
  return f || W ? D([E([F, Fe]), F]) : Fe;
}
function Nl(e, t) {
  return (q(t) || t.type === "NGPipeExpression" && t.left === e) && !t.computed;
}
function Gl(e, t, r, n) {
  return [...e.map(u => ot(u)), ot(t), ot(r)].flat().some(u => ee(u) && Te(n.originalText, j(u), I(u)));
}
var Ul = new Map([["AssignmentExpression", "right"], ["VariableDeclarator", "init"], ["ReturnStatement", "argument"], ["ThrowStatement", "argument"], ["UnaryExpression", "argument"], ["YieldExpression", "argument"], ["AwaitExpression", "argument"]]);
function Yl(e) {
  let {
    node: t
  } = e;
  ...
  return n === t ? !1 : r[Ul.get(r.type)] === n;
}
var js = e => [b("("), E([F, e]), F, b(")")];
function $t(e, t, r, n) {
  if (!t.experimentalTernaries) return Aa(e, t, r);
  let {
      node: s
    } = e,
    ...
    l = f.type === s.type,
    h = l && p.some(Re => f[Re] === s),
    g = l && f[o] === s,
    S = m.type === s.type,
    B = y.type === s.type,
    O = B || g,
    R = t.tabWidth > 2 || t.useTabs,
    _,
    T,
    W = 0;
  do T = _ || s, _ = e.getParentNode(W), W++; while (_ && _.type === s.type && p.every(Re => _[Re] !== T));
  let Fe = _ || f,
    X = n && n.assignmentLayout && n.assignmentLayout !== "break-after-operator" && (f.type === "AssignmentExpression" || f.type === "VariableDeclarator" || f.type === "ClassProperty" || f.type === "PropertyDefinition" || f.type === "ClassPrivateProperty" || f.type === "ObjectProperty" || f.type === "Property"),
    ue = (f.type === "ReturnStatement" || f.type === "ThrowStatement") && !(S || B),
    z = u && Fe.type === "JSXExpressionContainer" && e.grandparent.type !== "JSXAttribute",
    wt = Yl(e),
    Ht = Nl(s, f),
    k = i && Be(e, t),
    N = R ? t.useTabs ? "	" : " ".repeat(t.tabWidth - 1) : "",
    Q = Gl(c, m, y, t) || S || B,
    je = !O && !l && !i && (z ? m.type === "NullLiteral" || m.type === "Literal" && m.value === null : nr(m, t) && Nn(s.test, 3)),
    xt = O || g || i && !l || l && u && Nn(s.test, 1) || je,
    Ws = [];
  !S && A(m, x.Dangling) && e.call(Re => {
    Ws.push(J(Re, t), C);
  }, "consequent");
  let Kt = [];
  A(s.test, x.Dangling) && e.call(Re => {
    Kt.push(J(Re, t));
  }, "test"), !B && A(y, x.Dangling) && e.call(Re => {
    Kt.push(J(Re, t));
  }, "alternate"), A(s, x.Dangling) && Kt.push(J(e, t));
  let Ns = Symbol("test"),
    wa = Symbol("consequent"),
    Ar = Symbol("test-and-consequent"),
    Oa = u ? [js(r("test")), s.test.type === "ConditionalExpression" ? Ee : ""] : [r("checkType"), " ", "extends", " ", s.extendsType.type === "TSConditionalType" || s.extendsType.type === "ConditionalTypeAnnotation" || s.extendsType.type === "TSMappedType" ? r("extendsType") : D(js(r("extendsType")))],
    Gs = D([Oa, " ?"], {
      id: Ns
    }),
    va = r(a),
    dr = E([S || z && (U(m) || l || O) ? C : d, Ws, va]),
    _a = xt ? D([Gs, O ? dr : b(dr, D(dr, {
      id: wa
    }), {
      groupId: Ns
    })], {
    ...
    zt = [_a, Kt.length > 0 ? [E([C, Kt]), C] : B ? C : je ? b(d, " ", {
      groupId: Ar
    }) : d, ":", B ? " " : R ? xt ? b(N, b(O || je ? " " : N, " "), {
      groupId: Ar
    }) : b(N, " ") : " ", B ? Us : D([E(Us), z && !je ? F : ""]), Ht && !wt ? F : "", Q ? Ee : ""];
  return X && !Q ? D(E([F, D(zt)])) : X || ue ? D(E(zt)) : wt || i && h ? D([E([F, zt]), k ? F : ""]) : f === Fe ? D(zt) : zt;
}
function da(e, t, r, n) {
  var _oa;
  let {
  ...
  switch (s.type) {
    ...
    case "JsonRoot":
      return [r("node"), C];
    case "File":
      return (_oa = oa(e, t, r)) !== null && _oa !== void 0 ? _oa : r("program");
    case "Program":
      return bs(e, t, r);
    case "EmptyStatement":
      return "";
    ...
    case "ChainExpression":
      return r("expression");
    case "ParenthesizedExpression":
      return !A(s.expression) && (se(s.expression) || G(s.expression)) ? ["(", r("expression"), ")"] : D(["(", E([F, r("expression")]), F, ")"]);
    case "AssignmentExpression":
      return ji(e, t, r);
    ...
    case "BindExpression":
      return s.object && i.push(r("object")), i.push(D(E([F, Kr(e, t, r)]))), i;
    case "Identifier":
      return [s.name, V(e), mn(e), Y(e, r)];
    ...
    case "SequenceExpression":
      {
        ...
        if (a.type === "ExpressionStatement" || a.type === "ForStatement") {
          let o = [];
          return e.each(_ref80 => {
            let {
              isFirst: p
            } = _ref80;
            p ? o.push(r()) : o.push(",", E([d, r()]));
          }, "expressions"), D(o);
        }
        return D(P([",", d], e.map(r, "expressions")));
      }
    case "ThisExpression":
      return "this";
    case "Super":
    ...
    case "Directive":
      return [r("value"), u];
    case "UnaryExpression":
      return i.push(s.operator), /[a-z]$/.test(s.operator) && i.push(" "), A(s.argument) ? i.push(D(["(", E([F, r("argument")]), F, ")"])) : i.push(r("argument")), i;
    case "UpdateExpression":
    ...
    case "VariableDeclaration":
      {
        let a = e.map(r, "declarations"),
          ...
          y;
        return a.length === 1 && !A(s.declarations[0]) ? y = a[0] : a.length > 0 && (y = E(a[0])), i = [ne(e), s.kind, y ? [" ", y] : "", E(a.slice(1).map(c => [",", m && !p ? C : d, c]))], p && o.body !== s || i.push(u), D(i);
      }
    case "WithStatement":
      return D(["with (", r("object"), ")", yt(s.body, r("body"))]);
    case "IfStatement":
      {
        let a = yt(s.consequent, r("consequent")),
          o = D(["if (", D([E([F, r("test")]), F]), ")", a]);
        if (i.push(o), s.alternate) {
          let p = A(s.consequent, x.Trailing | x.Line) || Or(s),
            m = s.consequent.type === "BlockStatement" && !p;
          i.push(m ? " " : C), A(s, x.Dangling) && i.push(J(e, t), p ? C : " "), i.push("else", D(yt(s.alternate, r("alternate"), s.alternate.type === "IfStatement")));
        }
        return i;
      }
    case "ForStatement":
      {
        let a = yt(s.body, r("body")),
          o = J(e, t),
          p = o ? [o, F] : "";
        return !s.init && !s.test && !s.update ? [p, D(["for (;;)", a])] : [p, D(["for (", D([E([F, r("init"), ";", d, r("test"), ";", d, r("update")]), F]), ")", a])];
      }
    case "WhileStatement":
      return D(["while (", D([E([F, r("test")]), F]), ")", yt(s.body, r("body"))]);
    case "ForInStatement":
      return D(["for (", r("left"), " in ", r("right"), ")", yt(s.body, r("body"))]);
    case "ForOfStatement":
      return D(["for", s.await ? " await" : "", " (", r("left"), " of ", r("right"), ")", yt(s.body, r("body"))]);
    case "DoWhileStatement":
      {
        let a = yt(s.body, r("body"));
        return i = [D(["do", a])], s.body.type === "BlockStatement" ? i.push(" ") : i.push(C), i.push("while (", D([E([F, r("test")]), F]), ")", u), i;
      }
    case "DoExpression":
    ...
    case "CatchClause":
      if (s.param) {
        let a = A(s.param, p => !ee(p) || p.leading && Z(t.originalText, I(p)) || p.trailing && Z(t.originalText, j(p), {
            backwards: !0
          })),
          o = r("param");
    ...
    case "SwitchStatement":
      return [D(["switch (", E([F, r("discriminant")]), F, ")"]), " {", s.cases.length > 0 ? E([C, P(C, e.map(_ref81 => {
        let {
          node: a,
          isLast: o
        } = _ref81;
...
function Pn(e, t, r) {
  ...
  return u === "callee" && w(n) || u === "object" && q(n) ? D([E([F, ...i]), F]) : i;
}
function Ta(e, t, r) {
  return Tt(e, r, t);
}
...
function xa(e, t, r) {
  ...
  return [s ? "of ".concat(s, " ") : "", Ta(e, t, r)];
}
function In(e, t, r) {
  let {
    node: n
  } = e;
  return [ne(e), n.const ? "const " : "", "enum ", t("id"), " ", n.type === "TSEnumDeclaration" ? Ta(e, t, r) : t("body")];
}
function Ln(e, t, r) {
  let {
      node: n
  ...
  return L(n.extends) && i.push(a ? b(" ", d, {
    groupId: Er(n.typeParameters)
  }) : d, "extends ", (n.extends.length === 1 ? du : E)(P([",", d], e.map(r, "extends")))), A(n.id, x.Trailing) || L(n.extends) ? a ? s.push(D([...u, E(i)])) : s.push(D(E([...u, ...i]))) : s.push(...u, ...i), s.push(" ", r("body")), D(s);
}
function ga(e, t, r) {
  var _n$kind, _n$raw, _n$raw2;
  let {
    node: n
  } = e;
  ...
  switch (n.type) {
    ...
    case "DeclareFunction":
      return [ne(e), "function ", r("id"), r("predicate"), s];
    case "DeclareModule":
      return ["declare module ", r("id"), " ", r("body")];
    case "DeclareModuleExports":
      return ["declare module.exports", Y(e, r), s];
    case "DeclareVariable":
      return [ne(e), (_n$kind = n.kind) !== null && _n$kind !== void 0 ? _n$kind : "var", " ", r("id"), s];
    ...
    case "TupleTypeSpreadElement":
      return un(e, t, r);
    case "GenericTypeAnnotation":
      return [r("id"), It(e, t, r, "typeParameters")];
    ...
    case "Variance":
      {
        ...
        return yn.ok(u === "plus" || u === "minus"), u === "plus" ? "+" : "-";
      }
    ...
    case "ObjectTypeProperty":
      {
        let u = "";
        return n.proto ? u = "proto " : n.static && (u = "static "), [u, n.kind !== "init" ? n.kind + " " : "", n.variance ? r("variance") : "", ft(e, t, r), V(e), ht(n) ? "" : ": ", r("value")];
      }
    ...
    case "NumberLiteralTypeAnnotation":
      return Qe((_n$raw = n.raw) !== null && _n$raw !== void 0 ? _n$raw : n.extra.raw);
    case "BigIntLiteralTypeAnnotation":
      return Bn((_n$raw2 = n.raw) !== null && _n$raw2 !== void 0 ? _n$raw2 : n.extra.raw);
    case "TypeCastExpression":
...
function ha(e, t, r) {
  ...
  if (Pr(n)) return n.type.slice(2, -7).toLowerCase();
  let s = t.semi ? ";" : "",
    u = [];
  switch (n.type) {
    case "TSThisType":
    ...
    case "TSTypeAssertion":
      {
        ...
        return a ? He([[o, r("expression")], [o, D(p, {
          shouldBreak: !0
    ...
    case "TSPropertySignature":
      return [n.readonly ? "readonly " : "", ft(e, t, r), V(e), Y(e, r)];
    ...
    case "TSIndexSignature":
      {
        let a = n.parameters.length > 1 ? b(ye(t) ? "," : "") : "",
          o = D([E([F, P([", ", F], e.map(r, "parameters"))]), a, F]),
          p = e.parent.type === "ClassBody" && e.key === "body";
        return [p && n.static ? "static " : "", n.readonly ? "readonly " : "", "[", n.parameters ? o : "", "]", Y(e, r), p ? s : ""];
      }
    ...
    case "TSNonNullExpression":
      return [r("expression"), "!"];
    case "TSImportType":
      return [n.isTypeOf ? "typeof " : "", "import(", r("argument"), ")", n.qualifier ? [".", r("qualifier")] : "", It(e, t, r, n.typeArguments ? "typeArguments" : "typeParameters")];
    case "TSLiteralType":
      return r("literal");
    ...
    case "TSMethodSignature":
      {
        let a = n.kind && n.kind !== "method" ? "".concat(n.kind, " ") : "";
        ...
        let o = Dt(e, r, t, !1, !0),
          ...
          y = m ? Y(e, r, p) : "",
          c = kt(n, y);
        return u.push(c ? D(o) : o), m && u.push(D(y)), D(u);
      }
    ...
    case "TSImportEqualsDeclaration":
      return [n.isExport ? "export " : "", "import ", _s(n, !1), r("id"), " = ", r("moduleReference"), t.semi ? ";" : ""];
    ...
    case "TSModuleDeclaration":
      {
        ...
        if (o) u.push(".");else if (u.push(ne(e)), !(n.kind === "global" || n.global)) {
          var _n$kind2;
          let y = (_n$kind2 = n.kind) !== null && _n$kind2 !== void 0 ? _n$kind2 : te(n.id) || Fr(t, j(n), j(n.id)).trim().endsWith("module") ? "module" : "namespace";
          u.push(y, " ");
        }
        return u.push(r("id")), p ? u.push(r("body")) : n.body ? u.push(" ", D(r("body"))) : u.push(s), u;
      }
    case "TSConditionalType":
      return $t(e, t, r);
    case "TSInferType":
    ...
    case "TSTupleType":
      return Vt(e, t, r);
    case "TSTypeReference":
      return [r("typeName"), It(e, t, r, "typeParameters")];
...
function $l(e, t, r, n) {
  ...
  if (Vl(u)) return s;
  let i = L(u.decorators),
    a = ki(e, t, r),
    o = u.type === "ClassExpression";
  if (i && !o) return or(s, c => D([a, c]));
  let p = Be(e, t),
    m = ua(e, t);
  return !a && !p && !m ? s : or(s, c => [m ? ";" : "", p ? "(" : "", p && o && i ? [E([d, a, c]), d] : [a, c], p ? ")" : ""]);
}
var Sa = $l;
var Hl = {
  avoidAstMutation: !0
...
function Ql(e, t, r) {
  ...
  switch (n.type) {
    ...
    case "ObjectExpression":
      return n.properties.length === 0 ? "{}" : ["{", E([C, P([",", C], e.map(r, "properties"))]), C, "}"];
    case "ObjectProperty":
      return [r("key"), ": ", r("value")];
    case "UnaryExpression":
    ...
    case "NumericLiteral":
      return ka(e) ? JSON.stringify(String(n.value)) : JSON.stringify(n.value);
    case "Identifier":
      return ka(e) ? JSON.stringify(n.name) : n.name;
    case "TemplateLiteral":
      return r(["quasis", 0]);
    case "TemplateElement":
...
var Zl = new Set(["start", "end", "extra", "loc", "comments", "leadingComments", "trailingComments", "innerComments", "errors", "range", "tokens"]);
function Ia(e, t) {
  let {
    type: r
  } = e;
...
var Lt = "JavaScript",
  em = {
    ...
    bracketSameLine: Cr.bracketSameLine,
    bracketSpacing: Cr.bracketSpacing,
    jsxBracketSameLine: {
      category: Lt,
      type: "boolean",
    ...
    singleAttributePerLine: Cr.singleAttributePerLine
  },
  La = em;
var tm = {
    estree: Rs,
...
var LT = qs;
exports.default = LT;
exports.languages = rm;
exports.options = La;
exports.printers = tm;
//# sourceMappingURL=estree-C0-H20eU.js.map
