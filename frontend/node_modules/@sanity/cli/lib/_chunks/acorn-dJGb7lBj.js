...
var Ae = (e, t, i) => (i = e != null ? xi(vi(e)) : {}, _i(t || !e || !e.__esModule ? we(i, "default", {
  value: e,
  enumerable: !0
}) : i, e));
var Jt = Ee((Qs, qt) => {
  ...
  function Kt(e) {
    ...
    if (!t) {
      ...
      l.jsxTagStart.updateContext = function () {
        ...
        _ === n && x === i.slash || _ === o ? (this.context.pop(), this.exprAllowed = this.curContext() === u) : this.exprAllowed = !0;
      }, t = {
        tokContexts: h,
        tokTypes: l
      }, Gt.set(e, t);
    ...
    return class extends t {
      ...
      jsx_readToken() {
        ...
        for (;;) {
          ...
          switch (m) {
            ...
            default:
              x(m) ? (p += this.input.slice(d, this.pos), p += this.jsx_readNewLine(!0), d = this.pos) : ++this.pos;
          }
        }
      }
      jsx_readNewLine(p) {
      ...
      jsx_readString(p) {
        ...
        for (;;) {
          ...
          if (g === p) break;
          g === 38 ? (d += this.input.slice(m, this.pos), d += this.jsx_readEntity(), m = this.pos) : x(g) ? (d += this.input.slice(m, this.pos), d += this.jsx_readNewLine(!1), m = this.pos) : ++this.pos;
        }
      ...
      jsx_readWord() {
        let p,
          d = this.pos;
        do p = this.input.charCodeAt(++this.pos); while (B(p) || p === 45);
      ...
      jsx_parseElementName() {
        ...
        let p = this.start,
          d = this.startLoc,
          m = this.jsx_parseNamespacedName();
      ...
      jsx_parseElementAt(p, d) {
        let m = this.startNodeAt(p, d),
          g = [],
          E = this.jsx_parseOpeningElementAt(p, d),
          pe = null;
        if (!E.selfClosing) {
      ...
      updateContext(p) {
        if (this.type == r.braceL) {
          ...
          d == u ? this.context.push(o.b_expr) : d == l ? this.context.push(o.b_tmpl) : super.updateContext(p), this.exprAllowed = !0;
        } else if (this.type === r.slash && p === n.jsxTagStart) this.context.length -= 2, this.context.push(h), this.exprAllowed = !1;else return super.updateContext(p);
      }
    };
  }
});
var ai = Ee(X => {
  ...
  function ri(e) {
    ...
    let i = "";
    for (; i !== e;) i = e, e = e.replace(Ts, "".concat(t, "$1 $2").concat(t));
    e = e.replace(Zt, "").trimRight();
    let s = Object.create(null),
      r = e.replace(ei, "").replace(Zt, "").trimRight(),
      n;
    for (; n = ei.exec(e);) {
  ...
  function Ps(_ref) {
    ...
    let i = "\n",
      ...
      n = " */",
      o = Object.keys(t),
      u = o.flatMap(l => ti(l, t[l])).map(l => "".concat(r, " ").concat(l).concat(i)).join("");
    if (!e) {
      if (o.length === 0) return "";
      if (o.length === 1 && !Array.isArray(t[o[0]])) {
        let l = t[o[0]];
        return "".concat(s, " ").concat(ti(o[0], l)[0]).concat(n);
      }
    }
    let h = e.split(i).map(l => "".concat(r, " ").concat(l)).join(i) + i;
    return s + i + (e ? h : "") + (e && o.length ? r + i : "") + u + n;
  }
  function ti(e, t) {
    return si.concat(t).map(i => "@".concat(e, " ").concat(i).trim());
  }
});
var et = {};
Si(et, {
...
var Ci = [509, 0, 227, 0, 150, 4, 294, 9, 1368, 2, 2, 1, 6, 3, 41, 2, 5, 0, 166, 1, 574, 3, 9, 9, 370, 1, 81, 2, 71, 10, 50, 3, 123, 2, 54, 14, 32, 10, 3, 1, 11, 3, 46, 10, 8, 0, 46, 9, 7, 2, 37, 13, 2, 9, 6, 1, 45, 0, 13, 2, 49, 13, 9, 3, 2, 11, 83, 11, 7, 0, 3, 0, 158, 11, 6, 9, 7, 3, 56, 1, 2, 6, 3, 1, 3, 2, 10, 0, 11, 1, 3, 6, 4, 4, 193, 17, 10, 9, 5, 0, 82, 19, 13, 9, 214, 6, 3, 8, 28, 1, 83, 16, 16, 9, 82, 12, 9, 9, 84, 14, 5, 9, 243, 14, 166, 9, 71, 5, 2, 1, 3, 3, 2, 0, 2, 1, 13, 9, 120, 6, 3, 6, 4, 0, 29, 9, 41, 6, 2, 3, 9, 0, 10, 10, 47, 15, 406, 7, 2, 7, 17, 9, 57, 21, 2, 13, 123, 5, 4, 0, 2, 1, 2, 6, 2, 0, 9, 9, 49, 4, 2, 1, 2, 4, 9, 9, 330, 3, 10, 1, 2, 0, 49, 6, 4, 4, 14, 9, 5351, 0, 7, 14, 13835, 9, 87, 9, 39, 4, 60, 6, 26, 9, 1014, 0, 2, 54, 8, 3, 82, 0, 12, 1, 19628, 1, 4706, 45, 3, 22, 543, 4, 4, 5, 9, 7, 3, 6, 31, 3, 149, 2, 1418, 49, 513, 54, 5, 49, 9, 0, 15, 0, 23, 4, 2, 14, 1361, 6, 2, 16, 3, 6, 2, 1, 2, 4, 101, 0, 161, 6, 10, 9, 357, 0, 62, 13, 499, 13, 983, 6, 110, 6, 6, 9, 4759, 9, 787719, 239],
  ...
  Ie = "break case catch continue debugger default do else finally for function if return switch throw try var while with null true false instanceof typeof void delete new in this",
  ki = {
    5: Ie,
...
function U(e, t) {
  return e < 65 ? e === 36 : e < 91 ? !0 : e < 97 ? e === 95 : e < 123 ? !0 : e <= 65535 ? e >= 170 && Ei.test(String.fromCharCode(e)) : t === !1 ? !1 : Ve(e, nt);
}
function H(e, t) {
  return e < 48 ? e === 36 : e < 58 ? !0 : e < 65 ? !1 : e < 91 ? !0 : e < 97 ? e === 95 : e < 123 ? !0 : e <= 65535 ? e >= 170 && Ai.test(String.fromCharCode(e)) : t === !1 ? !1 : Ve(e, nt) || Ve(e, Ci);
}
var S = function (t, i) {
...
var le = 0,
  ...
  T = function (t, i, s) {
    ...
    var r = "";
    t.allowReserved !== !0 && (r = Pe[t.ecmaVersion >= 6 ? 6 : t.ecmaVersion === 5 ? 5 : 3], t.sourceType === "module" && (r += " await")), this.reservedWords = G(r);
    var n = (r ? r + " " : "") + Pe.strict;
    this.reservedWordsStrict = G(n), this.reservedWordsStrictBind = G(n + " " + Pe.strictBind), this.input = String(i), this.containsEsc = !1, s ? (this.pos = s, this.lineStart = this.input.lastIndexOf("\n", s - 1) + 1, this.curLine = this.input.slice(0, this.lineStart).split(R).length) : (this.pos = this.lineStart = 0, this.curLine = 1), this.type = a.eof, this.value = null, this.start = this.end = this.pos, this.startLoc = this.endLoc = this.curPosition(), this.lastTokEndLoc = this.lastTokStartLoc = null, this.lastTokStart = this.lastTokEnd = this.pos, this.context = this.initialContext(), this.exprAllowed = !0, this.inModule = t.sourceType === "module", this.strict = this.inModule || this.strictDirective(this.pos), this.potentialArrowAt = -1, this.potentialArrowInForAwait = !1, this.yieldPos = this.awaitPos = this.awaitIdentPos = 0, this.labels = [], this.undefinedExports = Object.create(null), this.pos === 0 && t.allowHashBang && this.input.slice(0, 2) === "#!" && this.skipLineComment(2), this.scopeStack = [], this.enterScope(ie), this.regexpState = null, this.privateNameStack = [];
  },
  F = {
    inFunction: {
      configurable: !0
...
k.unexpected = function (e) {
  this.raise(e !== null && e !== void 0 ? e : this.start, "Unexpected token");
};
var xe = function () {
...
f.parseLabeledStatement = function (e, t, i, s) {
  ...
  for (var u = this.type.isLoop ? "loop" : this.type === a._switch ? "switch" : null, h = this.labels.length - 1; h >= 0; h--) {
    var l = this.labels[h];
    if (l.statementStart === e.start) l.statementStart = this.start, l.kind = u;else break;
  }
...
f.parseVarId = function (e, t) {
  e.id = this.parseBindingAtom(), this.checkLValPattern(e.id, t === "var" ? je : J, !1);
};
var ee = 1,
  Re = 2,
  vt = 4;
...
f.parseClass = function (e, t) {
  ...
  for (r.body = [], this.expect(a.braceL); this.type !== a.braceR;) {
    ...
    o && (r.body.push(o), o.type === "MethodDefinition" && o.kind === "constructor" ? (n && this.raiseRecoverable(o.start, "Duplicate constructor in the same class"), n = !0) : o.key && o.key.type === "PrivateIdentifier" && Fi(s, o) && this.raiseRecoverable(o.key.start, "Identifier '#" + o.key.name + "' has already been declared"));
  }
...
f.parseClassElement = function (e) {
  ...
  if (s ? (i.computed = !1, i.key = this.startNodeAt(this.lastTokStart, this.lastTokStartLoc), i.key.name = s, this.finishNode(i.key, "Identifier")) : this.parseClassElementName(i), t < 13 || this.type === a.parenL || o !== "method" || r || n) {
    var l = !i.static && fe(i, "constructor"),
      x = l && e;
...
f.parseClassId = function (e, t) {
  this.type === a.name ? (e.id = this.parseIdent(), t && this.checkLValSimple(e.id, J, !1)) : (t === !0 && this.unexpected(), e.id = null);
};
...
f.parseExport = function (e, t) {
  ...
  if (this.shouldParseExportStatement()) e.declaration = this.parseExportDeclaration(e), e.declaration.type === "VariableDeclaration" ? this.checkVariableExport(t, e.declaration.declarations) : this.checkExport(t, e.declaration.id, e.declaration.id.start), e.specifiers = [], e.source = null;else {
    if (e.declaration = null, e.specifiers = this.parseExportSpecifiers(t), this.eatContextual("from")) this.type !== a.string && this.unexpected(), e.source = this.parseExprAtom();else {
...
f.checkExport = function (e, t, i) {
  e && (typeof t != "string" && (t = t.type === "Identifier" ? t.name : t.value), se(e, t) && this.raiseRecoverable(i, "Duplicate export '" + t + "'"), e[t] = !0);
};
f.checkPatternExport = function (e, t) {
  var i = t.type;
  if (i === "Identifier") this.checkExport(e, t, t.start);else if (i === "ObjectPattern") for (var s = 0, r = t.properties; s < r.length; s += 1) {
    var n = r[s];
...
f.parseExportSpecifiers = function (e) {
  ...
  for (this.expect(a.braceL); !this.eat(a.braceR);) {
    if (i) i = !1;else if (this.expect(a.comma), this.afterTrailingComma(a.braceR)) break;
...
f.parseImportSpecifiers = function () {
  ...
  for (this.expect(a.braceL); !this.eat(a.braceR);) {
    if (t) t = !1;else if (this.expect(a.comma), this.afterTrailingComma(a.braceR)) break;
...
O.parseBindingList = function (e, t, i, s) {
  for (var r = [], n = !0; !this.eat(e);) if (n ? n = !1 : this.expect(a.comma), t && this.type === a.comma) r.push(null);else {
...
O.checkLValSimple = function (e, t, i) {
  ...
  switch (e.type) {
    case "Identifier":
      this.strict && this.reservedWordsStrictBind.test(e.name) && this.raiseRecoverable(e.start, (s ? "Binding " : "Assigning to ") + e.name + " in strict mode"), s && (t === J && e.name === "let" && this.raiseRecoverable(e.start, "let is disallowed as a lexically bound name"), i && (se(i, e.name) && this.raiseRecoverable(e.start, "Argument name clash"), i[e.name] = !0), t !== gt && this.declareName(e.name, t, e.start));
      break;
    case "ChainExpression":
      this.raiseRecoverable(e.start, "Optional chaining cannot appear in left-hand side");
      break;
...
$.braceIsBlock = function (e) {
  ...
  return t === C.f_expr || t === C.f_stat ? !0 : e === a.colon && (t === C.b_stat || t === C.b_expr) ? !t.isExpr : e === a._return || e === a.name && this.exprAllowed ? R.test(this.input.slice(this.lastTokEnd, this.start)) : e === a._else || e === a.semi || e === a.eof || e === a.parenR || e === a.arrow ? !0 : e === a.braceL ? t === C.b_stat : e === a._var || e === a._const || e === a.name ? !1 : !this.exprAllowed;
};
...
a._function.updateContext = a._class.updateContext = function (e) {
  e.beforeExpr && e !== a._else && !(e === a.semi && this.curContext() !== C.p_stat) && !(e === a._return && R.test(this.input.slice(this.lastTokEnd, this.start))) && !((e === a.colon || e === a.braceL) && this.curContext() === C.b_stat) ? this.context.push(C.f_expr) : this.context.push(C.f_stat), this.exprAllowed = !1;
};
a.colon.updateContext = function () {
  this.curContext().token === "function" && this.context.pop(), this.exprAllowed = !0;
};
a.backQuote.updateContext = function () {
  this.curContext() === C.q_tmpl ? this.context.pop() : this.context.push(C.q_tmpl), this.exprAllowed = !1;
};
...
y.parseMaybeAssign = function (e, t, i) {
  ...
  var s = !1,
    ...
    n = -1,
    o = -1;
  t ? (r = t.parenthesizedAssign, n = t.trailingComma, o = t.doubleProto, t.parenthesizedAssign = t.trailingComma = -1) : (t = new xe(), s = !0);
  var u = this.start,
    h = this.startLoc;
  ...
  if (i && (l = i.call(this, l, u, h)), this.type.isAssign) {
    ...
    return x.operator = this.value, this.type === a.eq && (l = this.toAssignable(l, !1, t)), s || (t.parenthesizedAssign = t.trailingComma = t.doubleProto = -1), t.shorthandAssign >= l.start && (t.shorthandAssign = -1), this.type === a.eq ? this.checkLValPattern(l) : this.checkLValSimple(l), x.left = l, this.next(), x.right = this.parseMaybeAssign(e), o > -1 && (t.doubleProto = o), this.finishNode(x, "AssignmentExpression");
...
y.parseExprOp = function (e, t, i, s, r) {
  ...
  if (n != null && (!r || this.type !== a._in) && n > s) {
    ...
    var l = this.start,
      x = this.startLoc,
      _ = this.parseExprOp(this.parseMaybeUnary(null, !1, !1, r), l, x, n, r),
      B = this.buildBinary(t, i, e, _, h, o || u);
...
y.parseMaybeUnary = function (e, t, i, s) {
  var r = this.start,
    n = this.startLoc,
    o;
  if (this.isContextual("await") && this.canAwait) o = this.parseAwait(s), t = !0;else if (this.type.prefix) {
    var u = this.startNode(),
      h = this.type === a.incDec;
    u.operator = this.value, u.prefix = !0, this.next(), u.argument = this.parseMaybeUnary(null, !0, h, s), this.checkExpressionErrors(e, !0), h ? this.checkLValSimple(u.argument) : this.strict && u.operator === "delete" && u.argument.type === "Identifier" ? this.raiseRecoverable(u.start, "Deleting local variable in strict mode") : u.operator === "delete" && bt(u.argument) ? this.raiseRecoverable(u.start, "Private fields can not be deleted") : t = !0, o = this.finishNode(u, h ? "UpdateExpression" : "UnaryExpression");
  } else if (!t && this.type === a.privateId) (s || this.privateNameStack.length === 0) && this.options.checkPrivateFields && this.unexpected(), o = this.parsePrivateIdent(), this.type !== a._in && this.unexpected();else {
  ...
  if (!i && this.eat(a.starstar)) {
    if (t) this.unexpected(this.lastTokStart);else return this.buildBinary(r, n, o, this.parseMaybeUnary(null, !1, !1, s), "**", !1);
  } else return o;
};
function bt(e) {
...
y.parseSubscript = function (e, t, i, s, r, n, o) {
  ...
  if (l || h && this.type !== a.parenL && this.type !== a.backQuote || this.eat(a.dot)) {
    ...
    var m = this.parseExprList(a.parenR, this.options.ecmaVersion >= 8, !1, _);
    ...
    this.checkExpressionErrors(_, !0), this.yieldPos = B || this.yieldPos, this.awaitPos = p || this.awaitPos, this.awaitIdentPos = d || this.awaitIdentPos;
  ...
  switch (this.type) {
    ...
    case a.name:
      var n = this.start,
        ...
        u = this.containsEsc,
        h = this.parseIdent(!1);
      if (this.options.ecmaVersion >= 8 && !u && h.name === "async" && !this.canInsertSemicolon() && this.eat(a._function)) return this.overrideContext(C.f_expr), this.parseFunction(this.startNodeAt(n, o), 0, !1, !0, t);
      if (r && !this.canInsertSemicolon()) {
        if (this.eat(a.arrow)) return this.parseArrowExpression(this.startNodeAt(n, o), [h], !1, t);
        if (this.options.ecmaVersion >= 8 && h.name === "async" && this.type === a.name && !u && (!this.potentialArrowInForAwait || this.value !== "of" || this.containsEsc)) return h = this.parseIdent(!1), (this.canInsertSemicolon() || !this.eat(a.arrow)) && this.unexpected(), this.parseArrowExpression(this.startNodeAt(n, o), [h], !0, t);
      }
      return h;
    case a.regexp:
      var l = this.value;
    ...
    case a.parenL:
      var x = this.start,
        _ = this.parseParenAndDistinguishExpression(r, t);
...
y.parseParenAndDistinguishExpression = function (e, t) {
  ...
  if (this.options.ecmaVersion >= 6) {
    ...
    for (this.yieldPos = 0, this.awaitPos = 0; this.type !== a.parenR;) if (l ? l = !1 : this.expect(a.comma), n && this.afterTrailingComma(a.parenR, !0)) {
      ...
      break;
    } else h.push(this.parseMaybeAssign(!1, _, this.parseParenItem));
    var m = this.lastTokEnd,
      g = this.lastTokEndLoc;
    if (this.expect(a.parenR), e && this.shouldParseArrow(h) && this.eat(a.arrow)) return this.checkPatternErrors(_, !1), this.checkYieldAwaitInDefaultParams(), this.yieldPos = B, this.awaitPos = p, this.parseParenArrowList(i, s, h, t);
    (!h.length || x) && this.unexpected(this.lastTokStart), d && this.unexpected(d), this.checkExpressionErrors(_, !0), this.yieldPos = B || this.yieldPos, this.awaitPos = p || this.awaitPos, h.length > 1 ? (r = this.startNodeAt(o, u), r.expressions = h, this.finishNodeAt(r, "SequenceExpression", m, g)) : r = h[0];
...
y.parseNew = function () {
  ...
  var s = this.start,
    r = this.startLoc;
  return e.callee = this.parseSubscripts(this.parseExprAtom(null, !1, !0), s, r, !0, !1), this.eat(a.parenL) ? e.arguments = this.parseExprList(a.parenR, this.options.ecmaVersion >= 8, !1) : e.arguments = Mi, this.finishNode(e, "NewExpression");
};
...
y.parseObj = function (e, t) {
  ...
  for (i.properties = [], this.next(); !this.eat(a.braceR);) {
    if (s) s = !1;else if (this.expect(a.comma), this.options.ecmaVersion >= 5 && this.afterTrailingComma(a.braceR)) break;
...
y.parseFunctionBody = function (e, t, i, s) {
  ...
  if (r) e.body = this.parseMaybeAssign(s), e.expression = !0, this.checkParams(e, !1);else {
    ...
    var h = this.labels;
    this.labels = [], o && (this.strict = !0), this.checkParams(e, !n && !o && !t && !i && this.isSimpleParamList(e.params)), this.strict && e.id && this.checkLValSimple(e.id, gt), e.body = this.parseBlock(!1, void 0, o && !n), e.expression = !1, this.adaptDirectivePrologue(e.body.body), this.labels = h;
  }
  this.exitScope();
};
...
y.parseExprList = function (e, t, i, s) {
  for (var r = [], n = !0; !this.eat(e);) {
    if (n) n = !1;else if (this.expect(a.comma), t && this.afterTrailingComma(e)) break;
    var o = void 0;
...
var _t = "ASCII ASCII_Hex_Digit AHex Alphabetic Alpha Any Assigned Bidi_Control Bidi_C Bidi_Mirrored Bidi_M Case_Ignorable CI Cased Changes_When_Casefolded CWCF Changes_When_Casemapped CWCM Changes_When_Lowercased CWL Changes_When_NFKC_Casefolded CWKCF Changes_When_Titlecased CWT Changes_When_Uppercased CWU Dash Default_Ignorable_Code_Point DI Deprecated Dep Diacritic Dia Emoji Emoji_Component Emoji_Modifier Emoji_Modifier_Base Emoji_Presentation Extender Ext Grapheme_Base Gr_Base Grapheme_Extend Gr_Ext Hex_Digit Hex IDS_Binary_Operator IDSB IDS_Trinary_Operator IDST ID_Continue IDC ID_Start IDS Ideographic Ideo Join_Control Join_C Logical_Order_Exception LOE Lowercase Lower Math Noncharacter_Code_Point NChar Pattern_Syntax Pat_Syn Pattern_White_Space Pat_WS Quotation_Mark QMark Radical Regional_Indicator RI Sentence_Terminal STerm Soft_Dotted SD Terminal_Punctuation Term Unified_Ideograph UIdeo Uppercase Upper Variation_Selector VS White_Space space XID_Continue XIDC XID_Start XIDS",
  ...
  Ji = "Basic_Emoji Emoji_Keycap_Sequence RGI_Emoji_Modifier_Sequence RGI_Emoji_Flag_Sequence RGI_Emoji_Tag_Sequence RGI_Emoji_ZWJ_Sequence RGI_Emoji",
  Gi = {
    9: "",
    10: "",
    11: "",
  ...
  Ki = Nt + " Hrkt Katakana_Or_Hiragana Kawi Nag_Mundari Nagm Unknown Zzzz",
  Wi = {
    9: Et,
    10: At,
    11: Pt,
...
c.regexp_eatRegExpIdentifierStart = function (e) {
  var t = e.pos,
    ...
    s = e.current(i);
  return e.advance(i), s === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, i) && (s = e.lastIntValue), zi(s) ? (e.lastIntValue = s, !0) : (e.pos = t, !1);
};
function zi(e) {
...
c.regexp_eatZero = function (e) {
  return e.current() === 48 && !ge(e.lookahead()) ? (e.lastIntValue = 0, e.advance(), !0) : !1;
};
...
c.regexp_eatCharacterClass = function (e) {
  if (e.eat(91)) {
    ...
    return e.eat(93) || e.raise("Unterminated character class"), t && i === L && e.raise("Negated character class may contain strings"), !0;
  }
  return !1;
};
...
c.regexp_eatClassSetCharacter = function (e) {
  ...
  var i = e.current();
  return i < 0 || i === e.lookahead() && Zi(i) || es(i) ? !1 : (e.advance(), e.lastIntValue = i, !0);
};
function Zi(e) {
...
c.regexp_eatClassControlLetter = function (e) {
  var t = e.current();
  return ge(t) || t === 95 ? (e.lastIntValue = t % 32, e.advance(), !0) : !1;
};
  ...
  e: for (; this.pos < this.input.length;) {
    ...
    switch (e) {
      ...
      case 47:
        ...
        break;
      default:
        if (e > 8 && e < 14 || e >= 5760 && ht.test(String.fromCharCode(e))) ++this.pos;else break e;
    }
  }
};
...
v.readToken_numberSign = function () {
  var e = this.options.ecmaVersion,
    t = 35;
  if (e >= 13 && (++this.pos, t = this.fullCharCodeAtPos(), U(t, !0) || t === 92)) return this.finishToken(a.privateId, this.readWord1());
...
v.readRegexp = function () {
  for (var e, t, i = this.pos;;) {
    ...
    if (R.test(s) && this.raise(i, "Unterminated regular expression"), e) e = !1;else {
...
v.readInt = function (e, t, i) {
  for (var s = this.options.ecmaVersion >= 12 && t === void 0, r = i && this.input.charCodeAt(this.pos) === 48, n = this.pos, o = 0, u = 0, h = 0, l = t !== null && t !== void 0 ? t : 1 / 0; h < l; ++h, ++this.pos) {
...
v.readNumber = function (e) {
  ...
  i && /[89]/.test(this.input.slice(t, this.pos)) && (i = !1), s === 46 && !i && (++this.pos, this.readInt(10), s = this.input.charCodeAt(this.pos)), (s === 69 || s === 101) && !i && (s = this.input.charCodeAt(++this.pos), (s === 43 || s === 45) && ++this.pos, this.readInt(10) === null && this.raise(t, "Invalid number")), U(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number");
...
v.readString = function (e) {
  for (var t = "", i = ++this.pos;;) {
    ...
    var s = this.input.charCodeAt(this.pos);
    if (s === e) break;
    s === 92 ? (t += this.input.slice(i, this.pos), t += this.readEscapedChar(!1), i = this.pos) : s === 8232 || s === 8233 ? (this.options.ecmaVersion < 10 && this.raise(this.start, "Unterminated string constant"), ++this.pos, this.options.locations && (this.curLine++, this.lineStart = this.pos)) : (Q(s) && this.raise(this.start, "Unterminated string constant"), ++this.pos);
  }
...
v.tryReadTemplateToken = function () {
  ...
  try {
    ...
    if (e === Ut) this.readInvalidTemplateToken();else throw e;
  }
...
v.readTmplToken = function () {
  for (var e = "", t = this.pos;;) {
    ...
    if (i === 92) e += this.input.slice(t, this.pos), e += this.readEscapedChar(!0), t = this.pos;else if (Q(i)) {
...
v.readWord1 = function () {
  ...
  for (var e = "", t = !0, i = this.pos, s = this.options.ecmaVersion >= 6; this.pos < this.input.length;) {
    ...
    if (H(r, s)) this.pos += r <= 65535 ? 1 : 2;else if (r === 92) {
...
function P(e) {
  var _ref2, _ref3;
  var s, r, n;
  let t = (_ref2 = (s = e.range) == null ? void 0 : s[0]) !== null && _ref2 !== void 0 ? _ref2 : e.start,
    i = (n = (_ref3 = (r = e.declaration) == null ? void 0 : r.decorators) !== null && _ref3 !== void 0 ? _ref3 : e.decorators) == null ? void 0 : n[0];
  return i ? Math.min(P(i), t) : t;
}
function j(e) {
  var _ref4;
  var t;
  return (_ref4 = (t = e.range) == null ? void 0 : t[1]) !== null && _ref4 !== void 0 ? _ref4 : e.end;
}
function fs(e) {
  let t = new Set(e);
...
function gs(e) {
  ...
  function i(s) {
    let r = s[t],
      n = e[r];
    if (!Array.isArray(n)) throw Object.assign(new Error("Missing visitor keys for '".concat(r, "'.")), {
      node: s
    });
    return n;
  }
...
var ui,
  Bs = () => {
    var _ui;
    return (_ui = ui) !== null && _ui !== void 0 ? _ui : ui = T.extend((0, hi.default)()), ui;
  };
function Ds(e, t) {
  let i = Bs(),
    s = [],
...
Qe.prototype = {
  ...
  translate(e, t) {
    ...
    if (i === s.name) e.type = w.Identifier, e.value === "static" && (e.type = w.Keyword), t.ecmaVersion > 5 && (e.value === "yield" || e.value === "let") && (e.type = w.Keyword);else if (i === s.privateId) e.type = w.PrivateIdentifier;else if (i === s.semi || i === s.comma || i === s.parenL || i === s.parenR || i === s.braceL || i === s.braceR || i === s.dot || i === s.bracketL || i === s.colon || i === s.question || i === s.bracketR || i === s.ellipsis || i === s.arrow || i === s.jsxTagStart || i === s.incDec || i === s.starstar || i === s.jsxTagEnd || i === s.prefix || i === s.questionDot || i.binop && !i.keyword || i.isAssign) e.type = w.Punctuator, e.value = this._code.slice(e.start, e.end);else if (i === s.jsxName) e.type = w.JSXIdentifier;else if (i.label === "jsxText" || i === s.jsxAttrValueToken) e.type = w.JSXText;else if (i.keyword) i.keyword === "true" || i.keyword === "false" ? e.type = w.Boolean : i.keyword === "null" ? e.type = w.Null : e.type = w.Keyword;else if (i === s.num) e.type = w.Numeric, e.value = this._code.slice(e.start, e.end);else if (i === s.string) t.jsxAttrValueToken ? (t.jsxAttrValueToken = !1, e.type = w.JSXText) : e.type = w.String, e.value = this._code.slice(e.start, e.end);else if (i === s.regexp) {
      e.type = w.RegularExpression;
      let r = e.value;
      e.regex = {
        flags: r.flags,
        pattern: r.pattern
      }, e.value = "/".concat(r.pattern, "/").concat(r.flags);
    }
    return e;
  },
  onToken(e, t) {
...
function Us() {
  ...
  let t = e === "latest" ? js() : e;
  if (typeof t != "number") throw new Error("ecmaVersion must be a number or \"latest\". Received value of type ".concat(typeof e, " instead."));
  if (t >= 2015 && (t -= 2009), !Ye.includes(t)) throw new Error("Invalid ecmaVersion.");
  return t;
}
function qs() {
  let e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "script";
...
var z = Symbol("espree's internal state"),
  $e = Symbol("espree's esprimaFinishNode");
...
var Ze = () => e => {
  ...
  return e.acornJsx && Object.assign(t, e.acornJsx.tokTypes), class extends e {
    ...
    tokenize() {
      do this.next(); while (this.type !== t.eof);
      this.next();
      let s = this[z],
        r = s.tokens;
    ...
    finishNode() {
      let r = super.finishNode(...arguments);
      return this[$e](r);
    }
    finishNodeAt() {
      let r = super.finishNodeAt(...arguments);
      return this[$e](r);
    }
    parse() {
      let s = this[z],
    ...
    unexpected(s) {
      ...
      this.end > this.start && (r += " ".concat(this.input.slice(this.start, this.end))), this.raise(this.start, r);
    }
    jsx_readString(s) {
    ...
    [$e](s) {
      return s.type === "TemplateElement" && this[z].templateElements.push(s), s.type.includes("Function") && !s.generator && (s.generator = !1), s;
    }
  };
};
var Gs = {
...
function Xs(e) {
  let t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  let i = Te(t),
    s = (i ? [i] : ["module", "script"]).map(n => () => di(e, {
      ...Ks,
      sourceType: n
    })),
    r;
...
exports.default = ya;
exports.parsers = zs;
//# sourceMappingURL=acorn-dJGb7lBj.js.map
