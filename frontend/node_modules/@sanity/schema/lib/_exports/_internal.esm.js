...
export { DEFAULT_MAX_FIELD_DEPTH, resolveSearchConfig, resolveSearchConfigForBaseFieldPaths } from '../_chunks/resolve-ouJP351U.js';
...
function extractSchema(schemaDef) {
  ...
  function createObject(schemaType) {
    ...
    if (((_a = schemaType.type) == null ? void 0 : _a.name) !== "document") {
      attributes._type = {
        type: "objectAttribute",
        value: {
          type: "string",
...
function createStringTypeNodeDefintion(stringSchemaType) {
  var _a;
  if ((_a = stringSchemaType.options) == null ? void 0 : _a.list) {
    return {
      type: "union",
...
function createNumberTypeNodeDefintion(numberSchemaType) {
  var _a;
  if ((_a = numberSchemaType.options) == null ? void 0 : _a.list) {
    return {
      type: "union",
...
function sortByDependencies(compiledSchema) {
  ...
  function walkDependencies(schemaType, dependencies) {
    ...
    if ("fields" in schemaType) {
      for (const field of gatherFields(schemaType)) {
        ...
        if (schemaTypeName === "document" || schemaTypeName === "object" || schemaTypeName === "block") {
  ...
  const typeNames = [];
  const currentlyVisiting = /* @__PURE__ */new Set();
...
export { extractSchema, groupProblems, isActionEnabled, validateSchema };
